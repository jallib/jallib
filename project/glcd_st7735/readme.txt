These images can be used for testing the glcd_st7735.jal library.
-----------------------------------------------------------------
See the sample file with the SD card for the st7735 on how to 
use these images.

The .bmp image files are in the format RGB565, the format
used by the st7735 graphics display.
