...
;   95 var          byte  _PORT_A_SHADOW        = PORTA
                               movf     v_porta,w
                               movwf    v__port_a_shadow
;  503 procedure _port_E_flush is
                               goto     l__l215
;  934 procedure enable_digital_io() is
l_enable_digital_io
;  936   ADCON0 = 0b0000_0000         -- disable ADC
                               clrf     v_adcon0
;  937   ADCON1 = 0b0000_0111         -- digital I/O
                               movlw    7
                               datalo_set v_adcon1
                               movwf    v_adcon1
;  938   CMCON  = 0b0000_0111         -- disable comparators
                               movlw    7
                               movwf    v_cmcon
;  939 end procedure
                               return   
...
; /Users/eur/jalv2/jallib/unvalidated/includes/device/16f877a.jal
;  176   _Tmp_Bit = x
                               datalo_clr v__port_a_shadow ; _tmp_bit33
                               bsf      v__port_a_shadow, 0 ; _tmp_bit33, 0
; b16f877a.jal
;   42   LED = on
; /Users/eur/jalv2/jallib/unvalidated/includes/device/16f877a.jal
;   99   PORTA = _PORT_A_SHADOW
...
l__l231
                               ...
                               goto     l__l231
                               branchhi_clr l__l230
                               branchlo_clr l__l230
...
; /Users/eur/jalv2/jallib/unvalidated/includes/device/16f877a.jal
;  176   _Tmp_Bit = x
                               bcf      v__port_a_shadow, 0 ; _tmp_bit34, 0
; b16f877a.jal
;   44   LED = off
; /Users/eur/jalv2/jallib/unvalidated/includes/device/16f877a.jal
;   99   PORTA = _PORT_A_SHADOW
