...
do i = 1 to dir.0                                           /* all relevant .edc files */
   ...
   if dsnumber \= ''  &  right(DevSpec.PicNameCaps.DataSheet,4) \= right(dsnumber,4) then
      call msg 1, 'Non matching DataSheet numbers: expected' DevSpec.PicNameCaps.DataSheet', found' dsnumber
   if psnumber \= ''  &  right(DevSpec.PicNameCaps.PgmSpec,4)   \= right(psnumber,4) then
         ...
         if val1 \= '' then do
            ...
            if width \= 8 then do                            /* skip 8-bit width subfields */
               ...
               select
                  ...
                  when reg = 'OSCCON'  &  val1 = 'SCS0' then do
                     call list_bitfield 2, reg'_SCS', reg, offset
                  end
...
call lineout jalfile, '--  - This file is generated by "edc2Jal.cmd" script! Do not change!'
call lineout jalfile, '--'
call lineout jalfile, '-- ==================================================='
call lineout jalfile, '--'
