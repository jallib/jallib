...
;   22 include 16f690
                               ...
                               branchlo_clr l_isr           ; 4294967295 -V rs rs [hl hl] 000d 118a
                                                            ; W = v__pic_isr_fsr
                               goto     l_isr               ; 4294967295 -V rs rs [hl hl] 000e 2bf7
                                                            ; W = v__pic_isr_fsr
...
;   66    for len using i loop           
                               clrf     v_i                 ;  1 OV Rs Rs [?? ??] 0206 01ae
                                                            ; W = v_len
                               goto     l__l249             ;  1 OV Rs Rs [?? ??] 0207 2a20
                                                            ; W = v_len
l__l248
;   70       device = str[i]
                               datahi_set v___str_1         ;  1 OV rs Rs [?? ??] 0208 1703
                               movf     v___str_1+1,w       ;  1 OV Rs Rs [?? ??] 0209 0827
                               datahi_clr v__pic_pointer    ;  1 OV Rs rs [?? ??] 020a 1303
                                                            ; W = v___str_1
                               movwf    v__pic_pointer+1    ;  1 OV rs rs [?? ??] 020b 00b5
                                                            ; W = v___str_1
                               datahi_set v_i               ;  1 OV rs Rs [?? ??] 020c 1703
                                                            ; W = v__pic_pointer
                               movf     v_i,w               ;  1 OV Rs Rs [?? ??] 020d 082e
                                                            ; W = v__pic_pointer
                               addwf    v___str_1,w         ;  1 OV Rs Rs [?? ??] 020e 0726
                                                            ; W = v_i
                               datahi_clr v__pic_pointer    ;  1 OV Rs rs [?? ??] 020f 1303
                               movwf    v__pic_pointer      ;  1 OV rs rs [?? ??] 0210 00b4
                               btfsc    v__status, v__c     ;  1 OV rs rs [?? ??] 0211 1803
                                                            ; W = v__pic_pointer
                               incf     v__pic_pointer+1,f  ;  1 OV rs rs [?? ??] 0212 0ab5
                                                            ; W = v__pic_pointer
                               bcf      v__pic_pointer+1, 6 ;  1 OV rs rs [?? ??] 0213 1335
                               movf     v__pic_pointer+1,w  ;  1 OV rs rs [?? ??] 0214 0835
                               call     l__pic_indirect     ;  1 OV rs ?? [?? ??] 0215 20bd
                                                            ; W = v__pic_pointer
                               datalo_clr v__pic_temp       ;  1 OV ?? ?s [?? ??] 0216 1283
                               datahi_clr v__pic_temp       ;  1 OV ?s rs [?? ??] 0217 1303
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 0218 00a0
                               movf     v____device_put_1,w ;  1 OV rs rs [?? ??] 0219 086e
                                                            ; W = v__pic_temp
                               movwf    v__pic_pointer      ;  1 OV rs rs [?? ??] 021a 00b4
                                                            ; W = v____device_put_1
                               movf     v____device_put_1+1,w;  1 OV rs rs [?? ??] 021b 086f
                                                            ; W = v__pic_pointer
                               call     l__pic_indirect     ;  1 OV rs ?? [?? ??] 021c 20bd
                                                            ; W = v____device_put_1
;   71    end loop
                               datalo_clr v_i               ;  1 OV ?? ?s [?? ??] 021d 1283
                               datahi_set v_i               ;  1 OV ?s Rs [?? ??] 021e 1703
                               incf     v_i,f               ;  1 OV Rs Rs [?? ??] 021f 0aae
l__l249
                               movf     v_i,w               ;  1 OV Rs Rs [?? ??] 0220 082e
                                                            ; W = v_len
                               subwf    v_len,w             ;  1 OV Rs Rs [?? ??] 0221 022c
                                                            ; W = v_i
                               datahi_clr v__pic_temp       ;  1 OV Rs rs [?? ??] 0222 1303
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 0223 00a0
                               datahi_set v_len             ;  1 OV rs Rs [?? ??] 0224 1703
                                                            ; W = v__pic_temp
                               movf     v_len+1,w           ;  1 OV Rs Rs [?? ??] 0225 082d
                                                            ; W = v__pic_temp
                               datahi_clr v__pic_temp       ;  1 OV Rs rs [?? ??] 0226 1303
                                                            ; W = v_len
                               iorwf    v__pic_temp,w       ;  1 OV rs rs [?? ??] 0227 0420
                                                            ; W = v_len
                               btfss    v__status, v__z     ;  1 OV rs rs [?? ??] 0228 1d03
                               goto     l__l248             ;  1 OV rs rs [?? ??] 0229 2a08
;   73 end procedure
                               return                       ;  1 OV rs rs [?? ??] 022a 0008
;  273 procedure print_byte_dec(volatile byte out device, byte in data) is
l_print_byte_dec
                               datahi_set v___data_49       ;  1 OV rs Rs [?? ??] 022b 1703
                                                            ; W = v_gpserrorcode
                               movwf    v___data_49         ;  1 OV Rs Rs [?? ??] 022c 00a2
                                                            ; W = v_gpserrorcode
;  275    _print_universal_dec(device, data, 100, 3)
                               datahi_clr v____device_put_19;  1 OV Rs rs [?? ??] 022d 1303
                                                            ; W = v___data_49
                               movf     v____device_put_19,w;  1 OV rs rs [?? ??] 022e 086e
                                                            ; W = v___data_49
                               datahi_set v____device_put_21;  1 OV rs Rs [?? ??] 022f 1703
                                                            ; W = v____device_put_19
                               movwf    v____device_put_21  ;  1 OV Rs Rs [?? ??] 0230 00a4
                                                            ; W = v____device_put_19
                               datahi_clr v____device_put_19;  1 OV Rs rs [?? ??] 0231 1303
                                                            ; W = v____device_put_21
                               movf     v____device_put_19+1,w;  1 OV rs rs [?? ??] 0232 086f
                                                            ; W = v____device_put_21
                               datahi_set v____device_put_21;  1 OV rs Rs [?? ??] 0233 1703
                                                            ; W = v____device_put_19
                               movwf    v____device_put_21+1;  1 OV Rs Rs [?? ??] 0234 00a5
                                                            ; W = v____device_put_19
                               movf     v___data_49,w       ;  1 OV Rs Rs [?? ??] 0235 0822
                                                            ; W = v____device_put_21
                               movwf    v___data_53         ;  1 OV Rs Rs [?? ??] 0236 00a8
                                                            ; W = v___data_49
                               clrf     v___data_53+1       ;  1 OV Rs Rs [?? ??] 0237 01a9
                                                            ; W = v___data_53
                               clrf     v___data_53+2       ;  1 OV Rs Rs [?? ??] 0238 01aa
                                                            ; W = v___data_53
                               clrf     v___data_53+3       ;  1 OV Rs Rs [?? ??] 0239 01ab
                                                            ; W = v___data_53
                               movlw    100                 ;  1 OV Rs Rs [?? ??] 023a 3064
                                                            ; W = v___data_53
                               movwf    v___digit_divisor_5 ;  1 OV Rs Rs [?? ??] 023b 00af
                               clrf     v___digit_divisor_5+1;  1 OV Rs Rs [?? ??] 023c 01b0
                                                            ; W = v___digit_divisor_5
                               clrf     v___digit_divisor_5+2;  1 OV Rs Rs [?? ??] 023d 01b1
                                                            ; W = v___digit_divisor_5
                               clrf     v___digit_divisor_5+3;  1 OV Rs Rs [?? ??] 023e 01b2
                                                            ; W = v___digit_divisor_5
                               movlw    3                   ;  1 OV Rs Rs [?? ??] 023f 3003
                                                            ; W = v___digit_divisor_5
                               goto     l__print_universal_dec;  1 OV Rs Rs [?? ??] 0240 2a41
;  277 end procedure
...
l__print_universal_dec
                               movwf    v___digit_number_5  ;  1 OV Rs Rs [?? ??] 0241 00b3
;  298    if (data == 0) then
                               movf     v___data_53,w       ;  1 OV Rs Rs [?? ??] 0242 0828
                                                            ; W = v___digit_number_5
                               iorwf    v___data_53+1,w     ;  1 OV Rs Rs [?? ??] 0243 0429
                                                            ; W = v___data_53
                               iorwf    v___data_53+2,w     ;  1 OV Rs Rs [?? ??] 0244 042a
                               iorwf    v___data_53+3,w     ;  1 OV Rs Rs [?? ??] 0245 042b
                               btfss    v__status, v__z     ;  1 OV Rs Rs [?? ??] 0246 1d03
                               goto     l__l319             ;  1 OV Rs Rs [?? ??] 0247 2a52
;  299       device = "0"      
                               movlw    48                  ;  1 OV Rs Rs [?? ??] 0248 3030
                               datahi_clr v__pic_temp       ;  1 OV Rs rs [?? ??] 0249 1303
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 024a 00a0
                               datahi_set v____device_put_21;  1 OV rs Rs [?? ??] 024b 1703
                                                            ; W = v__pic_temp
                               movf     v____device_put_21,w;  1 OV Rs Rs [?? ??] 024c 0824
                                                            ; W = v__pic_temp
                               datahi_clr v__pic_pointer    ;  1 OV Rs rs [?? ??] 024d 1303
                                                            ; W = v____device_put_21
                               movwf    v__pic_pointer      ;  1 OV rs rs [?? ??] 024e 00b4
                                                            ; W = v____device_put_21
                               datahi_set v____device_put_21;  1 OV rs Rs [?? ??] 024f 1703
                                                            ; W = v__pic_pointer
                               movf     v____device_put_21+1,w;  1 OV Rs Rs [?? ??] 0250 0825
                                                            ; W = v__pic_pointer
                               goto     l__pic_indirect     ;  1 OV Rs Rs [?? ??] 0251 28bd
                                                            ; W = v____device_put_21
;  300       return
;  301    end if
l__l319
;  303    no_digits_printed_yet = true
                               bsf      v____bitbucket_42, 0 ; no_digits_printed_yet;  1 OV Rs Rs [?? ??] 0252 1436
;  304    while (digit_divisor > 0) loop
l__l320
                               movf     v___digit_divisor_5+3,w;  1 OV Rs Rs [?? ??] 0253 0832
                                                            ; W = v_digit
                               xorlw    128                 ;  1 OV Rs Rs [?? ??] 0254 3a80
                                                            ; W = v___digit_divisor_5
                               datahi_clr v__pic_temp       ;  1 OV Rs rs [?? ??] 0255 1303
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 0256 00a0
                               movlw    128                 ;  1 OV rs rs [?? ??] 0257 3080
                                                            ; W = v__pic_temp
                               subwf    v__pic_temp,w       ;  1 OV rs rs [?? ??] 0258 0220
                               btfss    v__status, v__z     ;  1 OV rs rs [?? ??] 0259 1d03
                               goto     l__l555             ;  1 OV rs rs [?? ??] 025a 2a66
                               movlw    0                   ;  1 OV rs rs [?? ??] 025b 3000
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 025c 1703
                               subwf    v___digit_divisor_5+2,w;  1 OV Rs Rs [?? ??] 025d 0231
                               btfss    v__status, v__z     ;  1 OV Rs Rs [?? ??] 025e 1d03
                               goto     l__l555             ;  1 OV Rs Rs [?? ??] 025f 2a66
                               movlw    0                   ;  1 OV Rs Rs [?? ??] 0260 3000
                               subwf    v___digit_divisor_5+1,w;  1 OV Rs Rs [?? ??] 0261 0230
                               btfss    v__status, v__z     ;  1 OV Rs Rs [?? ??] 0262 1d03
                               goto     l__l555             ;  1 OV Rs Rs [?? ??] 0263 2a66
                               movlw    0                   ;  1 OV Rs Rs [?? ??] 0264 3000
                               subwf    v___digit_divisor_5,w;  1 OV Rs Rs [?? ??] 0265 022f
l__l555
                               btfsc    v__status, v__z     ;  1 OV ?s Rs [?? ??] 0266 1903
                               goto     l__l321             ;  1 OV ?s Rs [?? ??] 0267 2ae7
                               btfss    v__status, v__c     ;  1 OV ?s Rs [?? ??] 0268 1c03
                               goto     l__l321             ;  1 OV ?s Rs [?? ??] 0269 2ae7
;  305       digit = byte ( data / digit_divisor )
                               datahi_set v___digit_divisor_5;  1 OV ?s Rs [?? ??] 026a 1703
                               movf     v___digit_divisor_5,w;  1 OV Rs Rs [?? ??] 026b 082f
                               datahi_clr v__pic_divisor    ;  1 OV Rs rs [?? ??] 026c 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_divisor      ;  1 OV rs rs [?? ??] 026d 00a8
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 026e 1703
                                                            ; W = v__pic_divisor
                               movf     v___digit_divisor_5+1,w;  1 OV Rs Rs [?? ??] 026f 0830
                                                            ; W = v__pic_divisor
                               datahi_clr v__pic_divisor    ;  1 OV Rs rs [?? ??] 0270 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_divisor+1    ;  1 OV rs rs [?? ??] 0271 00a9
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 0272 1703
                                                            ; W = v__pic_divisor
                               movf     v___digit_divisor_5+2,w;  1 OV Rs Rs [?? ??] 0273 0831
                                                            ; W = v__pic_divisor
                               datahi_clr v__pic_divisor    ;  1 OV Rs rs [?? ??] 0274 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_divisor+2    ;  1 OV rs rs [?? ??] 0275 00aa
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 0276 1703
                                                            ; W = v__pic_divisor
                               movf     v___digit_divisor_5+3,w;  1 OV Rs Rs [?? ??] 0277 0832
                                                            ; W = v__pic_divisor
                               datahi_clr v__pic_divisor    ;  1 OV Rs rs [?? ??] 0278 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_divisor+3    ;  1 OV rs rs [?? ??] 0279 00ab
                                                            ; W = v___digit_divisor_5
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 027a 1703
                                                            ; W = v__pic_divisor
                               movf     v___data_53,w       ;  1 OV Rs Rs [?? ??] 027b 0828
                                                            ; W = v__pic_divisor
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 027c 1303
                                                            ; W = v___data_53
                               movwf    v__pic_dividend     ;  1 OV rs rs [?? ??] 027d 00a0
                                                            ; W = v___data_53
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 027e 1703
                                                            ; W = v__pic_dividend
                               movf     v___data_53+1,w     ;  1 OV Rs Rs [?? ??] 027f 0829
                                                            ; W = v__pic_dividend
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 0280 1303
                                                            ; W = v___data_53
                               movwf    v__pic_dividend+1   ;  1 OV rs rs [?? ??] 0281 00a1
                                                            ; W = v___data_53
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 0282 1703
                                                            ; W = v__pic_dividend
                               movf     v___data_53+2,w     ;  1 OV Rs Rs [?? ??] 0283 082a
                                                            ; W = v__pic_dividend
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 0284 1303
                                                            ; W = v___data_53
                               movwf    v__pic_dividend+2   ;  1 OV rs rs [?? ??] 0285 00a2
                                                            ; W = v___data_53
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 0286 1703
                                                            ; W = v__pic_dividend
                               movf     v___data_53+3,w     ;  1 OV Rs Rs [?? ??] 0287 082b
                                                            ; W = v__pic_dividend
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 0288 1303
                                                            ; W = v___data_53
                               movwf    v__pic_dividend+3   ;  1 OV rs rs [?? ??] 0289 00a3
                                                            ; W = v___data_53
                               call     l__pic_divide       ;  1 OV rs ?? [?? ??] 028a 206b
                                                            ; W = v__pic_dividend
                               datalo_clr v__pic_quotient   ;  1 OV ?? ?s [?? ??] 028b 1283
                               datahi_clr v__pic_quotient   ;  1 OV ?s rs [?? ??] 028c 1303
                               movf     v__pic_quotient,w   ;  1 OV rs rs [?? ??] 028d 082c
                               datahi_set v_digit           ;  1 OV rs Rs [?? ??] 028e 1703
                                                            ; W = v__pic_quotient
                               movwf    v_digit             ;  1 OV Rs Rs [?? ??] 028f 00b4
                                                            ; W = v__pic_quotient
;  306       data = data % digit_divisor
                               datahi_clr v__pic_remainder  ;  1 OV Rs rs [?? ??] 0290 1303
                                                            ; W = v_digit
                               movf     v__pic_remainder,w  ;  1 OV rs rs [?? ??] 0291 0824
                                                            ; W = v_digit
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 0292 1703
                                                            ; W = v__pic_remainder
                               movwf    v___data_53         ;  1 OV Rs Rs [?? ??] 0293 00a8
                                                            ; W = v__pic_remainder
                               datahi_clr v__pic_remainder  ;  1 OV Rs rs [?? ??] 0294 1303
                                                            ; W = v___data_53
                               movf     v__pic_remainder+1,w;  1 OV rs rs [?? ??] 0295 0825
                                                            ; W = v___data_53
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 0296 1703
                                                            ; W = v__pic_remainder
                               movwf    v___data_53+1       ;  1 OV Rs Rs [?? ??] 0297 00a9
                                                            ; W = v__pic_remainder
                               datahi_clr v__pic_remainder  ;  1 OV Rs rs [?? ??] 0298 1303
                                                            ; W = v___data_53
                               movf     v__pic_remainder+2,w;  1 OV rs rs [?? ??] 0299 0826
                                                            ; W = v___data_53
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 029a 1703
                                                            ; W = v__pic_remainder
                               movwf    v___data_53+2       ;  1 OV Rs Rs [?? ??] 029b 00aa
                                                            ; W = v__pic_remainder
                               datahi_clr v__pic_remainder  ;  1 OV Rs rs [?? ??] 029c 1303
                                                            ; W = v___data_53
                               movf     v__pic_remainder+3,w;  1 OV rs rs [?? ??] 029d 0827
                                                            ; W = v___data_53
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 029e 1703
                                                            ; W = v__pic_remainder
                               movwf    v___data_53+3       ;  1 OV Rs Rs [?? ??] 029f 00ab
                                                            ; W = v__pic_remainder
;  307       digit_divisor = digit_divisor / 10
                               movlw    10                  ;  1 OV Rs Rs [?? ??] 02a0 300a
                                                            ; W = v___data_53
                               datahi_clr v__pic_divisor    ;  1 OV Rs rs [?? ??] 02a1 1303
                               movwf    v__pic_divisor      ;  1 OV rs rs [?? ??] 02a2 00a8
                               clrf     v__pic_divisor+1    ;  1 OV rs rs [?? ??] 02a3 01a9
                                                            ; W = v__pic_divisor
                               clrf     v__pic_divisor+2    ;  1 OV rs rs [?? ??] 02a4 01aa
                                                            ; W = v__pic_divisor
                               clrf     v__pic_divisor+3    ;  1 OV rs rs [?? ??] 02a5 01ab
                                                            ; W = v__pic_divisor
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02a6 1703
                                                            ; W = v__pic_divisor
                               movf     v___digit_divisor_5,w;  1 OV Rs Rs [?? ??] 02a7 082f
                                                            ; W = v__pic_divisor
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 02a8 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_dividend     ;  1 OV rs rs [?? ??] 02a9 00a0
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02aa 1703
                                                            ; W = v__pic_dividend
                               movf     v___digit_divisor_5+1,w;  1 OV Rs Rs [?? ??] 02ab 0830
                                                            ; W = v__pic_dividend
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 02ac 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_dividend+1   ;  1 OV rs rs [?? ??] 02ad 00a1
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02ae 1703
                                                            ; W = v__pic_dividend
                               movf     v___digit_divisor_5+2,w;  1 OV Rs Rs [?? ??] 02af 0831
                                                            ; W = v__pic_dividend
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 02b0 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_dividend+2   ;  1 OV rs rs [?? ??] 02b1 00a2
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02b2 1703
                                                            ; W = v__pic_dividend
                               movf     v___digit_divisor_5+3,w;  1 OV Rs Rs [?? ??] 02b3 0832
                                                            ; W = v__pic_dividend
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 02b4 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_dividend+3   ;  1 OV rs rs [?? ??] 02b5 00a3
                                                            ; W = v___digit_divisor_5
                               call     l__pic_sdivide      ;  1 OV rs ?? [?? ??] 02b6 204a
                                                            ; W = v__pic_dividend
                               datalo_clr v__pic_quotient   ;  1 OV ?? ?s [?? ??] 02b7 1283
                               datahi_clr v__pic_quotient   ;  1 OV ?s rs [?? ??] 02b8 1303
                               movf     v__pic_quotient,w   ;  1 OV rs rs [?? ??] 02b9 082c
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02ba 1703
                                                            ; W = v__pic_quotient
                               movwf    v___digit_divisor_5 ;  1 OV Rs Rs [?? ??] 02bb 00af
                                                            ; W = v__pic_quotient
                               datahi_clr v__pic_quotient   ;  1 OV Rs rs [?? ??] 02bc 1303
                                                            ; W = v___digit_divisor_5
                               movf     v__pic_quotient+1,w ;  1 OV rs rs [?? ??] 02bd 082d
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02be 1703
                                                            ; W = v__pic_quotient
                               movwf    v___digit_divisor_5+1;  1 OV Rs Rs [?? ??] 02bf 00b0
                                                            ; W = v__pic_quotient
                               datahi_clr v__pic_quotient   ;  1 OV Rs rs [?? ??] 02c0 1303
                                                            ; W = v___digit_divisor_5
                               movf     v__pic_quotient+2,w ;  1 OV rs rs [?? ??] 02c1 082e
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02c2 1703
                                                            ; W = v__pic_quotient
                               movwf    v___digit_divisor_5+2;  1 OV Rs Rs [?? ??] 02c3 00b1
                                                            ; W = v__pic_quotient
                               datahi_clr v__pic_quotient   ;  1 OV Rs rs [?? ??] 02c4 1303
                                                            ; W = v___digit_divisor_5
                               movf     v__pic_quotient+3,w ;  1 OV rs rs [?? ??] 02c5 082f
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02c6 1703
                                                            ; W = v__pic_quotient
                               movwf    v___digit_divisor_5+3;  1 OV Rs Rs [?? ??] 02c7 00b2
                                                            ; W = v__pic_quotient
;  309       if ((digit != 0) | (no_digits_printed_yet == false)) then
                               movf     v_digit,w           ;  1 OV Rs Rs [?? ??] 02c8 0834
                                                            ; W = v___digit_divisor_5
                               bsf      v____bitbucket_42, 3 ; _btemp47;  1 OV Rs Rs [?? ??] 02c9 15b6
                                                            ; W = v_digit
                               btfsc    v__status, v__z     ;  1 OV Rs Rs [?? ??] 02ca 1903
                                                            ; W = v_digit
                               bcf      v____bitbucket_42, 3 ; _btemp47;  1 OV Rs Rs [?? ??] 02cb 11b6
                                                            ; W = v_digit
                               bcf      v____bitbucket_42, 4 ; _btemp48;  1 OV Rs Rs [?? ??] 02cc 1236
                                                            ; W = v_digit
                               btfss    v____bitbucket_42, 0 ; no_digits_printed_yet;  1 OV Rs Rs [?? ??] 02cd 1c36
                                                            ; W = v_digit
                               bsf      v____bitbucket_42, 4 ; _btemp48;  1 OV Rs Rs [?? ??] 02ce 1636
                                                            ; W = v_digit
                               bcf      v____bitbucket_42, 5 ; _btemp49;  1 OV Rs Rs [?? ??] 02cf 12b6
                                                            ; W = v_digit
                               btfss    v____bitbucket_42, 3 ; _btemp47;  1 OV Rs Rs [?? ??] 02d0 1db6
                                                            ; W = v_digit
                               btfsc    v____bitbucket_42, 4 ; _btemp48;  1 OV Rs Rs [?? ??] 02d1 1a36
                                                            ; W = v_digit
                               bsf      v____bitbucket_42, 5 ; _btemp49;  1 OV Rs Rs [?? ??] 02d2 16b6
                                                            ; W = v_digit
                               btfss    v____bitbucket_42, 5 ; _btemp49;  1 OV Rs Rs [?? ??] 02d3 1eb6
                                                            ; W = v_digit
                               goto     l__l324             ;  1 OV Rs Rs [?? ??] 02d4 2ae5
                                                            ; W = v_digit
;  310          device = digit | "0"
                               movlw    48                  ;  1 OV Rs Rs [?? ??] 02d5 3030
                               iorwf    v_digit,w           ;  1 OV Rs Rs [?? ??] 02d6 0434
                               movwf    v____temp_42        ;  1 OV Rs Rs [?? ??] 02d7 00b5
                               movf     v____temp_42,w      ;  1 OV Rs Rs [?? ??] 02d8 0835
                                                            ; W = v____temp_42
                               datahi_clr v__pic_temp       ;  1 OV Rs rs [?? ??] 02d9 1303
                                                            ; W = v____temp_42
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 02da 00a0
                                                            ; W = v____temp_42
                               datahi_set v____device_put_21;  1 OV rs Rs [?? ??] 02db 1703
                                                            ; W = v__pic_temp
                               movf     v____device_put_21,w;  1 OV Rs Rs [?? ??] 02dc 0824
                                                            ; W = v__pic_temp
                               datahi_clr v__pic_pointer    ;  1 OV Rs rs [?? ??] 02dd 1303
                                                            ; W = v____device_put_21
                               movwf    v__pic_pointer      ;  1 OV rs rs [?? ??] 02de 00b4
                                                            ; W = v____device_put_21
                               datahi_set v____device_put_21;  1 OV rs Rs [?? ??] 02df 1703
                                                            ; W = v__pic_pointer
                               movf     v____device_put_21+1,w;  1 OV Rs Rs [?? ??] 02e0 0825
                                                            ; W = v__pic_pointer
                               call     l__pic_indirect     ;  1 OV Rs ?? [?? ??] 02e1 20bd
                                                            ; W = v____device_put_21
;  311          no_digits_printed_yet = false
                               datalo_clr v____bitbucket_42 ; no_digits_printed_yet;  1 OV ?? ?s [?? ??] 02e2 1283
                               datahi_set v____bitbucket_42 ; no_digits_printed_yet;  1 OV ?s Rs [?? ??] 02e3 1703
                               bcf      v____bitbucket_42, 0 ; no_digits_printed_yet;  1 OV Rs Rs [?? ??] 02e4 1036
;  312       end if
l__l324
;  313       digit_number = digit_number - 1
                               decf     v___digit_number_5,f;  1 OV Rs Rs [?? ??] 02e5 03b3
                                                            ; W = v_digit
;  314    end loop
                               goto     l__l320             ;  1 OV Rs Rs [?? ??] 02e6 2a53
                                                            ; W = v_digit
l__l321
;  316 end procedure
l__l239
                               return                       ;  1 OV ?s Rs [?? ??] 02e7 0008
; delay.jal
;  113 procedure delay_1ms(word in n) is
l_delay_1ms
;  115    for n loop
                               datahi_set v__floop4         ;  1 OV rs Rs [?? ??] 02e8 1703
                                                            ; W = v___n_3
                               clrf     v__floop4           ;  1 OV Rs Rs [?? ??] 02e9 01a2
                                                            ; W = v___n_3
                               clrf     v__floop4+1         ;  1 OV Rs Rs [?? ??] 02ea 01a3
                                                            ; W = v___n_3
                               goto     l__l359             ;  1 OV Rs Rs [?? ??] 02eb 2afe
                                                            ; W = v___n_3
l__l358
;  117          _usec_delay(_one_ms_delay)
                               datalo_clr v__pic_temp       ;  1 -V rs rs [?? ??] 02ec 1283
                               datahi_clr v__pic_temp       ;  1 -V rs rs [?? ??] 02ed 1303
                               movlw    35                  ;  1 -V rs rs [?? ??] 02ee 3023
                               movwf    v__pic_temp         ;  1 -V rs rs [?? ??] 02ef 00a0
l__l559
                               movlw    13                  ;  1 -V rs rs [?? ??] 02f0 300d
                               movwf    v__pic_temp+1       ;  1 -V rs rs [?? ??] 02f1 00a1
l__l560
                               branchhi_clr l__l560         ;  1 -V rs rs [?? h?] 02f2 120a
                               branchlo_clr l__l560         ;  1 -V rs rs [h? hl] 02f3 118a
                               decfsz   v__pic_temp+1,f     ;  1 -V rs rs [hl hl] 02f4 0ba1
                               goto     l__l560             ;  1 -V rs rs [hl hl] 02f5 2af2
                               branchhi_clr l__l559         ;  1 -V rs rs [hl hl] 02f6 120a
                               branchlo_clr l__l559         ;  1 -V rs rs [hl hl] 02f7 118a
                               decfsz   v__pic_temp,f       ;  1 -V rs rs [hl hl] 02f8 0ba0
                               goto     l__l559             ;  1 -V rs rs [hl hl] 02f9 2af0
;  121    end loop
                               datahi_set v__floop4         ;  1 OV rs Rs [hl hl] 02fa 1703
                                                            ; W = v__pic_temp
                               incf     v__floop4,f         ;  1 OV Rs Rs [hl hl] 02fb 0aa2
                                                            ; W = v__pic_temp
                               btfsc    v__status, v__z     ;  1 OV Rs Rs [hl hl] 02fc 1903
                                                            ; W = v__pic_temp
                               incf     v__floop4+1,f       ;  1 OV Rs Rs [hl hl] 02fd 0aa3
                                                            ; W = v__pic_temp
l__l359
                               movf     v__floop4,w         ;  1 OV Rs Rs [?? ??] 02fe 0822
                                                            ; W = v___n_3
                               datahi_clr v___n_3           ;  1 OV Rs rs [?? ??] 02ff 1303
                                                            ; W = v__floop4
                               subwf    v___n_3,w           ;  1 OV rs rs [?? ??] 0300 026e
                                                            ; W = v__floop4
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 0301 00a0
                               datahi_set v__floop4         ;  1 OV rs Rs [?? ??] 0302 1703
                                                            ; W = v__pic_temp
                               movf     v__floop4+1,w       ;  1 OV Rs Rs [?? ??] 0303 0823
                                                            ; W = v__pic_temp
                               datahi_clr v___n_3           ;  1 OV Rs rs [?? ??] 0304 1303
                                                            ; W = v__floop4
                               subwf    v___n_3+1,w         ;  1 OV rs rs [?? ??] 0305 026f
                                                            ; W = v__floop4
                               iorwf    v__pic_temp,w       ;  1 OV rs rs [?? ??] 0306 0420
                               btfss    v__status, v__z     ;  1 OV rs rs [?? ??] 0307 1d03
                               goto     l__l358             ;  1 OV rs rs [?? ??] 0308 2aec
;  122 end procedure
                               return                       ;  1 OV rs rs [?? ??] 0309 0008
                                                            ; W = v__pic_temp
;  138 end procedure
l__l368
; gps_converter.jal
;   16 var byte GpsErrorCode = 1  ; errorcode 1 = startup (wait for $).
                               movlw    1                   ;  0 OV ?? ?? [?? ??] 030a 3001
                               datalo_clr v_gpserrorcode    ;  0 OV ?? ?s [?? ??] 030b 1283
                               datahi_clr v_gpserrorcode    ;  0 OV ?s rs [?? ??] 030c 1303
                               movwf    v_gpserrorcode      ;  0 OV rs rs [?? ??] 030d 00e9
;   22 procedure DumpGpsInBuffer is      
                               goto     l__l405             ;  0 OV rs rs [?? ??] 030e 2ba8
                                                            ; W = v_gpserrorcode
;   44 function StoreBytes (byte in char) return bit is
l_storebytes
                               movwf    v___char_5          ;  1 OV rs rs [?? ??] 030f 00ee
                                                            ; W = v___char_7
;   47    if (char == ",") then
                               movlw    44                  ;  1 OV rs rs [?? ??] 0310 302c
                                                            ; W = v___char_5
                               subwf    v___char_5,w        ;  1 OV rs rs [?? ??] 0311 026e
                               btfss    v__status, v__z     ;  1 OV rs rs [?? ??] 0312 1d03
                               goto     l__l381             ;  1 OV rs rs [?? ??] 0313 2b16
;   48       return true
                               bsf      v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 0314 1420
                               return                       ;  1 OV rs rs [?? ??] 0315 0008
;   49    end if
l__l381
;   51    if (GpsInBufferIndex >= (IN_BUF_SIZE-1)) then
                               movlw    19                  ;  1 OV rs rs [?? ??] 0316 3013
                               subwf    v_gpsinbufferindex,w;  1 OV rs rs [?? ??] 0317 0267
                               btfsc    v__status, v__z     ;  1 OV rs rs [?? ??] 0318 1903
                               goto     l__l562             ;  1 OV rs rs [?? ??] 0319 2b1c
                               btfss    v__status, v__c     ;  1 OV rs rs [?? ??] 031a 1c03
                                                            ; W = v_gpserrorcode
                               goto     l__l383             ;  1 OV rs rs [?? ??] 031b 2b1f
                                                            ; W = v_gpserrorcode
l__l562
;   53       GpsErrorCode = 201
                               movlw    201                 ;  1 OV rs rs [?? ??] 031c 30c9
                               movwf    v_gpserrorcode      ;  1 OV rs rs [?? ??] 031d 00e9
;   54       return;
...
;   57    GpsInBuffer[GpsInBufferIndex] = char
                               movlw    v_gpsinbuffer       ;  1 OV rs rs [?? ??] 031f 3053
                                                            ; W = v_gpserrorcode
                               addwf    v_gpsinbufferindex,w;  1 OV rs rs [?? ??] 0320 0767
                               movwf    v__fsr              ;  1 OV rs rs [?? ??] 0321 0084
                               irp_clr                      ;  1 OV rs rs [?? ??] 0322 1383
                               movf     v___char_5,w        ;  1 OV rs rs [?? ??] 0323 086e
                               movwf    v__ind              ;  1 OV rs rs [?? ??] 0324 0080
                                                            ; W = v___char_5
;   58    GpsInBufferIndex = GpsInBufferIndex + 1
                               incf     v_gpsinbufferindex,f;  1 OV rs rs [?? ??] 0325 0ae7
;   59    GpsInBuffer[GpsInBufferIndex] = 0 ; iedere keer de afsluit-0 plaatsen.
                               movlw    v_gpsinbuffer       ;  1 OV rs rs [?? ??] 0326 3053
                               addwf    v_gpsinbufferindex,w;  1 OV rs rs [?? ??] 0327 0767
                               movwf    v__fsr              ;  1 OV rs rs [?? ??] 0328 0084
                               irp_clr                      ;  1 OV rs rs [?? ??] 0329 1383
                               clrf     v__ind              ;  1 OV rs rs [?? ??] 032a 0180
;   61    return false ; not done yet.
                               bcf      v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 032b 1020
;   62 end function
l__l379
                               return                       ;  1 OV rs rs [?? ??] 032c 0008
                                                            ; W = v_gpserrorcode
;   64 function IsMsg(byte in name[]) return bit is
l_ismsg
;   67    for 5 using i loop       
                               clrf     v___i_2             ;  2 OV Rs Rs [?? ??] 032d 01a4
                                                            ; W = v___name_1
l__l386
;   73       if (name[i] != GpsInBuffer[i]) then return false end if
                               movf     v___name_1+1,w      ;  2 OV Rs Rs [?? ??] 032e 0821
                               datahi_clr v__pic_pointer    ;  2 OV Rs rs [?? ??] 032f 1303
                                                            ; W = v___name_1
                               movwf    v__pic_pointer+1    ;  2 OV rs rs [?? ??] 0330 00b5
                                                            ; W = v___name_1
                               datahi_set v___i_2           ;  2 OV rs Rs [?? ??] 0331 1703
                                                            ; W = v__pic_pointer
                               movf     v___i_2,w           ;  2 OV Rs Rs [?? ??] 0332 0824
                                                            ; W = v__pic_pointer
                               addwf    v___name_1,w        ;  2 OV Rs Rs [?? ??] 0333 0720
                                                            ; W = v___i_2
                               datahi_clr v__pic_pointer    ;  2 OV Rs rs [?? ??] 0334 1303
                               movwf    v__pic_pointer      ;  2 OV rs rs [?? ??] 0335 00b4
                               btfsc    v__status, v__c     ;  2 OV rs rs [?? ??] 0336 1803
                                                            ; W = v__pic_pointer
                               incf     v__pic_pointer+1,f  ;  2 OV rs rs [?? ??] 0337 0ab5
                                                            ; W = v__pic_pointer
                               bcf      v__pic_pointer+1, 6 ;  2 OV rs rs [?? ??] 0338 1335
                               movf     v__pic_pointer+1,w  ;  2 OV rs rs [?? ??] 0339 0835
                               call     l__pic_indirect     ;  2 OV rs ?? [?? ??] 033a 20bd
                                                            ; W = v__pic_pointer
                               datalo_clr v__pic_temp       ;  2 OV ?? ?s [?? ??] 033b 1283
                               datahi_clr v__pic_temp       ;  2 OV ?s rs [?? ??] 033c 1303
                               movwf    v__pic_temp         ;  2 OV rs rs [?? ??] 033d 00a0
                               movlw    v_gpsinbuffer       ;  2 OV rs rs [?? ??] 033e 3053
                                                            ; W = v__pic_temp
                               datahi_set v___i_2           ;  2 OV rs Rs [?? ??] 033f 1703
                               addwf    v___i_2,w           ;  2 OV Rs Rs [?? ??] 0340 0724
                               movwf    v__fsr              ;  2 OV Rs Rs [?? ??] 0341 0084
                               irp_clr                      ;  2 OV Rs Rs [?? ??] 0342 1383
                               datahi_clr v__pic_temp       ;  2 OV Rs rs [?? ??] 0343 1303
                               movf     v__pic_temp,w       ;  2 OV rs rs [?? ??] 0344 0820
                               subwf    v__ind,w            ;  2 OV rs rs [?? ??] 0345 0200
                                                            ; W = v__pic_temp
                               btfsc    v__status, v__z     ;  2 OV rs rs [?? ??] 0346 1903
                               goto     l__l390             ;  2 OV rs rs [?? ??] 0347 2b4a
                               bcf      v__pic_temp, 0 ; _pic_temp   ;  2 OV rs rs [?? ??] 0348 1020
                                                            ; W = v___name_1
                               return                       ;  2 OV rs rs [?? ??] 0349 0008
                                                            ; W = v___name_1
l__l390
;   74    end loop
                               datahi_set v___i_2           ;  2 OV rs Rs [?? ??] 034a 1703
                               incf     v___i_2,f           ;  2 OV Rs Rs [?? ??] 034b 0aa4
                               movlw    5                   ;  2 OV Rs Rs [?? ??] 034c 3005
                               subwf    v___i_2,w           ;  2 OV Rs Rs [?? ??] 034d 0224
                               btfss    v__status, v__z     ;  2 OV Rs Rs [?? ??] 034e 1d03
                               goto     l__l386             ;  2 OV Rs Rs [?? ??] 034f 2b2e
;   78    return true
                               datahi_clr v__pic_temp ; _pic_temp    ;  2 OV Rs rs [?? ??] 0350 1303
                                                            ; W = v___name_1
                               bsf      v__pic_temp, 0 ; _pic_temp   ;  2 OV rs rs [?? ??] 0351 1420
                                                            ; W = v___name_1
;   79 end function
l__l385
...
;   89    if (IsMsg(str_gpgga)) then return 1 end if
                               movlw    l__data_str_gpgga   ;  1 OV rs rs [?? ??] 0353 3028
                               datahi_set v___name_1        ;  1 OV rs Rs [?? ??] 0354 1703
                               movwf    v___name_1          ;  1 OV Rs Rs [?? ??] 0355 00a0
                               movlw    HIGH l__data_str_gpgga;  1 OV Rs Rs [?? ??] 0356 3000
                                                            ; W = v___name_1
                               iorlw    64                  ;  1 OV Rs Rs [?? ??] 0357 3840
                               movwf    v___name_1+1        ;  1 OV Rs Rs [?? ??] 0358 00a1
                               call     l_ismsg             ;  1 OV Rs ?? [?? ??] 0359 232d
                                                            ; W = v___name_1
                               datalo_clr v____bitbucket_4 ; _btemp61;  1 OV ?? ?s [?? ??] 035a 1283
                               datahi_clr v____bitbucket_4 ; _btemp61;  1 OV ?s rs [?? ??] 035b 1303
                               bcf      v____bitbucket_4, 0 ; _btemp61;  1 OV rs rs [?? ??] 035c 106e
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 035d 1820
                               bsf      v____bitbucket_4, 0 ; _btemp61;  1 OV rs rs [?? ??] 035e 146e
                               btfsc    v____bitbucket_4, 0 ; _btemp61;  1 OV rs rs [?? ??] 035f 186e
                               retlw    1                   ;  1 OV rs rs [?? ??] 0360 3401
l__l394
;   90    if (IsMsg(str_gpgll)) then return 2 end if
                               movlw    l__data_str_gpgll   ;  1 OV rs rs [?? ??] 0361 303a
                               datahi_set v___name_1        ;  1 OV rs Rs [?? ??] 0362 1703
                               movwf    v___name_1          ;  1 OV Rs Rs [?? ??] 0363 00a0
                               movlw    HIGH l__data_str_gpgll;  1 OV Rs Rs [?? ??] 0364 3000
                                                            ; W = v___name_1
                               iorlw    64                  ;  1 OV Rs Rs [?? ??] 0365 3840
                               movwf    v___name_1+1        ;  1 OV Rs Rs [?? ??] 0366 00a1
                               call     l_ismsg             ;  1 OV Rs ?? [?? ??] 0367 232d
                                                            ; W = v___name_1
                               datalo_clr v____bitbucket_4 ; _btemp62;  1 OV ?? ?s [?? ??] 0368 1283
                               datahi_clr v____bitbucket_4 ; _btemp62;  1 OV ?s rs [?? ??] 0369 1303
                               bcf      v____bitbucket_4, 1 ; _btemp62;  1 OV rs rs [?? ??] 036a 10ee
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 036b 1820
                               bsf      v____bitbucket_4, 1 ; _btemp62;  1 OV rs rs [?? ??] 036c 14ee
                               btfsc    v____bitbucket_4, 1 ; _btemp62;  1 OV rs rs [?? ??] 036d 18ee
                               retlw    2                   ;  1 OV rs rs [?? ??] 036e 3402
l__l396
;   91    if (IsMsg(str_gpgsa)) then return 3 end if
                               movlw    l__data_str_gpgsa   ;  1 OV rs rs [?? ??] 036f 3034
                               datahi_set v___name_1        ;  1 OV rs Rs [?? ??] 0370 1703
                               movwf    v___name_1          ;  1 OV Rs Rs [?? ??] 0371 00a0
                               movlw    HIGH l__data_str_gpgsa;  1 OV Rs Rs [?? ??] 0372 3000
                                                            ; W = v___name_1
                               iorlw    64                  ;  1 OV Rs Rs [?? ??] 0373 3840
                               movwf    v___name_1+1        ;  1 OV Rs Rs [?? ??] 0374 00a1
                               call     l_ismsg             ;  1 OV Rs ?? [?? ??] 0375 232d
                                                            ; W = v___name_1
                               datalo_clr v____bitbucket_4 ; _btemp63;  1 OV ?? ?s [?? ??] 0376 1283
                               datahi_clr v____bitbucket_4 ; _btemp63;  1 OV ?s rs [?? ??] 0377 1303
                               bcf      v____bitbucket_4, 2 ; _btemp63;  1 OV rs rs [?? ??] 0378 116e
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 0379 1820
                               bsf      v____bitbucket_4, 2 ; _btemp63;  1 OV rs rs [?? ??] 037a 156e
                               btfsc    v____bitbucket_4, 2 ; _btemp63;  1 OV rs rs [?? ??] 037b 196e
                               retlw    3                   ;  1 OV rs rs [?? ??] 037c 3403
l__l398
;   92    if (IsMsg(str_gpgsv)) then return 4 end if
                               movlw    l__data_str_gpgsv   ;  1 OV rs rs [?? ??] 037d 3022
                               datahi_set v___name_1        ;  1 OV rs Rs [?? ??] 037e 1703
                               movwf    v___name_1          ;  1 OV Rs Rs [?? ??] 037f 00a0
                               movlw    HIGH l__data_str_gpgsv;  1 OV Rs Rs [?? ??] 0380 3000
                                                            ; W = v___name_1
                               iorlw    64                  ;  1 OV Rs Rs [?? ??] 0381 3840
                               movwf    v___name_1+1        ;  1 OV Rs Rs [?? ??] 0382 00a1
                               call     l_ismsg             ;  1 OV Rs ?? [?? ??] 0383 232d
                                                            ; W = v___name_1
                               datalo_clr v____bitbucket_4 ; _btemp64;  1 OV ?? ?s [?? ??] 0384 1283
                               datahi_clr v____bitbucket_4 ; _btemp64;  1 OV ?s rs [?? ??] 0385 1303
                               bcf      v____bitbucket_4, 3 ; _btemp64;  1 OV rs rs [?? ??] 0386 11ee
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 0387 1820
                               bsf      v____bitbucket_4, 3 ; _btemp64;  1 OV rs rs [?? ??] 0388 15ee
                               btfsc    v____bitbucket_4, 3 ; _btemp64;  1 OV rs rs [?? ??] 0389 19ee
                               retlw    4                   ;  1 OV rs rs [?? ??] 038a 3404
l__l400
;   93    if (IsMsg(str_gprmc)) then return 5 end if
                               movlw    l__data_str_gprmc   ;  1 OV rs rs [?? ??] 038b 3040
                               datahi_set v___name_1        ;  1 OV rs Rs [?? ??] 038c 1703
                               movwf    v___name_1          ;  1 OV Rs Rs [?? ??] 038d 00a0
                               movlw    HIGH l__data_str_gprmc;  1 OV Rs Rs [?? ??] 038e 3000
                                                            ; W = v___name_1
                               iorlw    64                  ;  1 OV Rs Rs [?? ??] 038f 3840
                               movwf    v___name_1+1        ;  1 OV Rs Rs [?? ??] 0390 00a1
                               call     l_ismsg             ;  1 OV Rs ?? [?? ??] 0391 232d
                                                            ; W = v___name_1
                               datalo_clr v____bitbucket_4 ; _btemp65;  1 OV ?? ?s [?? ??] 0392 1283
                               datahi_clr v____bitbucket_4 ; _btemp65;  1 OV ?s rs [?? ??] 0393 1303
                               bcf      v____bitbucket_4, 4 ; _btemp65;  1 OV rs rs [?? ??] 0394 126e
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 0395 1820
                               bsf      v____bitbucket_4, 4 ; _btemp65;  1 OV rs rs [?? ??] 0396 166e
                               btfsc    v____bitbucket_4, 4 ; _btemp65;  1 OV rs rs [?? ??] 0397 1a6e
                               retlw    5                   ;  1 OV rs rs [?? ??] 0398 3405
l__l402
;   94    if (IsMsg(str_gpvtg)) then return 6 end if
                               movlw    l__data_str_gpvtg   ;  1 OV rs rs [?? ??] 0399 302e
                               datahi_set v___name_1        ;  1 OV rs Rs [?? ??] 039a 1703
                               movwf    v___name_1          ;  1 OV Rs Rs [?? ??] 039b 00a0
                               movlw    HIGH l__data_str_gpvtg;  1 OV Rs Rs [?? ??] 039c 3000
                                                            ; W = v___name_1
                               iorlw    64                  ;  1 OV Rs Rs [?? ??] 039d 3840
                               movwf    v___name_1+1        ;  1 OV Rs Rs [?? ??] 039e 00a1
                               call     l_ismsg             ;  1 OV Rs ?? [?? ??] 039f 232d
                                                            ; W = v___name_1
                               datalo_clr v____bitbucket_4 ; _btemp66;  1 OV ?? ?s [?? ??] 03a0 1283
                               datahi_clr v____bitbucket_4 ; _btemp66;  1 OV ?s rs [?? ??] 03a1 1303
                               bcf      v____bitbucket_4, 5 ; _btemp66;  1 OV rs rs [?? ??] 03a2 12ee
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 03a3 1820
                               bsf      v____bitbucket_4, 5 ; _btemp66;  1 OV rs rs [?? ??] 03a4 16ee
                               btfsc    v____bitbucket_4, 5 ; _btemp66;  1 OV rs rs [?? ??] 03a5 1aee
                               retlw    6                   ;  1 OV rs rs [?? ??] 03a6 3406
l__l404
;   96    return 0 ; unknown message
                               retlw    0                   ;  1 OV rs rs [?? ??] 03a7 3400
;   97 end function
l__l392
;  164 end procedure                             
l__l405
...
;   70 T2CON_TOUTPS = 0b00                       -- postscaler 1:1
                               movlw    135                 ;  0 OV rs rs [?? ??] 03a8 3087
                                                            ; W = v_gpserrorcode
                               andwf    v_t2con,f           ;  0 OV rs rs [?? ??] 03a9 0592
;   71 T2CON_T2CKPS = 0b00                       -- prescaler 1:1
                               movlw    252                 ;  0 OV rs rs [?? ??] 03aa 30fc
                               andwf    v_t2con,f           ;  0 OV rs rs [?? ??] 03ab 0592
;   72 T2CON_TMR2ON = TRUE
                               bsf      v_t2con, 2 ; t2con_tmr2on       ;  0 OV rs rs [?? ??] 03ac 1512
;   73 PR2 = 249   -- count from 0 to 249 and skip back to 0 = 250 steps
                               movlw    249                 ;  0 OV rs rs [?? ??] 03ad 30f9
                               datalo_set v_pr2             ;  0 OV rs rS [?? ??] 03ae 1683
                               movwf    v_pr2               ;  0 OV rS rS [?? ??] 03af 0092
;   75 ccp1con_p1m = 0  -- alleen output op pin P1A
                               movlw    63                  ;  0 OV rS rS [?? ??] 03b0 303f
                               datalo_clr v_ccp1con         ;  0 OV rS rs [?? ??] 03b1 1283
                               andwf    v_ccp1con,f         ;  0 OV rs rs [?? ??] 03b2 0597
;   76 ccp1con_ccp1m = 0b1100  -- pwm mode
                               movlw    240                 ;  0 OV rs rs [?? ??] 03b3 30f0
                               andwf    v_ccp1con,w         ;  0 OV rs rs [?? ??] 03b4 0517
                               iorlw    12                  ;  0 OV rs rs [?? ??] 03b5 380c
                               movwf    v_ccp1con           ;  0 OV rs rs [?? ??] 03b6 0097
;   77 pin_c5_direction = output
                               datalo_set v_trisc ; pin_c5_direction        ;  0 OV rs rS [?? ??] 03b7 1683
                                                            ; W = v_ccp1con
                               bcf      v_trisc, 5 ; pin_c5_direction       ;  0 OV rS rS [?? ??] 03b8 1287
                                                            ; W = v_ccp1con
;   79 PIE1_TMR2IE = true
                               bsf      v_pie1, 1 ; pie1_tmr2ie        ;  0 OV rS rS [?? ??] 03b9 148c
                                                            ; W = v_ccp1con
;   80 INTCON_GIE = true
                               bsf      v_intcon, 7 ; intcon_gie      ;  0 OV rS rS [?? ??] 03ba 178b
                                                            ; W = v_ccp1con
;   81 INTCON_PEIE = true
                               bsf      v_intcon, 6 ; intcon_peie      ;  0 OV rS rS [?? ??] 03bb 170b
                                                            ; W = v_ccp1con
;   83 var volatile word Ticks = 0   
                               datalo_clr v_ticks           ;  0 OV rS rs [?? ??] 03bc 1283
                                                            ; W = v_ccp1con
                               clrf     v_ticks             ;  0 OV rs rs [?? ??] 03bd 01b8
                                                            ; W = v_ccp1con
                               clrf     v_ticks+1           ;  0 OV rs rs [?? ??] 03be 01b9
                                                            ; W = v_ccp1con
;   87 print_string(serial_hw_data, str1)      
                               movlw    l__serial_hw_data_put;  0 OV rs rs [?? ??] 03bf 30e5
                                                            ; W = v_ccp1con
                               movwf    v____device_put_1   ;  0 OV rs rs [?? ??] 03c0 00ee
                               movlw    HIGH l__serial_hw_data_put;  0 OV rs rs [?? ??] 03c1 3001
                                                            ; W = v____device_put_1
                               movwf    v____device_put_1+1 ;  0 OV rs rs [?? ??] 03c2 00ef
                               movlw    10                  ;  0 OV rs rs [?? ??] 03c3 300a
                                                            ; W = v____device_put_1
                               datahi_set v__str_count      ;  0 OV rs Rs [?? ??] 03c4 1703
                               movwf    v__str_count        ;  0 OV Rs Rs [?? ??] 03c5 00a2
                               clrf     v__str_count+1      ;  0 OV Rs Rs [?? ??] 03c6 01a3
                                                            ; W = v__str_count
                               movlw    l__data_str1_2      ;  0 OV Rs Rs [?? ??] 03c7 3010
                                                            ; W = v__str_count
                               movwf    v___str_1           ;  0 OV Rs Rs [?? ??] 03c8 00a6
                               movlw    HIGH l__data_str1_2 ;  0 OV Rs Rs [?? ??] 03c9 3000
                                                            ; W = v___str_1
                               iorlw    64                  ;  0 OV Rs Rs [?? ??] 03ca 3840
                               movwf    v___str_1+1         ;  0 OV Rs Rs [?? ??] 03cb 00a7
                               call     l_print_string      ;  0 OV Rs ?? [?? ??] 03cc 2202
                                                            ; W = v___str_1
;   89 procedure SetDutyCycle (word in duty) is
                               goto     l__l429             ;  0 OV ?? ?? [?? ??] 03cd 2c0a
l_setdutycycle
;   91    if (duty > 999) then 
                               movlw    3                   ;  1 OV rs rs [?? ??] 03ce 3003
                                                            ; W = v___duty_1
                               subwf    v___duty_1+1,w      ;  1 OV rs rs [?? ??] 03cf 026f
                               btfss    v__status, v__z     ;  1 OV rs rs [?? ??] 03d0 1d03
                               goto     l__l563             ;  1 OV rs rs [?? ??] 03d1 2bd4
                               movlw    231                 ;  1 OV rs rs [?? ??] 03d2 30e7
                               subwf    v___duty_1,w        ;  1 OV rs rs [?? ??] 03d3 026e
l__l563
                               btfsc    v__status, v__z     ;  1 OV rs rs [?? ??] 03d4 1903
                               goto     l__l428             ;  1 OV rs rs [?? ??] 03d5 2bdf
                               btfss    v__status, v__c     ;  1 OV rs rs [?? ??] 03d6 1c03
                                                            ; W = v_ccp1con
                               goto     l__l428             ;  1 OV rs rs [?? ??] 03d7 2bdf
                                                            ; W = v_ccp1con
;   92       duty = 999
                               movlw    231                 ;  1 OV rs rs [?? ??] 03d8 30e7
                               movwf    v___duty_1          ;  1 OV rs rs [?? ??] 03d9 00ee
                               movlw    3                   ;  1 OV rs rs [?? ??] 03da 3003
                                                            ; W = v___duty_1
                               movwf    v___duty_1+1        ;  1 OV rs rs [?? ??] 03db 00ef
;   93       serial_hw_data = "E"
                               movlw    69                  ;  1 OV rs rs [?? ??] 03dc 3045
                                                            ; W = v___duty_1
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 03dd 00a0
                               call     l__serial_hw_data_put;  1 OV rs ?? [?? ??] 03de 21e5
                                                            ; W = v__pic_temp
;   94    end if                
l__l428
;   96    ccpr1l = byte(duty >> 2)
                               bcf      v__status, v__c     ;  1 OV ?? ?? [?? ??] 03df 1003
                                                            ; W = v_ccp1con
                               datalo_clr v___duty_1        ;  1 OV ?? ?s [?? ??] 03e0 1283
                                                            ; W = v_ccp1con
                               datahi_clr v___duty_1        ;  1 OV ?s rs [?? ??] 03e1 1303
                                                            ; W = v_ccp1con
                               rrf      v___duty_1+1,w      ;  1 OV rs rs [?? ??] 03e2 0c6f
                                                            ; W = v_ccp1con
                               movwf    v__pic_temp+1       ;  1 OV rs rs [?? ??] 03e3 00a1
                               rrf      v___duty_1,w        ;  1 OV rs rs [?? ??] 03e4 0c6e
                                                            ; W = v__pic_temp
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 03e5 00a0
                               bcf      v__status, v__c     ;  1 OV rs rs [?? ??] 03e6 1003
                                                            ; W = v__pic_temp
                               rrf      v__pic_temp+1,f     ;  1 OV rs rs [?? ??] 03e7 0ca1
                                                            ; W = v__pic_temp
                               rrf      v__pic_temp,f       ;  1 OV rs rs [?? ??] 03e8 0ca0
                               movf     v__pic_temp,w       ;  1 OV rs rs [?? ??] 03e9 0820
                               movwf    v_ccpr1l            ;  1 OV rs rs [?? ??] 03ea 0095
                                                            ; W = v__pic_temp
;   97    ccp1con_dc1b = byte(duty) & 0b11
                               movlw    3                   ;  1 OV rs rs [?? ??] 03eb 3003
                               andwf    v___duty_1,w        ;  1 OV rs rs [?? ??] 03ec 056e
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 03ed 00a0
                               swapf    v__pic_temp,w       ;  1 OV rs rs [?? ??] 03ee 0e20
                                                            ; W = v__pic_temp
                               movwf    v__pic_temp+1       ;  1 OV rs rs [?? ??] 03ef 00a1
                               movlw    48                  ;  1 OV rs rs [?? ??] 03f0 3030
                                                            ; W = v__pic_temp
                               andwf    v__pic_temp+1,f     ;  1 OV rs rs [?? ??] 03f1 05a1
                               movlw    207                 ;  1 OV rs rs [?? ??] 03f2 30cf
                               andwf    v_ccp1con,w         ;  1 OV rs rs [?? ??] 03f3 0517
                               iorwf    v__pic_temp+1,w     ;  1 OV rs rs [?? ??] 03f4 0421
                               movwf    v_ccp1con           ;  1 OV rs rs [?? ??] 03f5 0097
;   99 end procedure
                               return                       ;  1 OV rs rs [?? ??] 03f6 0008
                                                            ; W = v_ccp1con
;  104 procedure isr is
l_isr
;  107    if (PIR1_TMR2IF) then
                               btfss    v_pir1, 1 ; pir1_tmr2if        ;  4 OV rs rs [hl hl] 03f7 1c8c
                                                            ; W = v__pic_isr_fsr
                               goto     l__serial_receive_interrupt_handler;  4 OV rs rs [hl hl] 03f8 2913
                                                            ; W = v__pic_isr_fsr
;  108       PIR1_TMR2IF = false
                               bcf      v_pir1, 1 ; pir1_tmr2if        ;  4 OV rs rs [hl hl] 03f9 108c
                                                            ; W = v___x_67
;  109       Ticks = Ticks + 1
                               incf     v_ticks,f           ;  4 OV rs rs [hl hl] 03fa 0ab8
                                                            ; W = v___x_67
                               btfsc    v__status, v__z     ;  4 OV rs rs [hl hl] 03fb 1903
                                                            ; W = v___x_67
                               incf     v_ticks+1,f         ;  4 OV rs rs [hl hl] 03fc 0ab9
                                                            ; W = v___x_67
;  110       if (Ticks > 9999) then
                               movlw    39                  ;  4 OV rs rs [hl hl] 03fd 3027
                                                            ; W = v___x_67
                               subwf    v_ticks+1,w         ;  4 OV rs rs [hl hl] 03fe 0239
                               btfss    v__status, v__z     ;  4 OV rs rs [hl hl] 03ff 1d03
                               goto     l__l565             ;  4 OV rs rs [hl hl] 0400 2c03
                               movlw    15                  ;  4 OV rs rs [hl hl] 0401 300f
                               subwf    v_ticks,w           ;  4 OV rs rs [hl hl] 0402 0238
l__l565
                               btfsc    v__status, v__z     ;  4 OV rs rs [hl hl] 0403 1903
                               goto     l__serial_receive_interrupt_handler;  4 OV rs rs [hl hl] 0404 2913
                               btfss    v__status, v__c     ;  4 OV rs rs [hl hl] 0405 1c03
                               goto     l__serial_receive_interrupt_handler;  4 OV rs rs [hl hl] 0406 2913
;  111          Ticks = 0
                               clrf     v_ticks             ;  4 OV rs rs [hl hl] 0407 01b8
                               clrf     v_ticks+1           ;  4 OV rs rs [hl hl] 0408 01b9
;  113    end if   
                               goto     l__serial_receive_interrupt_handler;  4 OV rs rs [hl hl] 0409 2913
;  115 end procedure
l__l429
;  118 for 8 loop
                               datalo_clr v__floop7         ;  0 OV ?? ?s [?? ??] 040a 1283
                               datahi_clr v__floop7         ;  0 OV ?s rs [?? ??] 040b 1303
                               clrf     v__floop7           ;  0 OV rs rs [?? ??] 040c 01ea
l__l435
;  120    led1 = ! led1 
                               btfss    v_porta, 2 ; pin_a2       ;  0 OV rs rs [?? ??] 040d 1d05
                               goto     l__l568             ;  0 OV rs rs [?? ??] 040e 2c11
                               bcf      v__bitbucket, 2 ; _btemp79  ;  0 OV rs rs [?? ??] 040f 116b
                                                            ; W = v_gpserrorcode
                               goto     l__l567             ;  0 OV rs rs [?? ??] 0410 2c12
                                                            ; W = v_gpserrorcode
l__l568
                               bsf      v__bitbucket, 2 ; _btemp79  ;  0 OV rs rs [?? ??] 0411 156b
l__l567
                               bcf      v__porta_shadow, 2 ; x69;  0 OV rs rs [?? ??] 0412 1142
                               btfsc    v__bitbucket, 2 ; _btemp79  ;  0 OV rs rs [?? ??] 0413 196b
                               bsf      v__porta_shadow, 2 ; x69;  0 OV rs rs [?? ??] 0414 1542
; 16f690.jal
;  100    PORTA = _PORTA_shadow
                               movf     v__porta_shadow,w   ;  0 OV rs rs [?? ??] 0415 0842
                               movwf    v_porta             ;  0 OV rs rs [?? ??] 0416 0085
                                                            ; W = v__porta_shadow
; jallib.jal
;  120    led1 = ! led1 
; 16f690.jal
...
;  120    led1 = ! led1 
;  121    delay_1ms(50)
                               movlw    50                  ;  0 OV rs rs [?? ??] 0417 3032
                               movwf    v___n_3             ;  0 OV rs rs [?? ??] 0418 00ee
                               clrf     v___n_3+1           ;  0 OV rs rs [?? ??] 0419 01ef
                                                            ; W = v___n_3
                               call     l_delay_1ms         ;  0 OV rs ?? [?? ??] 041a 22e8
                                                            ; W = v___n_3
;  122 end loop
                               datalo_clr v__floop7         ;  0 OV ?? ?s [?? ??] 041b 1283
                               datahi_clr v__floop7         ;  0 OV ?s rs [?? ??] 041c 1303
                               incf     v__floop7,f         ;  0 OV rs rs [?? ??] 041d 0aea
                               movlw    8                   ;  0 OV rs rs [?? ??] 041e 3008
                               subwf    v__floop7,w         ;  0 OV rs rs [?? ??] 041f 026a
                               btfss    v__status, v__z     ;  0 OV rs rs [?? ??] 0420 1d03
                               goto     l__l435             ;  0 OV rs rs [?? ??] 0421 2c0d
;  124 SetDutyCycle(500)
                               movlw    244                 ;  0 OV rs rs [?? ??] 0422 30f4
                               movwf    v___duty_1          ;  0 OV rs rs [?? ??] 0423 00ee
                               movlw    1                   ;  0 OV rs rs [?? ??] 0424 3001
                                                            ; W = v___duty_1
                               movwf    v___duty_1+1        ;  0 OV rs rs [?? ??] 0425 00ef
                               call     l_setdutycycle      ;  0 OV rs ?? [?? ??] 0426 23ce
                                                            ; W = v___duty_1
;  129 forever loop    
l__l440
;  139  gpstakt()
...
;  111    if (!Serial_HW_read(char)) then
                               call     l_serial_hw_read    ;  0 OV ?? ?? [?? ??] 0427 2161
                               datalo_clr v___char_7        ;  0 OV ?? ?s [?? ??] 0428 1283
                               datahi_clr v___char_7        ;  0 OV ?s rs [?? ??] 0429 1303
                               movwf    v___char_7          ;  0 OV rs rs [?? ??] 042a 00ed
                               bcf      v__bitbucket, 4 ; _btemp671  ;  0 OV rs rs [?? ??] 042b 126b
                                                            ; W = v___char_7
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  0 OV rs rs [?? ??] 042c 1820
                                                            ; W = v___char_7
                               bsf      v__bitbucket, 4 ; _btemp671  ;  0 OV rs rs [?? ??] 042d 166b
                                                            ; W = v___char_7
                               btfss    v__bitbucket, 4 ; _btemp671  ;  0 OV rs rs [?? ??] 042e 1e6b
                                                            ; W = v___char_7
; jallib.jal
;  139  gpstakt()
; gps_converter.jal
;  112       return
                               goto     l__l440             ;  0 OV rs rs [?? ??] 042f 2c27
                                                            ; W = v_gpserrorcode
;  113    end if
l__l442
; jallib.jal
...
;  119    if (GpsErrorCode > 1) then                     
                               movlw    1                   ;  0 OV rs rs [?? ??] 0430 3001
                                                            ; W = v___char_7
                               subwf    v_gpserrorcode,w    ;  0 OV rs rs [?? ??] 0431 0269
                               btfsc    v__status, v__z     ;  0 OV rs rs [?? ??] 0432 1903
                               goto     l__l446             ;  0 OV rs rs [?? ??] 0433 2c57
                               btfss    v__status, v__c     ;  0 OV rs rs [?? ??] 0434 1c03
                               goto     l__l446             ;  0 OV rs rs [?? ??] 0435 2c57
; jallib.jal
;  139  gpstakt()
; gps_converter.jal
;  120       print_string(serial_hw_data, str_error)
                               movlw    l__serial_hw_data_put;  0 OV rs rs [?? ??] 0436 30e5
                               movwf    v____device_put_1   ;  0 OV rs rs [?? ??] 0437 00ee
                               movlw    HIGH l__serial_hw_data_put;  0 OV rs rs [?? ??] 0438 3001
                                                            ; W = v____device_put_1
                               movwf    v____device_put_1+1 ;  0 OV rs rs [?? ??] 0439 00ef
                               movlw    6                   ;  0 OV rs rs [?? ??] 043a 3006
                                                            ; W = v____device_put_1
                               datahi_set v__str_count      ;  0 OV rs Rs [?? ??] 043b 1703
                               movwf    v__str_count        ;  0 OV Rs Rs [?? ??] 043c 00a2
                               clrf     v__str_count+1      ;  0 OV Rs Rs [?? ??] 043d 01a3
                                                            ; W = v__str_count
                               movlw    l__data_str_error   ;  0 OV Rs Rs [?? ??] 043e 301b
                                                            ; W = v__str_count
                               movwf    v___str_1           ;  0 OV Rs Rs [?? ??] 043f 00a6
                               movlw    HIGH l__data_str_error;  0 OV Rs Rs [?? ??] 0440 3000
                                                            ; W = v___str_1
                               iorlw    64                  ;  0 OV Rs Rs [?? ??] 0441 3840
                               movwf    v___str_1+1         ;  0 OV Rs Rs [?? ??] 0442 00a7
                               call     l_print_string      ;  0 OV Rs ?? [?? ??] 0443 2202
                                                            ; W = v___str_1
;  121       print_byte_dec(serial_hw_data, GpsErrorCode)
                               movlw    l__serial_hw_data_put;  0 OV ?? ?? [?? ??] 0444 30e5
                               datalo_clr v____device_put_19;  0 OV ?? ?s [?? ??] 0445 1283
                               datahi_clr v____device_put_19;  0 OV ?s rs [?? ??] 0446 1303
                               movwf    v____device_put_19  ;  0 OV rs rs [?? ??] 0447 00ee
                               movlw    HIGH l__serial_hw_data_put;  0 OV rs rs [?? ??] 0448 3001
                                                            ; W = v____device_put_19
                               movwf    v____device_put_19+1;  0 OV rs rs [?? ??] 0449 00ef
                               movf     v_gpserrorcode,w    ;  0 OV rs rs [?? ??] 044a 0869
                                                            ; W = v____device_put_19
                               call     l_print_byte_dec    ;  0 OV rs ?? [?? ??] 044b 222b
                                                            ; W = v_gpserrorcode
;  122       print_crlf(serial_hw_data) 
                               movlw    l__serial_hw_data_put;  0 OV ?? ?? [?? ??] 044c 30e5
                               datalo_clr v__device_put     ;  0 OV ?? ?s [?? ??] 044d 1283
                               datahi_clr v__device_put     ;  0 OV ?s rs [?? ??] 044e 1303
                               movwf    v__device_put       ;  0 OV rs rs [?? ??] 044f 00ee
                               movlw    HIGH l__serial_hw_data_put;  0 OV rs rs [?? ??] 0450 3001
                                                            ; W = v__device_put
                               movwf    v__device_put+1     ;  0 OV rs rs [?? ??] 0451 00ef
                               call     l_print_crlf        ;  0 OV rs ?? [?? ??] 0452 21f4
                                                            ; W = v__device_put
;  123       GpsErrorCode = 1
                               movlw    1                   ;  0 OV ?? ?? [?? ??] 0453 3001
                               datalo_clr v_gpserrorcode    ;  0 OV ?? ?s [?? ??] 0454 1283
                               datahi_clr v_gpserrorcode    ;  0 OV ?s rs [?? ??] 0455 1303
                               movwf    v_gpserrorcode      ;  0 OV rs rs [?? ??] 0456 00e9
;  124    end if
l__l446
;  126    if (char == "$") then
                               movlw    36                  ;  0 OV rs rs [?? ??] 0457 3024
                               subwf    v___char_7,w        ;  0 OV rs rs [?? ??] 0458 026d
                               btfss    v__status, v__z     ;  0 OV rs rs [?? ??] 0459 1d03
                               goto     l__l448             ;  0 OV rs rs [?? ??] 045a 2c60
; jallib.jal
;  139  gpstakt()
; gps_converter.jal
;  128       GpsMsgNr    = 0
                               clrf     v_gpsmsgnr          ;  0 OV rs rs [?? ??] 045b 01b7
;  129       GpsFieldNr  = 0                      
                               clrf     v_gpsfieldnr        ;  0 OV rs rs [?? ??] 045c 01e8
;  130       GpsInBufferIndex = 0
                               clrf     v_gpsinbufferindex  ;  0 OV rs rs [?? ??] 045d 01e7
;  132       GpsErrorCode = 0  ; clear prev errors on new msg start
                               clrf     v_gpserrorcode      ;  0 OV rs rs [?? ??] 045e 01e9
;  135       return
                               goto     l__l440             ;  0 OV rs rs [?? ??] 045f 2c27
;  136    end if
l__l448
;  138    if (GpsErrorCode > 0) then
                               movf     v_gpserrorcode,w    ;  0 OV rs rs [?? ??] 0460 0869
                               btfss    v__status, v__z     ;  0 OV rs rs [?? ??] 0461 1d03
                                                            ; W = v_gpserrorcode
; jallib.jal
;  139  gpstakt()
; gps_converter.jal
;  139       return
                               goto     l__l440             ;  0 OV rs rs [?? ??] 0462 2c27
;  140    end if   
l__l450
;  142    if (StoreBytes(char)) then ; put byte in buffer, true = field end
                               movf     v___char_7,w        ;  0 OV rs rs [?? ??] 0463 086d
                                                            ; W = v_gpserrorcode
                               call     l_storebytes        ;  0 OV rs ?? [?? ??] 0464 230f
                                                            ; W = v___char_7
                               datalo_clr v__bitbucket+1 ; _btemp731 ;  0 OV ?? ?s [?? ??] 0465 1283
                               datahi_clr v__bitbucket+1 ; _btemp731 ;  0 OV ?s rs [?? ??] 0466 1303
                               bcf      v__bitbucket+1, 2 ; _btemp731;  0 OV rs rs [?? ??] 0467 116c
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  0 OV rs rs [?? ??] 0468 1820
                               bsf      v__bitbucket+1, 2 ; _btemp731;  0 OV rs rs [?? ??] 0469 156c
                               btfss    v__bitbucket+1, 2 ; _btemp731;  0 OV rs rs [?? ??] 046a 1d6c
                               goto     l__l458             ;  0 OV rs rs [?? ??] 046b 2c94
; jallib.jal
;  139  gpstakt()
; gps_converter.jal
;  144       if (GpsFieldNr == 0) then
                               movf     v_gpsfieldnr,w      ;  0 OV rs rs [?? ??] 046c 0868
                               btfss    v__status, v__z     ;  0 OV rs rs [?? ??] 046d 1d03
                                                            ; W = v_gpsfieldnr
                               goto     l__l456             ;  0 OV rs rs [?? ??] 046e 2c90
                                                            ; W = v_gpsfieldnr
; jallib.jal
;  139  gpstakt()
; gps_converter.jal
;  147          GpsMsgNr = ParseMessageID()    
                               call     l_parsemessageid    ;  0 OV rs ?? [?? ??] 046f 2353
                               datalo_clr v_gpsmsgnr        ;  0 OV ?? ?s [?? ??] 0470 1283
                               datahi_clr v_gpsmsgnr        ;  0 OV ?s rs [?? ??] 0471 1303
                               movwf    v_gpsmsgnr          ;  0 OV rs rs [?? ??] 0472 00b7
;  149          print_string(serial_hw_data, str_msg)  
                               movlw    l__serial_hw_data_put;  0 OV rs rs [?? ??] 0473 30e5
                               movwf    v____device_put_1   ;  0 OV rs rs [?? ??] 0474 00ee
                               movlw    HIGH l__serial_hw_data_put;  0 OV rs rs [?? ??] 0475 3001
                                                            ; W = v____device_put_1
                               movwf    v____device_put_1+1 ;  0 OV rs rs [?? ??] 0476 00ef
...
;  150          print_byte_dec(serial_hw_data, GpsMsgNr) 
                               ...
                               movf     v_gpsmsgnr,w        ;  0 OV rs rs [?? ??] 0487 0837
                                                            ; W = v____device_put_19
                               call     l_print_byte_dec    ;  0 OV rs ?? [?? ??] 0488 222b
;  151          print_crlf(serial_hw_data)
                               ...
                               movwf    v__device_put       ;  0 OV rs rs [?? ??] 048c 00ee
                               movlw    HIGH l__serial_hw_data_put;  0 OV rs rs [?? ??] 048d 3001
                                                            ; W = v__device_put
                               movwf    v__device_put+1     ;  0 OV rs rs [?? ??] 048e 00ef
...
;  160       GpsInBufferIndex = 0
                               ...
                               datahi_clr v_gpsinbufferindex;  0 OV ?s rs [?? ??] 0491 1303
                                                            ; W = v_gpsfieldnr
                               clrf     v_gpsinbufferindex  ;  0 OV rs rs [?? ??] 0492 01e7
                                                            ; W = v_gpsfieldnr
;  161       GpsFieldNr = GpsFieldNr + 1
                               incf     v_gpsfieldnr,f      ;  0 OV rs rs [?? ??] 0493 0ae8
                                                            ; W = v_gpsfieldnr
;  163    end if
l__l458
;  164 end procedure                             
...
;  139  gpstakt()
;  161 end loop
                               goto     l__l440             ;  0 OV rs rs [?? ??] 0494 2c27
                               end
...
;     487108:__porta_shadow byte (type=i dflags=----- auto sz=1 use=1 assigned=3 base=0042)
...
;     4e5d28:__serial_rcvbuf  (type=a dflags=----- auto sz=12 use=2 assigned=2 base=0043)
...
;      = 20
;     550d58:_gpsinbuffer  (type=a dflags=----- auto sz=20 use=3 assigned=3 base=0053)
;     55ca38:_gpsinbufferindex byte (type=i dflags=----- auto sz=1 use=4 assigned=3 base=0067)
;     55cb28:_gpsmsgnr byte (type=i dflags=-V--- auto sticky sz=1 use=1 assigned=2 base=0037)
;     55cbe8:_gpsfieldnr byte (type=i dflags=----- auto sz=1 use=2 assigned=2 base=0068)
;     55cd78:_gpserrorcode byte (type=i dflags=----- auto sz=1 use=3 assigned=4 base=0069)
...
;     5608f8:_storebytes_1  (type=F dflags=----- sz=2 use=0 assigned=0 base=0000)
;     5642b8:_ismsg_1  (type=F dflags=----- sz=5 use=0 assigned=0 base=0000)
;     566b48:_str_gpgga  (type=a dflags=C---- lookup sz=5 use=1 assigned=0)
;      = 71,80,71,71,65
;     566e78:_str_gpgll  (type=a dflags=C---- lookup sz=5 use=1 assigned=0)
;      = 71,80,71,76,76
...
;      = 71,80,86,84,71
;     5605f8:_parsemessageid_1  (type=F dflags=----- sz=1 use=0 assigned=0 base=0000)
...
;     579788:_ticks word (type=i dflags=-V--- auto sticky sz=2 use=4 assigned=6 base=0038)
...
;     57f8c8:__floop7  (type=i dflags=----- auto sz=1 use=2 assigned=2 base=006a)
...
;      = 0
;     575298:__bitbucket  (type=i dflags=----- auto sz=2 use=6 assigned=12 base=006b)
;     52c638:__pic_isr_fsr  (type=i dflags=----- sz=1 use=1 assigned=1 base=0036)
;     52ba28:__pic_isr_status  (type=i dflags=----- sz=1 use=1 assigned=1 base=0030)
;     52b818:__pic_isr_pclath  (type=i dflags=----- sz=1 use=1 assigned=1 base=0031)
;     527418:__pic_temp  (type=i dflags=----- sz=2 use=21 assigned=27) ---> _pic_state+0
;     51ed48:__pic_pointer  (type=i dflags=----- sz=2 use=5 assigned=13 base=0034)
;     510c18:__pic_loop  (type=i dflags=----- sz=1 use=1 assigned=2 base=0032)
;     5108b8:__pic_divisor  (type=i dflags=----- sz=4 use=20 assigned=16) ---> _pic_state+8
;     5106a8:__pic_dividend  (type=i dflags=----- sz=4 use=9 assigned=16) ---> _pic_state+0
;     50fb18:__pic_quotient  (type=i dflags=----- sz=4 use=17 assigned=13) ---> _pic_state+12
;     50f468:__pic_remainder  (type=i dflags=----- sz=4 use=20 assigned=16) ---> _pic_state+4
...
;     60f1c8:__pic_state  (type=i dflags=----- sz=16 use=95 assigned=96 base=0020)
;     --- labels ---
...
;     _print_universal_dec (pc(0241) usage=5)
...
;     print_byte_dec (pc(022b) usage=10)
...
;     delay_1ms (pc(02e8) usage=5)
;     delay_100ms (pc(0000) usage=0)
;     delay_1s (pc(0000) usage=0)
;     dumpgpsinbuffer (pc(0000) usage=0)
;     storebytes (pc(030f) usage=5)
;     ismsg (pc(032d) usage=30)
;     parsemessageid (pc(0353) usage=5)
;     gpstakt (pc(0000) usage=0)
;     setdutycycle (pc(03ce) usage=5)
;     isr (pc(03f7) usage=5)
...
;         --- records ---
;         --- variables ---
;         581e98:_char_7 byte (type=i dflags=----- auto sz=1 use=2 assigned=1 base=006d)
...
;         = 0
;        574418:__bitbucket_1  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        579f48:_duty_1 word (type=i dflags=----- auto sz=2 use=5 assigned=4 base=006e)
...
;         = 0
;        559f38:__bitbucket_2  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        571ed8:__btemp72  (type=B dflags=---B- sz=1 use=0 assigned=0 base=0000 bit=5)
...
;         = 0
;        55f738:__bitbucket_3  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        566728:__btemp_22  (type=i dflags=---B- sz=6 use=0 assigned=0 bit=0) ---> ___bitbucket4+0
;        566818:__btemp61  (type=B dflags=---B- sz=1 use=1 assigned=2 bit=0) ---> ___bitbucket4+0
...
;        55f258:__bitbucket_4  (type=i dflags=----- auto sz=1 use=6 assigned=12 base=006e)
;        --- labels ---
;        {block enter}
;          --- records ---
;          --- variables ---
...
;        --- records ---
;        --- variables ---
;        5644f8:__name_count  (type=i dflags=C---- sz=2 use=0 assigned=2)
;         = 0
;        5645b8:_name_1  (type=* dflags=----- auto ptr_lookup sz=2 use=2 assigned=12 base=0120)
;        564688:_i_2 byte (type=i dflags=----- auto sz=1 use=4 assigned=2 base=0124)
;        564f38:__btemp_21  (type=i dflags=C--B- sz=2 use=0 assigned=0 bit=0)
;         = 0
;        565c88:__btemp60  (type=B dflags=---B- sz=1 use=0 assigned=0 base=0000 bit=1)
;        55ed78:__bitbucket_5  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
;          --- variables ---
;          565148:__btemp59  (type=B dflags=---B- sz=1 use=0 assigned=0 base=0000 bit=0)
;          --- labels ---
;          {block enter}
;            --- records ---
;            --- variables ---
...
;        --- records ---
;        --- variables ---
;        560ae8:_char_5 byte (type=i dflags=----- auto sz=1 use=2 assigned=1 base=006e)
;        560d88:__btemp_20  (type=i dflags=C--B- sz=2 use=0 assigned=0 bit=0)
;         = 0
;        560e58:__btemp57  (type=B dflags=---B- sz=1 use=0 assigned=0 base=0000 bit=0)
;        561b08:__btemp58  (type=B dflags=---B- sz=1 use=0 assigned=0 base=0000 bit=1)
;        5623b8:__temp_45  (type=? dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        55d598:__bitbucket_6  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        55d4a8:__bitbucket_7  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        55ab58:__bitbucket_8  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        558c38:__bitbucket_9  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        5566d8:_n_3 word (type=i dflags=----- auto sz=2 use=2 assigned=2 base=006e)
...
;        553c78:__bitbucket_10  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        552608:__bitbucket_11  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        551f18:__bitbucket_12  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        545e68:__bitbucket_13  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        544e38:__bitbucket_14  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        542f98:__bitbucket_15  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        542e98:__bitbucket_16  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        542108:__bitbucket_17  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        541f98:__bitbucket_18  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        541208:__bitbucket_19  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        541108:__bitbucket_20  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        543ac8:__device_put_19  (type=* dflags=----- auto ptr_ptr sz=2 use=2 assigned=4 base=006e)
;        543b88:_data_49 byte (type=i dflags=----- auto sz=1 use=1 assigned=1 base=0122)
;        540338:__bitbucket_21  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        540238:__bitbucket_22  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        4fdf28:__bitbucket_23  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        4f8e28:__bitbucket_24  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        4f4f78:__bitbucket_25  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        53fe18:__bitbucket_26  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        53fd18:__bitbucket_27  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        53f8a8:__bitbucket_28  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53f698:__bitbucket_29  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53e838:__bitbucket_30  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53e738:__bitbucket_31  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        53d978:__bitbucket_32  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53d878:__bitbucket_33  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53c948:__bitbucket_34  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53c778:__bitbucket_35  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 108,111,119
;        53c268:__bitbucket_36  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 102,97,108,115,101
;        53b8e8:__bitbucket_37  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        515bb8:__device_put_1  (type=* dflags=----- auto ptr_ptr sz=2 use=2 assigned=6 base=006e)
...
;        515f78:_i byte (type=i dflags=----- auto sz=1 use=3 assigned=2 base=012e)
...
;        53bc58:__bitbucket_38  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        5158e8:__device_put  (type=* dflags=----- auto ptr_ptr sz=2 use=4 assigned=4 base=006e)
;        53ba48:__bitbucket_39  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        53b408:__bitbucket_40  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53b1d8:__bitbucket_41  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        5464f8:_digit_divisor_5 sdword (type=i dflags=--S-- auto sz=4 use=12 assigned=8 base=012f)
;        547108:_digit_number_5 byte (type=i dflags=----- auto sz=1 use=1 assigned=2 base=0133)
;        5471f8:_digit byte (type=i dflags=----- auto sz=1 use=2 assigned=1 base=0134)
...
;        549108:__temp_42  (type=i dflags=----- auto sz=1 use=1 assigned=1 base=0135)
;        53a108:__bitbucket_42  (type=i dflags=----- auto sz=1 use=4 assigned=8 base=0136)
;        --- labels ---
;        {block enter}
;          --- records ---
;          --- variables ---
...
;         = 0
;        539e88:__bitbucket_43  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        539a78:__bitbucket_44  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        539518:__bitbucket_45  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        5397d8:__bitbucket_46  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        539678:__bitbucket_47  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        539108:__bitbucket_48  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        538ab8:__bitbucket_49  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        538d78:__bitbucket_50  (type=i dflags=----- auto sticky sz=1 use=3 assigned=6 base=0041)
;        --- labels ---
;        {block enter}
;          --- records ---
;          --- variables ---
...
;        538c18:__bitbucket_51  (type=i dflags=----- auto sz=1 use=0 assigned=0 base=ffff)
;        --- labels ---
;      {block exit}
...
;        5385a8:__bitbucket_52  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        537cb8:__bitbucket_53  (type=i dflags=----- sticky sz=2 use=3 assigned=6 base=003c)
;        --- labels ---
;        {block enter}
;          --- records ---
;          --- variables ---
...
;         = 0
;        538108:__bitbucket_54  (type=i dflags=----- sticky sz=1 use=3 assigned=6 base=003b)
;        --- labels ---
;        {block enter}
;          --- records ---
;          --- variables ---
...
;         = 4798
;        537e18:__bitbucket_55  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        5377d8:__bitbucket_56  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        5375a8:__bitbucket_57  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        536458:__bitbucket_58  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        536288:__bitbucket_59  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        535d18:__bitbucket_60  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        5357b8:__bitbucket_61  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        535a78:__bitbucket_62  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        535918:__bitbucket_63  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        5353a8:__bitbucket_64  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        534d48:__bitbucket_65  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        535108:__bitbucket_66  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        534ea8:__bitbucket_67  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        534938:__bitbucket_68  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        5343d8:__bitbucket_69  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        534698:__bitbucket_70  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        534538:__bitbucket_71  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        533e78:__bitbucket_72  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        533918:__bitbucket_73  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        533bd8:__bitbucket_74  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        533a78:__bitbucket_75  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        533508:__bitbucket_76  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        532f88:__bitbucket_77  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        533268:__bitbucket_78  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        533108:__bitbucket_79  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        532b78:__bitbucket_80  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        532618:__bitbucket_81  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        5328d8:__bitbucket_82  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        532778:__bitbucket_83  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        532108:__bitbucket_84  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        531818:__bitbucket_85  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        531b88:__bitbucket_86  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        531978:__bitbucket_87  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        531338:__bitbucket_88  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        531108:__bitbucket_89  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        4eef48:__bitbucket_90  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        4eacf8:__bitbucket_91  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        52fbd8:__bitbucket_92  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        52f678:__bitbucket_93  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        52f938:__bitbucket_94  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        52f7d8:__bitbucket_95  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        52f268:__bitbucket_96  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        52ebf8:__bitbucket_97  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        52eeb8:__bitbucket_98  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        52ed58:__bitbucket_99  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        52e7e8:__bitbucket_100  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        52e288:__bitbucket_101  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        52e548:__bitbucket_102  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        52e3e8:__bitbucket_103  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        52dd68:__bitbucket_104  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        52d808:__bitbucket_105  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        52dac8:__bitbucket_106  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        52d968:__bitbucket_107  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
; --- call stack ---
...
;514a88:_l239(use=4:ref=4:pc=02e7)
...
;518398:_l248(use=5:ref=3:pc=0208)
;5183f8:_l249(use=5:ref=3:pc=0220)
...
;547a98:_l319(use=5:ref=3:pc=0252)
;548598:_l320(use=5:ref=3:pc=0253)
;5485f8:_l321(use=9:ref=3:pc=02e7)
;548658:_l322(use=0:ref=1:pc=0000)
;54a408:_l323(use=0:ref=1:pc=0000)
;54b4a8:_l324(use=5:ref=3:pc=02e5)
...
;557328:_l358(use=5:ref=3:pc=02ec)
;557388:_l359(use=5:ref=3:pc=02fe)
...
;55a728:_l368(use=5:ref=4:pc=030a)
...
;5607a8:_l378(use=0:ref=2:pc=0000)
;560808:_l379(use=8:ref=5:pc=032c)
;560bc8:_l380(use=0:ref=1:pc=0000)
;561438:_l381(use=5:ref=3:pc=0316)
;5619a8:_l382(use=0:ref=1:pc=0000)
;562238:_l383(use=5:ref=3:pc=031f)
;564168:_l384(use=0:ref=2:pc=0000)
;5641c8:_l385(use=4:ref=4:pc=0352)
;564bc8:_l386(use=5:ref=3:pc=032e)
;564c28:_l387(use=0:ref=1:pc=0000)
;564c88:_l388(use=0:ref=1:pc=0000)
;564e08:_l389(use=0:ref=1:pc=0000)
;565498:_l390(use=5:ref=3:pc=034a)
;567c38:_l391(use=0:ref=2:pc=0000)
;567c98:_l392(use=24:ref=9:pc=03a8)
;567f38:_l393(use=0:ref=1:pc=0000)
;568238:_l394(use=5:ref=3:pc=0361)
;5687e8:_l395(use=0:ref=1:pc=0000)
;568bd8:_l396(use=5:ref=3:pc=036f)
;5692e8:_l397(use=0:ref=1:pc=0000)
;5696d8:_l398(use=5:ref=3:pc=037d)
;569ce8:_l399(use=0:ref=1:pc=0000)
;56a1b8:_l400(use=5:ref=3:pc=038b)
;56a7c8:_l401(use=0:ref=1:pc=0000)
;56abb8:_l402(use=5:ref=3:pc=0399)
;56b2e8:_l403(use=0:ref=1:pc=0000)
;56b6d8:_l404(use=5:ref=3:pc=03a7)
;56c4d8:_l405(use=5:ref=4:pc=03a8)
...
;5704a8:_l414(use=0:ref=1:pc=0000)
;571d08:_l415(use=0:ref=1:pc=0000)
...
;57b438:_l428(use=9:ref=3:pc=03df)
;57d238:_l429(use=5:ref=4:pc=040a)
...
;57fd08:_l435(use=5:ref=3:pc=040d)
...
;5c1828:_l461(use=2:ref=1:pc=0043)
;5c1888:_l462(use=2:ref=1:pc=0046)
;5c21c8:_l463(use=0:ref=1:pc=0052)
;5c2228:_l464(use=0:ref=1:pc=0000)
;5c37f8:_l465(use=0:ref=1:pc=0071)
;5c3b38:_l466(use=2:ref=1:pc=0077)
;5c61a8:_l467(use=0:ref=1:pc=00ba)
;5c6208:_l468(use=0:ref=1:pc=0000)
;5c8d88:_l469(use=0:ref=1:pc=00fd)
;5c9228:_l470(use=2:ref=1:pc=0103)
;5ca3a8:_l471(use=0:ref=1:pc=0120)
;5ca788:_l472(use=0:ref=1:pc=0126)
;5cbd28:_l473(use=0:ref=1:pc=0148)
;5cc1a8:_l474(use=0:ref=1:pc=014e)
;5cdb88:_l475(use=0:ref=1:pc=0176)
;5cdec8:_l476(use=2:ref=1:pc=017c)
;5ce828:_l477(use=0:ref=1:pc=018a)
;5cec08:_l478(use=0:ref=1:pc=0190)
;5d0328:_l479(use=0:ref=1:pc=01b2)
;5d0668:_l480(use=2:ref=1:pc=01b8)
;5d22c8:_l481(use=0:ref=1:pc=01ea)
;5d2328:_l482(use=0:ref=1:pc=0000)
;5d3c28:_l483(use=0:ref=1:pc=020e)
;5d3f68:_l484(use=2:ref=1:pc=0214)
;5dfb88:_l485(use=6:ref=1:pc=0364)
;5e0f48:_l486(use=0:ref=1:pc=036a)
;5e6ea8:_l487(use=0:ref=1:pc=0418)
;5e6f08:_l488(use=0:ref=1:pc=0000)
;5e9428:_l489(use=3:ref=1:pc=044a)
;5e9488:_l490(use=3:ref=1:pc=044c)
;5ebd08:_l491(use=0:ref=1:pc=048a)
;5ec1a8:_l492(use=2:ref=1:pc=0490)
;5f0688:_l493(use=2:ref=1:pc=0504)
;5f06e8:_l494(use=2:ref=1:pc=0507)
;5f1b68:_l495(use=2:ref=1:pc=0524)
;5f1bc8:_l496(use=2:ref=1:pc=0527)
;5f3108:_l497(use=2:ref=1:pc=0544)
;5f3168:_l498(use=2:ref=1:pc=0547)
;5f4588:_l499(use=2:ref=1:pc=0564)
;5f45e8:_l500(use=2:ref=1:pc=0567)
;5f5a68:_l501(use=2:ref=1:pc=0584)
;5f5ac8:_l502(use=2:ref=1:pc=0587)
;5f6ee8:_l503(use=2:ref=1:pc=05a4)
;5f6f48:_l504(use=2:ref=1:pc=05a7)
;5fac08:_l505(use=2:ref=1:pc=0600)
;5fb488:_l506(use=0:ref=1:pc=0606)
;5feb08:_l507(use=2:ref=1:pc=0664)
;5ff328:_l508(use=0:ref=1:pc=066a)
;5ffe88:_l509(use=2:ref=1:pc=0683)
;5ffee8:_l510(use=2:ref=1:pc=0680)
;602428:_l511(use=2:ref=1:pc=06bd)
;602488:_l512(use=2:ref=1:pc=06c0)
;6031a8:_l513(use=0:ref=1:pc=06cb)
;6034e8:_l514(use=0:ref=1:pc=06d1)
;606b28:_l515(use=2:ref=1:pc=0732)
;606b88:_l516(use=2:ref=1:pc=0735)
;60f288:_l517(use=2:ref=1:pc=0000)
;60f2e8:_l518(use=2:ref=1:pc=0000)
;60f348:_l519(use=2:ref=1:pc=0000)
;60f3a8:_l520(use=2:ref=1:pc=0000)
;6109e8:_l521(use=2:ref=1:pc=0000)
;612228:_l522(use=2:ref=1:pc=0000)
;6144a8:_l523(use=6:ref=1:pc=0000)
;61b108:_l524(use=2:ref=1:pc=0072)
;61b168:_l525(use=2:ref=1:pc=00a1)
;61b1c8:_l526(use=2:ref=1:pc=0092)
;61b228:_l527(use=2:ref=1:pc=0059)
;61b3a8:_l528(use=2:ref=1:pc=0069)
;61b528:_l529(use=2:ref=1:pc=006c)
;61b5e8:_l530(use=6:ref=1:pc=008e)
;61b948:_l531(use=2:ref=1:pc=00e7)
;61b9a8:_l532(use=2:ref=1:pc=00e9)
;61ba28:_l533(use=0:ref=1:pc=00ed)
;61ba88:_l534(use=0:ref=1:pc=0000)
;61bae8:_l535(use=0:ref=1:pc=00fc)
;61bba8:_l536(use=2:ref=1:pc=0100)
;61bc68:_l537(use=0:ref=1:pc=011f)
;61bcc8:_l538(use=0:ref=1:pc=0000)
;61be48:_l539(use=0:ref=1:pc=013a)
;61bf08:_l540(use=2:ref=1:pc=013e)
;61bf68:_l541(use=0:ref=1:pc=0149)
;61bfc8:_l542(use=0:ref=1:pc=014d)
;61c1e8:_l543(use=0:ref=1:pc=015a)
;61c2a8:_l544(use=0:ref=1:pc=015e)
;61c3c8:_l545(use=0:ref=1:pc=0172)
;61c488:_l546(use=2:ref=1:pc=0176)
;61c4e8:_l547(use=0:ref=1:pc=017b)
;61c548:_l548(use=0:ref=1:pc=017f)
;61c668:_l549(use=0:ref=1:pc=0190)
;61c728:_l550(use=2:ref=1:pc=0194)
;61c8c8:_l551(use=0:ref=1:pc=01a8)
;61c928:_l552(use=0:ref=1:pc=0000)
;61c9e8:_l553(use=0:ref=1:pc=01ba)
;61caa8:_l554(use=2:ref=1:pc=01be)
;61d368:_l555(use=6:ref=1:pc=0266)
;61d5c8:_l556(use=0:ref=1:pc=026a)
;61d688:_l557(use=0:ref=1:pc=02d3)
;61d6e8:_l558(use=0:ref=1:pc=0000)
;61d838:_l559(use=3:ref=1:pc=02f0)
;61d898:_l560(use=3:ref=1:pc=02f2)
;61db98:_l561(use=0:ref=1:pc=0318)
;61dc88:_l562(use=2:ref=1:pc=031c)
;61ec28:_l563(use=2:ref=1:pc=03d4)
;61ed48:_l564(use=0:ref=1:pc=03d8)
;61f248:_l565(use=2:ref=1:pc=0403)
;61f368:_l566(use=0:ref=1:pc=0407)
;61f3c8:_l567(use=2:ref=1:pc=0412)
;61f428:_l568(use=2:ref=1:pc=0411)
;61f608:_l569(use=0:ref=1:pc=0432)
;61f6c8:_l570(use=0:ref=1:pc=0436)
