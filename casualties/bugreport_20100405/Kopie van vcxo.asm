...
v__btemp80                     EQU 0x006b  ; _btemp80-->_bitbucket:2
v___x_69                       EQU 0x0042  ; x-->_porta_shadow:2
v___char_7                     EQU 0x006d  ; char
v____btemp68_1                 EQU 0x006b  ; _btemp68-->_bitbucket:4
v____btemp74_1                 EQU 0x006b  ; _btemp74-->_bitbucket:10
v___duty_1                     EQU 0x006e  ; setdutycycle:duty
v____temp_46                   EQU 0       ; gpstakt(): _temp
v__btemp62                     EQU 0x006e  ; parsemessageid:_btemp62-->_bitbucket4:0
v__btemp63                     EQU 0x006e  ; parsemessageid:_btemp63-->_bitbucket4:1
v__btemp64                     EQU 0x006e  ; parsemessageid:_btemp64-->_bitbucket4:2
v__btemp65                     EQU 0x006e  ; parsemessageid:_btemp65-->_bitbucket4:3
v__btemp66                     EQU 0x006e  ; parsemessageid:_btemp66-->_bitbucket4:4
v__btemp67                     EQU 0x006e  ; parsemessageid:_btemp67-->_bitbucket4:5
...
v__btemp48                     EQU 0x0136  ; _print_universal_dec:_btemp48-->_bitbucket42:3
v__btemp49                     EQU 0x0136  ; _print_universal_dec:_btemp49-->_bitbucket42:4
v__btemp50                     EQU 0x0136  ; _print_universal_dec:_btemp50-->_bitbucket42:5
...
;   22 include 16f690
                               ...
                               branchlo_clr l_isr           ; 4294967295 -V rs rs [hl hl] 000d 118a
                                                            ; W = v__pic_isr_fsr
                               goto     l_isr               ; 4294967295 -V rs rs [hl hl] 000e 2c00
                                                            ; W = v__pic_isr_fsr
...
;   96 var          byte  _PORTA_shadow        = PORTA
                               ...
                               movwf    v__porta_shadow     ;  0 OV rs rs [hl hl] 00c2 00c2
; vcxo.jal
...
;  182    if ((PIR1_TXIF == TRUE) & (PIE1_TXIE == TRUE)) then          -- UART xmit interrupt
                               bcf      v____bitbucket_54, 0 ; _btemp1;  4 OV rs rs [hl hl] 00de 103b
                               btfsc    v_pir1, 4 ; pir1_txif        ;  4 OV rs rs [hl hl] 00df 1a0c
                               bsf      v____bitbucket_54, 0 ; _btemp1;  4 OV rs rs [hl hl] 00e0 143b
                               ...
                               bcf      v____bitbucket_54, 1 ; _btemp2;  4 OV rs rs [hl hl] 00e5 10bb
                               goto     l__l535             ;  4 OV rs rs [hl hl] 00e6 28e9
l__l534
                               datalo_clr v____bitbucket_54 ; _btemp2;  4 OV rS rs [hl hl] 00e7 1283
                               bsf      v____bitbucket_54, 1 ; _btemp2;  4 OV rs rs [hl hl] 00e8 14bb
l__l535
                               bsf      v____bitbucket_54, 2 ; _btemp3;  4 OV rs rs [hl hl] 00e9 153b
                               btfsc    v____bitbucket_54, 0 ; _btemp1;  4 OV rs rs [hl hl] 00ea 183b
                               btfss    v____bitbucket_54, 1 ; _btemp2;  4 OV rs rs [hl hl] 00eb 1cbb
                               bcf      v____bitbucket_54, 2 ; _btemp3;  4 OV rs rs [hl hl] 00ec 113b
                               btfss    v____bitbucket_54, 2 ; _btemp3;  4 OV rs rs [hl hl] 00ed 1d3b
                               goto     l__l157             ;  4 OV rs rs [hl hl] 00ee 290a
;  183       if (_serial_offsetxmttail != _serial_offsetxmthead) then  -- data in xmit buffer
                               movf     v__serial_offsetxmttail,w;  4 OV rs rs [hl hl] 00ef 0850
                               subwf    v__serial_offsetxmthead,w;  4 OV rs rs [hl hl] 00f0 024f
...
;  187             _serial_offsetxmttail = 0           -- wrap to begin
                               clrf     v__serial_offsetxmttail;  4 OV rs rs [hl hl] 0100 01d0
;  188          end if
l__l161
;  189          if (_serial_offsetxmttail == _serial_offsetxmthead) then  -- last byte xmt'd
                               movf     v__serial_offsetxmttail,w;  4 OV rs rs [hl hl] 0101 0850
                               subwf    v__serial_offsetxmthead,w;  4 OV rs rs [hl hl] 0102 024f
                                                            ; W = v__serial_offsetxmttail
...
;  192          TXREG = x                              -- actually xmit byte
                               ...
                               movf     v___x_66,w          ;  4 OV rs rs [hl hl] 0108 083a
...
;  214       if ((RCSTA_OERR == TRUE) | (RCSTA_FERR == TRUE)) then  -- frame/overr error
                               bcf      v____bitbucket_53, 1 ; _btemp8;  4 OV rs rs [hl hl] 0115 10bc
                               btfsc    v_rcsta, 1 ; rcsta_oerr       ;  4 OV rs rs [hl hl] 0116 1898
                               bsf      v____bitbucket_53, 1 ; _btemp8;  4 OV rs rs [hl hl] 0117 14bc
                               bcf      v____bitbucket_53, 2 ; _btemp9;  4 OV rs rs [hl hl] 0118 113c
                               btfsc    v_rcsta, 2 ; rcsta_ferr       ;  4 OV rs rs [hl hl] 0119 1918
                               bsf      v____bitbucket_53, 2 ; _btemp9;  4 OV rs rs [hl hl] 011a 153c
                               bcf      v____bitbucket_53, 3 ; _btemp10;  4 OV rs rs [hl hl] 011b 11bc
                               btfss    v____bitbucket_53, 1 ; _btemp8;  4 OV rs rs [hl hl] 011c 1cbc
                               btfsc    v____bitbucket_53, 2 ; _btemp9;  4 OV rs rs [hl hl] 011d 193c
                               bsf      v____bitbucket_53, 3 ; _btemp10;  4 OV rs rs [hl hl] 011e 15bc
                               btfss    v____bitbucket_53, 3 ; _btemp10;  4 OV rs rs [hl hl] 011f 1dbc
                               goto     l__l169             ;  4 OV rs rs [hl hl] 0120 2930
;  215          x = RCREG                              -- flush hardware buffer
                               movf     v_rcreg,w           ;  4 OV rs rs [hl hl] 0121 081a
                                                            ; W = v___x_67
                               movwf    v___x_67            ;  4 OV rs rs [hl hl] 0122 00ba
...
;  219             x = RCREG                           -- \  flush hardware buffers
                               ...
                               movwf    v___x_67            ;  4 OV rs rs [hl hl] 0128 00ba
;  220             x = RCREG                           -- /
                               movf     v_rcreg,w           ;  4 OV rs rs [hl hl] 0129 081a
                                                            ; W = v___x_67
                               movwf    v___x_67            ;  4 OV rs rs [hl hl] 012a 00ba
...
;  222          _serial_offsetrcvtail = 0              -- \  flush circular buffer
                               clrf     v__serial_offsetrcvtail;  4 OV rs rs [hl hl] 012c 01d2
                                                            ; W = v___x_67
;  223          _serial_offsetrcvhead = 0              -- /
                               clrf     v__serial_offsetrcvhead;  4 OV rs rs [hl hl] 012d 01d1
                                                            ; W = v___x_67
;  224          serial_ctsinv = FALSE                  -- ensure CTS true
                               bcf      v__bitbucket, 0 ; dummy  ;  4 OV rs rs [hl hl] 012e 106b
                                                            ; W = v___x_67
...
;  227          _serial_rcvbuf[_serial_offsetrcvhead] = RCREG      -- move byte to rcv buffer
                               movlw    v__serial_rcvbuf    ;  4 OV rs rs [hl hl] 0130 3043
                               addwf    v__serial_offsetrcvhead,w;  4 OV rs rs [hl hl] 0131 0751
...
;  247          x = _serial_offsetrcvhead + 1          -- update offset
                               incf     v__serial_offsetrcvhead,w;  4 OV rs rs [hl hl] 0136 0a51
                               movwf    v___x_67            ;  4 OV rs rs [hl hl] 0137 00ba
;  248          if x >= SERIAL_RCVBUFSIZE then         -- buffer overflow
                               movlw    12                  ;  4 OV rs rs [hl hl] 0138 300c
                                                            ; W = v___x_67
                               subwf    v___x_67,w          ;  4 OV rs rs [hl hl] 0139 023a
...
l__l543
;  249             x = 0                               -- wrap
                               clrf     v___x_67            ;  4 OV rs rs [hl hl] 013e 01ba
;  250          end if
l__l175
;  251          if (x != _serial_offsetrcvtail) then   -- buffer not yet full
                               movf     v___x_67,w          ;  4 OV rs rs [hl hl] 013f 083a
                                                            ; W = v__serial_offsetrcvhead
                               subwf    v__serial_offsetrcvtail,w;  4 OV rs rs [hl hl] 0140 0252
                                                            ; W = v___x_67
...
;  252             _serial_offsetrcvhead = x           -- update offset
                               movf     v___x_67,w          ;  4 OV rs rs [hl hl] 0143 083a
                                                            ; W = v___x_67
                               movwf    v__serial_offsetrcvhead;  4 OV rs rs [hl hl] 0144 00d1
                                                            ; W = v___x_67
;  253          end if                                 -- (else discard byte,
l__l177
;  255          if (serial_ctsinv == FALSE) then       -- CTS is TRUE
                               btfsc    v__bitbucket, 0 ; dummy  ;  4 OV rs rs [hl hl] 0145 186b
...
;  256             if _serial_offsetrcvhead > _serial_offsetrcvtail then  -- offset difference
                               movf     v__serial_offsetrcvhead,w;  4 OV rs rs [hl hl] 0147 0851
                               subwf    v__serial_offsetrcvtail,w;  4 OV rs rs [hl hl] 0148 0252
                                                            ; W = v__serial_offsetrcvhead
...
;  257                x = SERIAL_RCVBUFSIZE - _serial_offsetrcvhead + _serial_offsetrcvtail
                               comf     v__serial_offsetrcvhead,w;  4 OV rs rs [hl hl] 014d 0951
                               movwf    v____temp_25        ;  4 OV rs rs [hl hl] 014e 00bb
                               movlw    13                  ;  4 OV rs rs [hl hl] 014f 300d
                                                            ; W = v____temp_25
                               addwf    v____temp_25,f      ;  4 OV rs rs [hl hl] 0150 07bb
                               movf     v__serial_offsetrcvtail,w;  4 OV rs rs [hl hl] 0151 0852
                               addwf    v____temp_25,w      ;  4 OV rs rs [hl hl] 0152 073b
                                                            ; W = v__serial_offsetrcvtail
                               movwf    v___x_67            ;  4 OV rs rs [hl hl] 0153 00ba
;  258             else
                               goto     l__l180             ;  4 OV rs rs [hl hl] 0154 2958
                                                            ; W = v___x_67
l__l181
;  259                x = _serial_offsetrcvtail - _serial_offsetrcvhead
                               movf     v__serial_offsetrcvhead,w;  4 OV rs rs [hl hl] 0155 0851
                               subwf    v__serial_offsetrcvtail,w;  4 OV rs rs [hl hl] 0156 0252
                                                            ; W = v__serial_offsetrcvhead
                               movwf    v___x_67            ;  4 OV rs rs [hl hl] 0157 00ba
;  260             end if
l__l180
;  261             if (x < SERIAL_DELTA) then          -- circular buffer almost full
                               movlw    17                  ;  4 OV rs rs [hl hl] 0158 3011
                                                            ; W = v___x_67
                               subwf    v___x_67,w          ;  4 OV rs rs [hl hl] 0159 023a
...
;  262                serial_ctsinv = TRUE             -- set CTS FALSE
                               bsf      v__bitbucket, 0 ; dummy  ;  4 OV rs rs [hl hl] 015e 146b
;  264          end if
...
;  291    if (_serial_offsetrcvtail == _serial_offsetrcvhead) then  -- receive buffer empty
                               ...
                               movf     v__serial_offsetrcvtail,w;  1 OV rs rs [?? ??] 0163 0852
                               subwf    v__serial_offsetrcvhead,w;  1 OV rs rs [?? ??] 0164 0251
                                                            ; W = v__serial_offsetrcvtail
...
;  298       _serial_offsetrcvtail = 0                 -- wrap
                               clrf     v__serial_offsetrcvtail;  1 OV rs rs [?? ??] 0176 01d2
;  299    end if
l__l189
;  300    if (serial_ctsinv == TRUE) then              -- CTS is FALSE
                               btfss    v__bitbucket, 0 ; dummy  ;  1 OV rs rs [?? ??] 0177 1c6b
                                                            ; W = v___x_68
                               goto     l__l191             ;  1 OV rs rs [?? ??] 0178 2996
                                                            ; W = v___x_68
;  301       if (_serial_offsetrcvhead > _serial_offsetrcvtail) then
                               movf     v__serial_offsetrcvhead,w;  1 OV rs rs [?? ??] 0179 0851
                                                            ; W = v___data_1
                               subwf    v__serial_offsetrcvtail,w;  1 OV rs rs [?? ??] 017a 0252
                                                            ; W = v__serial_offsetrcvhead
...
;  302          x = SERIAL_RCVBUFSIZE - _serial_offsetrcvhead + _serial_offsetrcvtail
                               comf     v__serial_offsetrcvhead,w;  1 OV rs rs [?? ??] 017f 0951
                               ...
                               movf     v__serial_offsetrcvtail,w;  1 OV rs rs [?? ??] 0185 0852
...
;  304          x = _serial_offsetrcvtail - _serial_offsetrcvhead  -- offset difference
                               movf     v__serial_offsetrcvhead,w;  1 OV rs rs [?? ??] 018a 0851
                               subwf    v__serial_offsetrcvtail,w;  1 OV rs rs [?? ??] 018b 0252
                                                            ; W = v__serial_offsetrcvhead
...
;  307          serial_ctsinv = FALSE                  -- make CTS TRUE
                               ...
                               bcf      v__bitbucket, 0 ; dummy  ;  1 OV rs rs [?? ??] 0195 106b
;  309    end if
l__l191
l__l190
...
;  313 end function
l__l185
                               movf     v___data_1,w        ;  1 OV rs rs [?? ??] 0198 086e
                                                            ; W = v___x_68
                               return                       ;  1 OV rs rs [?? ??] 0199 0008
                                                            ; W = v___data_1
;  338 function  serial_send_byte(byte in data) return byte is
l_serial_send_byte
                               movwf    v___data_5          ;  3 OV rs rs [?? ??] 019a 00bf
                                                            ; W = v___data_7
;  342    serial_send_success = true                   -- indicate byte sent
                               bsf      v__bitbucket, 1 ; serial_send_success  ;  3 OV rs rs [?? ??] 019b 14eb
                                                            ; W = v___data_5
;  344    if (_serial_offsetxmthead == _serial_offsetxmttail  &  -- nothing buffered
                               movf     v__serial_offsetxmthead,w;  3 OV rs rs [?? ??] 019c 084f
                                                            ; W = v___data_5
                               subwf    v__serial_offsetxmttail,w;  3 OV rs rs [?? ??] 019d 0250
                                                            ; W = v__serial_offsetxmthead
                               bcf      v____bitbucket_50, 0 ; _btemp23;  3 OV rs rs [?? ??] 019e 1041
                               btfsc    v__status, v__z     ;  3 OV rs rs [?? ??] 019f 1903
                               bsf      v____bitbucket_50, 0 ; _btemp23;  3 OV rs rs [?? ??] 01a0 1441
                               bcf      v____bitbucket_50, 1 ; _btemp24;  3 OV rs rs [?? ??] 01a1 10c1
                               btfsc    v_pir1, 4 ; pir1_txif        ;  3 OV rs rs [?? ??] 01a2 1a0c
                               bsf      v____bitbucket_50, 1 ; _btemp24;  3 OV rs rs [?? ??] 01a3 14c1
                               bsf      v____bitbucket_50, 2 ; _btemp25;  3 OV rs rs [?? ??] 01a4 1541
                               btfsc    v____bitbucket_50, 0 ; _btemp23;  3 OV rs rs [?? ??] 01a5 1841
                               btfss    v____bitbucket_50, 1 ; _btemp24;  3 OV rs rs [?? ??] 01a6 1cc1
                               bcf      v____bitbucket_50, 2 ; _btemp25;  3 OV rs rs [?? ??] 01a7 1141
                               btfss    v____bitbucket_50, 2 ; _btemp25;  3 OV rs rs [?? ??] 01a8 1d41
...
;  347       TXREG = data                              -- transmit byte immediately
                               datalo_clr v___data_5        ;  3 OV rS rs [?? ??] 01ac 1283
                                                            ; W = v_newxmthead
                               movf     v___data_5,w        ;  3 OV rs rs [?? ??] 01ad 083f
                                                            ; W = v_newxmthead
...
;  352          newxmthead = 0                         -- wrap to begin
                               clrf     v_newxmthead        ;  3 OV rs rs [?? ??] 01be 01c0
;  353       end if
l__l203
;  354       if (newxmthead != _serial_offsetxmttail) then  -- buffer not full
                               movf     v_newxmthead,w      ;  3 OV rs rs [?? ??] 01bf 0840
                                                            ; W = v__serial_offsetxmthead
                               subwf    v__serial_offsetxmttail,w;  3 OV rs rs [?? ??] 01c0 0250
                                                            ; W = v_newxmthead
...
;  355          _serial_offsetxmthead = newxmthead     -- update offset
                               movf     v_newxmthead,w      ;  3 OV rs rs [?? ??] 01c3 0840
                                                            ; W = v___data_5
                               movwf    v__serial_offsetxmthead;  3 OV rs rs [?? ??] 01c4 00cf
                                                            ; W = v_newxmthead
...
l__l208
                               movf     v_newxmthead,w      ;  3 OV rs rs [?? ??] 01c6 0840
                               subwf    v__serial_offsetxmttail,w;  3 OV rs rs [?? ??] 01c7 0250
                                                            ; W = v_newxmthead
...
;  361             _serial_offsetxmthead = newxmthead  -- update offset
                               movf     v_newxmthead,w      ;  3 OV rs rs [?? ??] 01ca 0840
                               movwf    v__serial_offsetxmthead;  3 OV rs rs [?? ??] 01cb 00cf
                                                            ; W = v_newxmthead
;  366       end if
l__l204
...
;  370    return data                                  -- transmitted byte!
                               datalo_clr v___data_5        ;  3 OV r? rs [?? ??] 01ce 1283
                                                            ; W = v__serial_offsetxmthead
                               movf     v___data_5,w        ;  3 OV rs rs [?? ??] 01cf 083f
                                                            ; W = v__serial_offsetxmthead
;  372 end function
...
;  380    _serial_offsetxmthead  = 0                   -- offset next byte from appl
                               ...
                               clrf     v__serial_offsetxmthead;  1 OV rs rs [hl hl] 01d2 01cf
;  381    _serial_offsetxmttail  = 0                   -- offset next byte to port
                               clrf     v__serial_offsetxmttail;  1 OV rs rs [hl hl] 01d3 01d0
;  382    _serial_offsetrcvhead  = 0                   -- offset next byte from port
                               clrf     v__serial_offsetrcvhead;  1 OV rs rs [hl hl] 01d4 01d1
;  383    _serial_offsetrcvtail  = 0                   -- offset next byte to appl
                               clrf     v__serial_offsetrcvtail;  1 OV rs rs [hl hl] 01d5 01d2
...
;  400    serial_ctsinv          = false               -- CTS true: accept PC data
                               ...
                               bcf      v__bitbucket, 0 ; dummy  ;  1 OV rs rs [?? ??] 01e3 106b
;  402 end procedure
...
l__serial_hw_data_put
                               ...
                               movwf    v___data_7          ;  2 OV rs rs [?? ??] 01e8 00be
                                                            ; W = v__pic_temp
;  422    serial_send_success = false
                               bcf      v__bitbucket, 1 ; serial_send_success  ;  2 OV rs rs [?? ??] 01e9 10eb
                                                            ; W = v___data_7
...
l__l217
                               ...
                               datahi_clr v__bitbucket ; serial_send_success   ;  2 OV ?s rs [?? ??] 01eb 1303
                                                            ; W = v___data_7
                               btfsc    v__bitbucket, 1 ; serial_send_success  ;  2 OV rs rs [?? ??] 01ec 18eb
                                                            ; W = v___data_7
                               goto     l__l218             ;  2 OV rs rs [?? ??] 01ed 29f1
                                                            ; W = v___data_7
;  424       dummy = serial_send_byte(data)
                               movf     v___data_7,w        ;  2 OV rs rs [?? ??] 01ee 083e
                                                            ; W = v___data_7
...
;   59    device = ASCII_LF -- line feed
                               ...
                               movf     v__device_put,w     ;  1 OV rs rs [?? ??] 01fe 086e
                                                            ; W = v__pic_temp
                               movwf    v__pic_pointer      ;  1 OV rs rs [?? ??] 01ff 00b4
                                                            ; W = v__device_put
                               movf     v__device_put+1,w   ;  1 OV rs rs [?? ??] 0200 086f
                                                            ; W = v__pic_pointer
...
;   66    for len using i loop    
                               clrf     v_i                 ;  1 OV Rs Rs [?? ??] 0206 01ae
                                                            ; W = v_len
                               goto     l__l251             ;  1 OV Rs Rs [?? ??] 0207 2a29
                                                            ; W = v_len
l__l250
;   67       if (str[i] == print_string_terminator) then exit loop end if
                               datahi_set v___str_1         ;  1 OV rs Rs [?? ??] 0208 1703
                               movf     v___str_1,w         ;  1 OV Rs Rs [?? ??] 0209 0826
                               addwf    v_i,w               ;  1 OV Rs Rs [?? ??] 020a 072e
                                                            ; W = v___str_1
                               movwf    v__fsr              ;  1 OV Rs Rs [?? ??] 020b 0084
                               bcf      v__status, v__irp   ;  1 OV Rs Rs [?? ??] 020c 1383
                               btfsc    v___str_1+1, 0      ;  1 OV Rs Rs [?? ??] 020d 1827
                               bsf      v__status, v__irp   ;  1 OV Rs Rs [?? ??] 020e 1783
                               movf     v__ind,w            ;  1 OV Rs Rs [?? ??] 020f 0800
                               btfsc    v__status, v__z     ;  1 OV Rs Rs [?? ??] 0210 1903
                               return                       ;  1 OV Rs Rs [?? ??] 0211 0008
l__l254
;   68       device = str[i]
                               movf     v___str_1+1,w       ;  1 OV Rs Rs [?? ??] 0212 0827
                               datahi_clr v__pic_pointer    ;  1 OV Rs rs [?? ??] 0213 1303
                                                            ; W = v___str_1
                               movwf    v__pic_pointer+1    ;  1 OV rs rs [?? ??] 0214 00b5
                                                            ; W = v___str_1
                               datahi_set v_i               ;  1 OV rs Rs [?? ??] 0215 1703
                                                            ; W = v__pic_pointer
                               movf     v_i,w               ;  1 OV Rs Rs [?? ??] 0216 082e
                                                            ; W = v__pic_pointer
                               addwf    v___str_1,w         ;  1 OV Rs Rs [?? ??] 0217 0726
                                                            ; W = v_i
                               datahi_clr v__pic_pointer    ;  1 OV Rs rs [?? ??] 0218 1303
                               movwf    v__pic_pointer      ;  1 OV rs rs [?? ??] 0219 00b4
                               btfsc    v__status, v__c     ;  1 OV rs rs [?? ??] 021a 1803
                                                            ; W = v__pic_pointer
                               incf     v__pic_pointer+1,f  ;  1 OV rs rs [?? ??] 021b 0ab5
                                                            ; W = v__pic_pointer
                               bcf      v__pic_pointer+1, 6 ;  1 OV rs rs [?? ??] 021c 1335
                               movf     v__pic_pointer+1,w  ;  1 OV rs rs [?? ??] 021d 0835
                               call     l__pic_indirect     ;  1 OV rs ?? [?? ??] 021e 20bd
                                                            ; W = v__pic_pointer
                               datalo_clr v__pic_temp       ;  1 OV ?? ?s [?? ??] 021f 1283
                               datahi_clr v__pic_temp       ;  1 OV ?s rs [?? ??] 0220 1303
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 0221 00a0
                               movf     v____device_put_1,w ;  1 OV rs rs [?? ??] 0222 086e
                                                            ; W = v__pic_temp
                               movwf    v__pic_pointer      ;  1 OV rs rs [?? ??] 0223 00b4
                                                            ; W = v____device_put_1
                               movf     v____device_put_1+1,w;  1 OV rs rs [?? ??] 0224 086f
                                                            ; W = v__pic_pointer
                               call     l__pic_indirect     ;  1 OV rs ?? [?? ??] 0225 20bd
                                                            ; W = v____device_put_1
;   69    end loop
                               datalo_clr v_i               ;  1 OV ?? ?s [?? ??] 0226 1283
                               datahi_set v_i               ;  1 OV ?s Rs [?? ??] 0227 1703
                               incf     v_i,f               ;  1 OV Rs Rs [?? ??] 0228 0aae
l__l251
                               movf     v_i,w               ;  1 OV Rs Rs [?? ??] 0229 082e
                                                            ; W = v_len
                               subwf    v_len,w             ;  1 OV Rs Rs [?? ??] 022a 022c
                                                            ; W = v_i
                               datahi_clr v__pic_temp       ;  1 OV Rs rs [?? ??] 022b 1303
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 022c 00a0
                               datahi_set v_len             ;  1 OV rs Rs [?? ??] 022d 1703
                                                            ; W = v__pic_temp
                               movf     v_len+1,w           ;  1 OV Rs Rs [?? ??] 022e 082d
                                                            ; W = v__pic_temp
                               datahi_clr v__pic_temp       ;  1 OV Rs rs [?? ??] 022f 1303
                                                            ; W = v_len
                               iorwf    v__pic_temp,w       ;  1 OV rs rs [?? ??] 0230 0420
                                                            ; W = v_len
                               btfss    v__status, v__z     ;  1 OV rs rs [?? ??] 0231 1d03
                               goto     l__l250             ;  1 OV rs rs [?? ??] 0232 2a08
l__l252
;   71 end procedure
                               return                       ;  1 OV rs rs [?? ??] 0233 0008
;  271 procedure print_byte_dec(volatile byte out device, byte in data) is
l_print_byte_dec
                               datahi_set v___data_49       ;  1 OV rs Rs [?? ??] 0234 1703
                                                            ; W = v_gpserrorcode
                               movwf    v___data_49         ;  1 OV Rs Rs [?? ??] 0235 00a2
                                                            ; W = v_gpserrorcode
;  273    _print_universal_dec(device, data, 100, 3)
                               datahi_clr v____device_put_19;  1 OV Rs rs [?? ??] 0236 1303
                                                            ; W = v___data_49
                               movf     v____device_put_19,w;  1 OV rs rs [?? ??] 0237 086e
                                                            ; W = v___data_49
                               datahi_set v____device_put_21;  1 OV rs Rs [?? ??] 0238 1703
                                                            ; W = v____device_put_19
                               movwf    v____device_put_21  ;  1 OV Rs Rs [?? ??] 0239 00a4
                                                            ; W = v____device_put_19
                               datahi_clr v____device_put_19;  1 OV Rs rs [?? ??] 023a 1303
                                                            ; W = v____device_put_21
                               movf     v____device_put_19+1,w;  1 OV rs rs [?? ??] 023b 086f
                                                            ; W = v____device_put_21
                               datahi_set v____device_put_21;  1 OV rs Rs [?? ??] 023c 1703
                                                            ; W = v____device_put_19
                               movwf    v____device_put_21+1;  1 OV Rs Rs [?? ??] 023d 00a5
                                                            ; W = v____device_put_19
                               movf     v___data_49,w       ;  1 OV Rs Rs [?? ??] 023e 0822
                                                            ; W = v____device_put_21
                               movwf    v___data_53         ;  1 OV Rs Rs [?? ??] 023f 00a8
                                                            ; W = v___data_49
                               clrf     v___data_53+1       ;  1 OV Rs Rs [?? ??] 0240 01a9
                                                            ; W = v___data_53
                               clrf     v___data_53+2       ;  1 OV Rs Rs [?? ??] 0241 01aa
                                                            ; W = v___data_53
                               clrf     v___data_53+3       ;  1 OV Rs Rs [?? ??] 0242 01ab
                                                            ; W = v___data_53
                               movlw    100                 ;  1 OV Rs Rs [?? ??] 0243 3064
                                                            ; W = v___data_53
                               movwf    v___digit_divisor_5 ;  1 OV Rs Rs [?? ??] 0244 00af
                               clrf     v___digit_divisor_5+1;  1 OV Rs Rs [?? ??] 0245 01b0
                                                            ; W = v___digit_divisor_5
                               clrf     v___digit_divisor_5+2;  1 OV Rs Rs [?? ??] 0246 01b1
                                                            ; W = v___digit_divisor_5
                               clrf     v___digit_divisor_5+3;  1 OV Rs Rs [?? ??] 0247 01b2
                                                            ; W = v___digit_divisor_5
                               movlw    3                   ;  1 OV Rs Rs [?? ??] 0248 3003
                                                            ; W = v___digit_divisor_5
                               goto     l__print_universal_dec;  1 OV Rs Rs [?? ??] 0249 2a4a
;  275 end procedure
...
l__print_universal_dec
                               movwf    v___digit_number_5  ;  1 OV Rs Rs [?? ??] 024a 00b3
;  296    if (data == 0) then
                               movf     v___data_53,w       ;  1 OV Rs Rs [?? ??] 024b 0828
                                                            ; W = v___digit_number_5
                               iorwf    v___data_53+1,w     ;  1 OV Rs Rs [?? ??] 024c 0429
                                                            ; W = v___data_53
                               iorwf    v___data_53+2,w     ;  1 OV Rs Rs [?? ??] 024d 042a
                               iorwf    v___data_53+3,w     ;  1 OV Rs Rs [?? ??] 024e 042b
                               btfss    v__status, v__z     ;  1 OV Rs Rs [?? ??] 024f 1d03
                               goto     l__l322             ;  1 OV Rs Rs [?? ??] 0250 2a5b
;  297       device = "0"      
                               movlw    48                  ;  1 OV Rs Rs [?? ??] 0251 3030
                               datahi_clr v__pic_temp       ;  1 OV Rs rs [?? ??] 0252 1303
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 0253 00a0
                               datahi_set v____device_put_21;  1 OV rs Rs [?? ??] 0254 1703
                                                            ; W = v__pic_temp
                               movf     v____device_put_21,w;  1 OV Rs Rs [?? ??] 0255 0824
                                                            ; W = v__pic_temp
                               datahi_clr v__pic_pointer    ;  1 OV Rs rs [?? ??] 0256 1303
                                                            ; W = v____device_put_21
                               movwf    v__pic_pointer      ;  1 OV rs rs [?? ??] 0257 00b4
                                                            ; W = v____device_put_21
                               datahi_set v____device_put_21;  1 OV rs Rs [?? ??] 0258 1703
                                                            ; W = v__pic_pointer
                               movf     v____device_put_21+1,w;  1 OV Rs Rs [?? ??] 0259 0825
                                                            ; W = v__pic_pointer
                               goto     l__pic_indirect     ;  1 OV Rs Rs [?? ??] 025a 28bd
                                                            ; W = v____device_put_21
;  298       return
;  299    end if
l__l322
;  301    no_digits_printed_yet = true
                               bsf      v____bitbucket_42, 0 ; no_digits_printed_yet;  1 OV Rs Rs [?? ??] 025b 1436
;  302    while (digit_divisor > 0) loop
l__l323
                               movf     v___digit_divisor_5+3,w;  1 OV Rs Rs [?? ??] 025c 0832
                                                            ; W = v_digit
                               xorlw    128                 ;  1 OV Rs Rs [?? ??] 025d 3a80
                                                            ; W = v___digit_divisor_5
                               datahi_clr v__pic_temp       ;  1 OV Rs rs [?? ??] 025e 1303
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 025f 00a0
                               movlw    128                 ;  1 OV rs rs [?? ??] 0260 3080
                                                            ; W = v__pic_temp
                               subwf    v__pic_temp,w       ;  1 OV rs rs [?? ??] 0261 0220
                               btfss    v__status, v__z     ;  1 OV rs rs [?? ??] 0262 1d03
                               goto     l__l558             ;  1 OV rs rs [?? ??] 0263 2a6f
                               movlw    0                   ;  1 OV rs rs [?? ??] 0264 3000
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 0265 1703
                               subwf    v___digit_divisor_5+2,w;  1 OV Rs Rs [?? ??] 0266 0231
                               btfss    v__status, v__z     ;  1 OV Rs Rs [?? ??] 0267 1d03
                               goto     l__l558             ;  1 OV Rs Rs [?? ??] 0268 2a6f
                               movlw    0                   ;  1 OV Rs Rs [?? ??] 0269 3000
                               subwf    v___digit_divisor_5+1,w;  1 OV Rs Rs [?? ??] 026a 0230
                               btfss    v__status, v__z     ;  1 OV Rs Rs [?? ??] 026b 1d03
                               goto     l__l558             ;  1 OV Rs Rs [?? ??] 026c 2a6f
                               movlw    0                   ;  1 OV Rs Rs [?? ??] 026d 3000
                               subwf    v___digit_divisor_5,w;  1 OV Rs Rs [?? ??] 026e 022f
l__l558
                               btfsc    v__status, v__z     ;  1 OV ?s Rs [?? ??] 026f 1903
                               goto     l__l324             ;  1 OV ?s Rs [?? ??] 0270 2af0
                               btfss    v__status, v__c     ;  1 OV ?s Rs [?? ??] 0271 1c03
                               goto     l__l324             ;  1 OV ?s Rs [?? ??] 0272 2af0
;  303       digit = byte ( data / digit_divisor )
                               datahi_set v___digit_divisor_5;  1 OV ?s Rs [?? ??] 0273 1703
                               movf     v___digit_divisor_5,w;  1 OV Rs Rs [?? ??] 0274 082f
                               datahi_clr v__pic_divisor    ;  1 OV Rs rs [?? ??] 0275 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_divisor      ;  1 OV rs rs [?? ??] 0276 00a8
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 0277 1703
                                                            ; W = v__pic_divisor
                               movf     v___digit_divisor_5+1,w;  1 OV Rs Rs [?? ??] 0278 0830
                                                            ; W = v__pic_divisor
                               datahi_clr v__pic_divisor    ;  1 OV Rs rs [?? ??] 0279 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_divisor+1    ;  1 OV rs rs [?? ??] 027a 00a9
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 027b 1703
                                                            ; W = v__pic_divisor
                               movf     v___digit_divisor_5+2,w;  1 OV Rs Rs [?? ??] 027c 0831
                                                            ; W = v__pic_divisor
                               datahi_clr v__pic_divisor    ;  1 OV Rs rs [?? ??] 027d 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_divisor+2    ;  1 OV rs rs [?? ??] 027e 00aa
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 027f 1703
                                                            ; W = v__pic_divisor
                               movf     v___digit_divisor_5+3,w;  1 OV Rs Rs [?? ??] 0280 0832
                                                            ; W = v__pic_divisor
                               datahi_clr v__pic_divisor    ;  1 OV Rs rs [?? ??] 0281 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_divisor+3    ;  1 OV rs rs [?? ??] 0282 00ab
                                                            ; W = v___digit_divisor_5
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 0283 1703
                                                            ; W = v__pic_divisor
                               movf     v___data_53,w       ;  1 OV Rs Rs [?? ??] 0284 0828
                                                            ; W = v__pic_divisor
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 0285 1303
                                                            ; W = v___data_53
                               movwf    v__pic_dividend     ;  1 OV rs rs [?? ??] 0286 00a0
                                                            ; W = v___data_53
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 0287 1703
                                                            ; W = v__pic_dividend
                               movf     v___data_53+1,w     ;  1 OV Rs Rs [?? ??] 0288 0829
                                                            ; W = v__pic_dividend
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 0289 1303
                                                            ; W = v___data_53
                               movwf    v__pic_dividend+1   ;  1 OV rs rs [?? ??] 028a 00a1
                                                            ; W = v___data_53
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 028b 1703
                                                            ; W = v__pic_dividend
                               movf     v___data_53+2,w     ;  1 OV Rs Rs [?? ??] 028c 082a
                                                            ; W = v__pic_dividend
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 028d 1303
                                                            ; W = v___data_53
                               movwf    v__pic_dividend+2   ;  1 OV rs rs [?? ??] 028e 00a2
                                                            ; W = v___data_53
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 028f 1703
                                                            ; W = v__pic_dividend
                               movf     v___data_53+3,w     ;  1 OV Rs Rs [?? ??] 0290 082b
                                                            ; W = v__pic_dividend
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 0291 1303
                                                            ; W = v___data_53
                               movwf    v__pic_dividend+3   ;  1 OV rs rs [?? ??] 0292 00a3
                                                            ; W = v___data_53
                               call     l__pic_divide       ;  1 OV rs ?? [?? ??] 0293 206b
                                                            ; W = v__pic_dividend
                               datalo_clr v__pic_quotient   ;  1 OV ?? ?s [?? ??] 0294 1283
                               datahi_clr v__pic_quotient   ;  1 OV ?s rs [?? ??] 0295 1303
                               movf     v__pic_quotient,w   ;  1 OV rs rs [?? ??] 0296 082c
                               datahi_set v_digit           ;  1 OV rs Rs [?? ??] 0297 1703
                                                            ; W = v__pic_quotient
                               movwf    v_digit             ;  1 OV Rs Rs [?? ??] 0298 00b4
                                                            ; W = v__pic_quotient
;  304       data = data % digit_divisor
                               datahi_clr v__pic_remainder  ;  1 OV Rs rs [?? ??] 0299 1303
                                                            ; W = v_digit
                               movf     v__pic_remainder,w  ;  1 OV rs rs [?? ??] 029a 0824
                                                            ; W = v_digit
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 029b 1703
                                                            ; W = v__pic_remainder
                               movwf    v___data_53         ;  1 OV Rs Rs [?? ??] 029c 00a8
                                                            ; W = v__pic_remainder
                               datahi_clr v__pic_remainder  ;  1 OV Rs rs [?? ??] 029d 1303
                                                            ; W = v___data_53
                               movf     v__pic_remainder+1,w;  1 OV rs rs [?? ??] 029e 0825
                                                            ; W = v___data_53
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 029f 1703
                                                            ; W = v__pic_remainder
                               movwf    v___data_53+1       ;  1 OV Rs Rs [?? ??] 02a0 00a9
                                                            ; W = v__pic_remainder
                               datahi_clr v__pic_remainder  ;  1 OV Rs rs [?? ??] 02a1 1303
                                                            ; W = v___data_53
                               movf     v__pic_remainder+2,w;  1 OV rs rs [?? ??] 02a2 0826
                                                            ; W = v___data_53
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 02a3 1703
                                                            ; W = v__pic_remainder
                               movwf    v___data_53+2       ;  1 OV Rs Rs [?? ??] 02a4 00aa
                                                            ; W = v__pic_remainder
                               datahi_clr v__pic_remainder  ;  1 OV Rs rs [?? ??] 02a5 1303
                                                            ; W = v___data_53
                               movf     v__pic_remainder+3,w;  1 OV rs rs [?? ??] 02a6 0827
                                                            ; W = v___data_53
                               datahi_set v___data_53       ;  1 OV rs Rs [?? ??] 02a7 1703
                                                            ; W = v__pic_remainder
                               movwf    v___data_53+3       ;  1 OV Rs Rs [?? ??] 02a8 00ab
                                                            ; W = v__pic_remainder
;  305       digit_divisor = digit_divisor / 10
                               movlw    10                  ;  1 OV Rs Rs [?? ??] 02a9 300a
                                                            ; W = v___data_53
                               datahi_clr v__pic_divisor    ;  1 OV Rs rs [?? ??] 02aa 1303
                               movwf    v__pic_divisor      ;  1 OV rs rs [?? ??] 02ab 00a8
                               clrf     v__pic_divisor+1    ;  1 OV rs rs [?? ??] 02ac 01a9
                                                            ; W = v__pic_divisor
                               clrf     v__pic_divisor+2    ;  1 OV rs rs [?? ??] 02ad 01aa
                                                            ; W = v__pic_divisor
                               clrf     v__pic_divisor+3    ;  1 OV rs rs [?? ??] 02ae 01ab
                                                            ; W = v__pic_divisor
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02af 1703
                                                            ; W = v__pic_divisor
                               movf     v___digit_divisor_5,w;  1 OV Rs Rs [?? ??] 02b0 082f
                                                            ; W = v__pic_divisor
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 02b1 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_dividend     ;  1 OV rs rs [?? ??] 02b2 00a0
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02b3 1703
                                                            ; W = v__pic_dividend
                               movf     v___digit_divisor_5+1,w;  1 OV Rs Rs [?? ??] 02b4 0830
                                                            ; W = v__pic_dividend
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 02b5 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_dividend+1   ;  1 OV rs rs [?? ??] 02b6 00a1
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02b7 1703
                                                            ; W = v__pic_dividend
                               movf     v___digit_divisor_5+2,w;  1 OV Rs Rs [?? ??] 02b8 0831
                                                            ; W = v__pic_dividend
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 02b9 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_dividend+2   ;  1 OV rs rs [?? ??] 02ba 00a2
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02bb 1703
                                                            ; W = v__pic_dividend
                               movf     v___digit_divisor_5+3,w;  1 OV Rs Rs [?? ??] 02bc 0832
                                                            ; W = v__pic_dividend
                               datahi_clr v__pic_dividend   ;  1 OV Rs rs [?? ??] 02bd 1303
                                                            ; W = v___digit_divisor_5
                               movwf    v__pic_dividend+3   ;  1 OV rs rs [?? ??] 02be 00a3
                                                            ; W = v___digit_divisor_5
                               call     l__pic_sdivide      ;  1 OV rs ?? [?? ??] 02bf 204a
                                                            ; W = v__pic_dividend
                               datalo_clr v__pic_quotient   ;  1 OV ?? ?s [?? ??] 02c0 1283
                               datahi_clr v__pic_quotient   ;  1 OV ?s rs [?? ??] 02c1 1303
                               movf     v__pic_quotient,w   ;  1 OV rs rs [?? ??] 02c2 082c
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02c3 1703
                                                            ; W = v__pic_quotient
                               movwf    v___digit_divisor_5 ;  1 OV Rs Rs [?? ??] 02c4 00af
                                                            ; W = v__pic_quotient
                               datahi_clr v__pic_quotient   ;  1 OV Rs rs [?? ??] 02c5 1303
                                                            ; W = v___digit_divisor_5
                               movf     v__pic_quotient+1,w ;  1 OV rs rs [?? ??] 02c6 082d
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02c7 1703
                                                            ; W = v__pic_quotient
                               movwf    v___digit_divisor_5+1;  1 OV Rs Rs [?? ??] 02c8 00b0
                                                            ; W = v__pic_quotient
                               datahi_clr v__pic_quotient   ;  1 OV Rs rs [?? ??] 02c9 1303
                                                            ; W = v___digit_divisor_5
                               movf     v__pic_quotient+2,w ;  1 OV rs rs [?? ??] 02ca 082e
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02cb 1703
                                                            ; W = v__pic_quotient
                               movwf    v___digit_divisor_5+2;  1 OV Rs Rs [?? ??] 02cc 00b1
                                                            ; W = v__pic_quotient
                               datahi_clr v__pic_quotient   ;  1 OV Rs rs [?? ??] 02cd 1303
                                                            ; W = v___digit_divisor_5
                               movf     v__pic_quotient+3,w ;  1 OV rs rs [?? ??] 02ce 082f
                                                            ; W = v___digit_divisor_5
                               datahi_set v___digit_divisor_5;  1 OV rs Rs [?? ??] 02cf 1703
                                                            ; W = v__pic_quotient
                               movwf    v___digit_divisor_5+3;  1 OV Rs Rs [?? ??] 02d0 00b2
                                                            ; W = v__pic_quotient
;  307       if ((digit != 0) | (no_digits_printed_yet == false)) then
                               movf     v_digit,w           ;  1 OV Rs Rs [?? ??] 02d1 0834
                                                            ; W = v___digit_divisor_5
                               bsf      v____bitbucket_42, 3 ; _btemp48;  1 OV Rs Rs [?? ??] 02d2 15b6
                                                            ; W = v_digit
                               btfsc    v__status, v__z     ;  1 OV Rs Rs [?? ??] 02d3 1903
                                                            ; W = v_digit
                               bcf      v____bitbucket_42, 3 ; _btemp48;  1 OV Rs Rs [?? ??] 02d4 11b6
                                                            ; W = v_digit
                               bcf      v____bitbucket_42, 4 ; _btemp49;  1 OV Rs Rs [?? ??] 02d5 1236
                                                            ; W = v_digit
                               btfss    v____bitbucket_42, 0 ; no_digits_printed_yet;  1 OV Rs Rs [?? ??] 02d6 1c36
                                                            ; W = v_digit
                               bsf      v____bitbucket_42, 4 ; _btemp49;  1 OV Rs Rs [?? ??] 02d7 1636
                                                            ; W = v_digit
                               bcf      v____bitbucket_42, 5 ; _btemp50;  1 OV Rs Rs [?? ??] 02d8 12b6
                                                            ; W = v_digit
                               btfss    v____bitbucket_42, 3 ; _btemp48;  1 OV Rs Rs [?? ??] 02d9 1db6
                                                            ; W = v_digit
                               btfsc    v____bitbucket_42, 4 ; _btemp49;  1 OV Rs Rs [?? ??] 02da 1a36
                                                            ; W = v_digit
                               bsf      v____bitbucket_42, 5 ; _btemp50;  1 OV Rs Rs [?? ??] 02db 16b6
                                                            ; W = v_digit
                               btfss    v____bitbucket_42, 5 ; _btemp50;  1 OV Rs Rs [?? ??] 02dc 1eb6
                                                            ; W = v_digit
                               goto     l__l327             ;  1 OV Rs Rs [?? ??] 02dd 2aee
                                                            ; W = v_digit
;  308          device = digit | "0"
                               movlw    48                  ;  1 OV Rs Rs [?? ??] 02de 3030
                               iorwf    v_digit,w           ;  1 OV Rs Rs [?? ??] 02df 0434
                               movwf    v____temp_42        ;  1 OV Rs Rs [?? ??] 02e0 00b5
                               movf     v____temp_42,w      ;  1 OV Rs Rs [?? ??] 02e1 0835
                                                            ; W = v____temp_42
                               datahi_clr v__pic_temp       ;  1 OV Rs rs [?? ??] 02e2 1303
                                                            ; W = v____temp_42
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 02e3 00a0
                                                            ; W = v____temp_42
                               datahi_set v____device_put_21;  1 OV rs Rs [?? ??] 02e4 1703
                                                            ; W = v__pic_temp
                               movf     v____device_put_21,w;  1 OV Rs Rs [?? ??] 02e5 0824
                                                            ; W = v__pic_temp
                               datahi_clr v__pic_pointer    ;  1 OV Rs rs [?? ??] 02e6 1303
                                                            ; W = v____device_put_21
                               movwf    v__pic_pointer      ;  1 OV rs rs [?? ??] 02e7 00b4
                                                            ; W = v____device_put_21
                               datahi_set v____device_put_21;  1 OV rs Rs [?? ??] 02e8 1703
                                                            ; W = v__pic_pointer
                               movf     v____device_put_21+1,w;  1 OV Rs Rs [?? ??] 02e9 0825
                                                            ; W = v__pic_pointer
                               call     l__pic_indirect     ;  1 OV Rs ?? [?? ??] 02ea 20bd
                                                            ; W = v____device_put_21
;  309          no_digits_printed_yet = false
                               datalo_clr v____bitbucket_42 ; no_digits_printed_yet;  1 OV ?? ?s [?? ??] 02eb 1283
                               datahi_set v____bitbucket_42 ; no_digits_printed_yet;  1 OV ?s Rs [?? ??] 02ec 1703
                               bcf      v____bitbucket_42, 0 ; no_digits_printed_yet;  1 OV Rs Rs [?? ??] 02ed 1036
;  310       end if
l__l327
;  311       digit_number = digit_number - 1
                               decf     v___digit_number_5,f;  1 OV Rs Rs [?? ??] 02ee 03b3
                                                            ; W = v_digit
;  312    end loop
                               goto     l__l323             ;  1 OV Rs Rs [?? ??] 02ef 2a5c
                                                            ; W = v_digit
l__l324
;  314 end procedure
l__l241
                               return                       ;  1 OV ?s Rs [?? ??] 02f0 0008
; c:\jallib\include\jal/delay.jal
;  113 procedure delay_1ms(word in n) is
l_delay_1ms
;  115    for n loop
                               datahi_set v__floop4         ;  1 OV rs Rs [?? ??] 02f1 1703
                                                            ; W = v___n_3
                               clrf     v__floop4           ;  1 OV Rs Rs [?? ??] 02f2 01a2
                                                            ; W = v___n_3
                               clrf     v__floop4+1         ;  1 OV Rs Rs [?? ??] 02f3 01a3
                                                            ; W = v___n_3
                               goto     l__l362             ;  1 OV Rs Rs [?? ??] 02f4 2b07
                                                            ; W = v___n_3
l__l361
;  117          _usec_delay(_one_ms_delay)
                               datalo_clr v__pic_temp       ;  1 -V rs rs [?? ??] 02f5 1283
                               datahi_clr v__pic_temp       ;  1 -V rs rs [?? ??] 02f6 1303
                               movlw    35                  ;  1 -V rs rs [?? ??] 02f7 3023
                               movwf    v__pic_temp         ;  1 -V rs rs [?? ??] 02f8 00a0
l__l562
                               movlw    13                  ;  1 -V rs rs [?? ??] 02f9 300d
                               movwf    v__pic_temp+1       ;  1 -V rs rs [?? ??] 02fa 00a1
l__l563
                               branchhi_clr l__l563         ;  1 -V rs rs [?? h?] 02fb 120a
                               branchlo_clr l__l563         ;  1 -V rs rs [h? hl] 02fc 118a
                               decfsz   v__pic_temp+1,f     ;  1 -V rs rs [hl hl] 02fd 0ba1
                               goto     l__l563             ;  1 -V rs rs [hl hl] 02fe 2afb
                               branchhi_clr l__l562         ;  1 -V rs rs [hl hl] 02ff 120a
                               branchlo_clr l__l562         ;  1 -V rs rs [hl hl] 0300 118a
                               decfsz   v__pic_temp,f       ;  1 -V rs rs [hl hl] 0301 0ba0
                               goto     l__l562             ;  1 -V rs rs [hl hl] 0302 2af9
;  121    end loop
                               datahi_set v__floop4         ;  1 OV rs Rs [hl hl] 0303 1703
                                                            ; W = v__pic_temp
                               incf     v__floop4,f         ;  1 OV Rs Rs [hl hl] 0304 0aa2
                                                            ; W = v__pic_temp
                               btfsc    v__status, v__z     ;  1 OV Rs Rs [hl hl] 0305 1903
                                                            ; W = v__pic_temp
                               incf     v__floop4+1,f       ;  1 OV Rs Rs [hl hl] 0306 0aa3
                                                            ; W = v__pic_temp
l__l362
                               movf     v__floop4,w         ;  1 OV Rs Rs [?? ??] 0307 0822
                                                            ; W = v___n_3
                               datahi_clr v___n_3           ;  1 OV Rs rs [?? ??] 0308 1303
                                                            ; W = v__floop4
                               subwf    v___n_3,w           ;  1 OV rs rs [?? ??] 0309 026e
                                                            ; W = v__floop4
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 030a 00a0
                               datahi_set v__floop4         ;  1 OV rs Rs [?? ??] 030b 1703
                                                            ; W = v__pic_temp
                               movf     v__floop4+1,w       ;  1 OV Rs Rs [?? ??] 030c 0823
                                                            ; W = v__pic_temp
                               datahi_clr v___n_3           ;  1 OV Rs rs [?? ??] 030d 1303
                                                            ; W = v__floop4
                               subwf    v___n_3+1,w         ;  1 OV rs rs [?? ??] 030e 026f
                                                            ; W = v__floop4
                               iorwf    v__pic_temp,w       ;  1 OV rs rs [?? ??] 030f 0420
                               btfss    v__status, v__z     ;  1 OV rs rs [?? ??] 0310 1d03
                               goto     l__l361             ;  1 OV rs rs [?? ??] 0311 2af5
;  122 end procedure
                               return                       ;  1 OV rs rs [?? ??] 0312 0008
                                                            ; W = v__pic_temp
;  138 end procedure
l__l371
; gps_converter.jal
;   16 var byte GpsErrorCode = 1  ; errorcode 1 = startup (wait for $).
                               movlw    1                   ;  0 OV ?? ?? [?? ??] 0313 3001
                               datalo_clr v_gpserrorcode    ;  0 OV ?? ?s [?? ??] 0314 1283
                               datahi_clr v_gpserrorcode    ;  0 OV ?s rs [?? ??] 0315 1303
                               movwf    v_gpserrorcode      ;  0 OV rs rs [?? ??] 0316 00e9
;   22 procedure DumpGpsInBuffer is      
                               goto     l__l408             ;  0 OV rs rs [?? ??] 0317 2bb1
                                                            ; W = v_gpserrorcode
;   44 function StoreBytes (byte in char) return bit is
l_storebytes
                               movwf    v___char_5          ;  1 OV rs rs [?? ??] 0318 00ee
                                                            ; W = v___char_7
;   47    if (char == ",") then
                               movlw    44                  ;  1 OV rs rs [?? ??] 0319 302c
                                                            ; W = v___char_5
                               subwf    v___char_5,w        ;  1 OV rs rs [?? ??] 031a 026e
                               btfss    v__status, v__z     ;  1 OV rs rs [?? ??] 031b 1d03
                               goto     l__l384             ;  1 OV rs rs [?? ??] 031c 2b1f
;   48       return true
                               bsf      v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 031d 1420
                               return                       ;  1 OV rs rs [?? ??] 031e 0008
;   49    end if
l__l384
;   51    if (GpsInBufferIndex >= (IN_BUF_SIZE-1)) then
                               movlw    19                  ;  1 OV rs rs [?? ??] 031f 3013
                               subwf    v_gpsinbufferindex,w;  1 OV rs rs [?? ??] 0320 0267
                               btfsc    v__status, v__z     ;  1 OV rs rs [?? ??] 0321 1903
                               goto     l__l565             ;  1 OV rs rs [?? ??] 0322 2b25
                               btfss    v__status, v__c     ;  1 OV rs rs [?? ??] 0323 1c03
                                                            ; W = v_gpserrorcode
                               goto     l__l386             ;  1 OV rs rs [?? ??] 0324 2b28
                                                            ; W = v_gpserrorcode
l__l565
;   53       GpsErrorCode = 201
                               movlw    201                 ;  1 OV rs rs [?? ??] 0325 30c9
                               movwf    v_gpserrorcode      ;  1 OV rs rs [?? ??] 0326 00e9
;   54       return;
                               return                       ;  1 OV rs rs [?? ??] 0327 0008
                                                            ; W = v_gpserrorcode
;   55    end if
l__l386
;   57    GpsInBuffer[GpsInBufferIndex] = char
                               movlw    v_gpsinbuffer       ;  1 OV rs rs [?? ??] 0328 3053
                                                            ; W = v_gpserrorcode
                               addwf    v_gpsinbufferindex,w;  1 OV rs rs [?? ??] 0329 0767
                               movwf    v__fsr              ;  1 OV rs rs [?? ??] 032a 0084
                               irp_clr                      ;  1 OV rs rs [?? ??] 032b 1383
                               movf     v___char_5,w        ;  1 OV rs rs [?? ??] 032c 086e
                               movwf    v__ind              ;  1 OV rs rs [?? ??] 032d 0080
                                                            ; W = v___char_5
;   58    GpsInBufferIndex = GpsInBufferIndex + 1
                               incf     v_gpsinbufferindex,f;  1 OV rs rs [?? ??] 032e 0ae7
;   59    GpsInBuffer[GpsInBufferIndex] = 0 ; iedere keer de afsluit-0 plaatsen.
                               movlw    v_gpsinbuffer       ;  1 OV rs rs [?? ??] 032f 3053
                               addwf    v_gpsinbufferindex,w;  1 OV rs rs [?? ??] 0330 0767
                               movwf    v__fsr              ;  1 OV rs rs [?? ??] 0331 0084
                               irp_clr                      ;  1 OV rs rs [?? ??] 0332 1383
                               clrf     v__ind              ;  1 OV rs rs [?? ??] 0333 0180
;   61    return false ; not done yet.
                               bcf      v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 0334 1020
;   62 end function
l__l382
                               return                       ;  1 OV rs rs [?? ??] 0335 0008
                                                            ; W = v_gpserrorcode
;   64 function IsMsg(byte in name[]) return bit is
l_ismsg
;   67    for 5 using i loop       
                               clrf     v___i_2             ;  2 OV Rs Rs [?? ??] 0336 01a4
                                                            ; W = v___name_1
l__l389
;   73       if (name[i] != GpsInBuffer[i]) then return false end if
                               movf     v___name_1+1,w      ;  2 OV Rs Rs [?? ??] 0337 0821
                               datahi_clr v__pic_pointer    ;  2 OV Rs rs [?? ??] 0338 1303
                                                            ; W = v___name_1
                               movwf    v__pic_pointer+1    ;  2 OV rs rs [?? ??] 0339 00b5
                                                            ; W = v___name_1
                               datahi_set v___i_2           ;  2 OV rs Rs [?? ??] 033a 1703
                                                            ; W = v__pic_pointer
                               movf     v___i_2,w           ;  2 OV Rs Rs [?? ??] 033b 0824
                                                            ; W = v__pic_pointer
                               addwf    v___name_1,w        ;  2 OV Rs Rs [?? ??] 033c 0720
                                                            ; W = v___i_2
                               datahi_clr v__pic_pointer    ;  2 OV Rs rs [?? ??] 033d 1303
                               movwf    v__pic_pointer      ;  2 OV rs rs [?? ??] 033e 00b4
                               btfsc    v__status, v__c     ;  2 OV rs rs [?? ??] 033f 1803
                                                            ; W = v__pic_pointer
                               incf     v__pic_pointer+1,f  ;  2 OV rs rs [?? ??] 0340 0ab5
                                                            ; W = v__pic_pointer
                               bcf      v__pic_pointer+1, 6 ;  2 OV rs rs [?? ??] 0341 1335
                               movf     v__pic_pointer+1,w  ;  2 OV rs rs [?? ??] 0342 0835
                               call     l__pic_indirect     ;  2 OV rs ?? [?? ??] 0343 20bd
                                                            ; W = v__pic_pointer
                               datalo_clr v__pic_temp       ;  2 OV ?? ?s [?? ??] 0344 1283
                               datahi_clr v__pic_temp       ;  2 OV ?s rs [?? ??] 0345 1303
                               movwf    v__pic_temp         ;  2 OV rs rs [?? ??] 0346 00a0
                               movlw    v_gpsinbuffer       ;  2 OV rs rs [?? ??] 0347 3053
                                                            ; W = v__pic_temp
                               datahi_set v___i_2           ;  2 OV rs Rs [?? ??] 0348 1703
                               addwf    v___i_2,w           ;  2 OV Rs Rs [?? ??] 0349 0724
                               movwf    v__fsr              ;  2 OV Rs Rs [?? ??] 034a 0084
                               irp_clr                      ;  2 OV Rs Rs [?? ??] 034b 1383
                               datahi_clr v__pic_temp       ;  2 OV Rs rs [?? ??] 034c 1303
                               movf     v__pic_temp,w       ;  2 OV rs rs [?? ??] 034d 0820
                               subwf    v__ind,w            ;  2 OV rs rs [?? ??] 034e 0200
                                                            ; W = v__pic_temp
                               btfsc    v__status, v__z     ;  2 OV rs rs [?? ??] 034f 1903
                               goto     l__l393             ;  2 OV rs rs [?? ??] 0350 2b53
                               bcf      v__pic_temp, 0 ; _pic_temp   ;  2 OV rs rs [?? ??] 0351 1020
                                                            ; W = v___name_1
                               return                       ;  2 OV rs rs [?? ??] 0352 0008
                                                            ; W = v___name_1
l__l393
;   74    end loop
                               datahi_set v___i_2           ;  2 OV rs Rs [?? ??] 0353 1703
                               incf     v___i_2,f           ;  2 OV Rs Rs [?? ??] 0354 0aa4
                               movlw    5                   ;  2 OV Rs Rs [?? ??] 0355 3005
                               subwf    v___i_2,w           ;  2 OV Rs Rs [?? ??] 0356 0224
                               btfss    v__status, v__z     ;  2 OV Rs Rs [?? ??] 0357 1d03
                               goto     l__l389             ;  2 OV Rs Rs [?? ??] 0358 2b37
;   78    return true
                               datahi_clr v__pic_temp ; _pic_temp    ;  2 OV Rs rs [?? ??] 0359 1303
                                                            ; W = v___name_1
                               bsf      v__pic_temp, 0 ; _pic_temp   ;  2 OV rs rs [?? ??] 035a 1420
                                                            ; W = v___name_1
;   79 end function
l__l388
                               return                       ;  2 OV rs rs [?? ??] 035b 0008
                                                            ; W = v___name_1
;   88 function ParseMessageID() return byte is
l_parsemessageid
;   89    if (IsMsg(str_gpgga)) then return 1 end if
                               movlw    l__data_str_gpgga   ;  1 OV rs rs [?? ??] 035c 3028
                               datahi_set v___name_1        ;  1 OV rs Rs [?? ??] 035d 1703
                               movwf    v___name_1          ;  1 OV Rs Rs [?? ??] 035e 00a0
                               movlw    HIGH l__data_str_gpgga;  1 OV Rs Rs [?? ??] 035f 3000
                                                            ; W = v___name_1
                               iorlw    64                  ;  1 OV Rs Rs [?? ??] 0360 3840
                               movwf    v___name_1+1        ;  1 OV Rs Rs [?? ??] 0361 00a1
                               call     l_ismsg             ;  1 OV Rs ?? [?? ??] 0362 2336
                                                            ; W = v___name_1
                               datalo_clr v____bitbucket_4 ; _btemp62;  1 OV ?? ?s [?? ??] 0363 1283
                               datahi_clr v____bitbucket_4 ; _btemp62;  1 OV ?s rs [?? ??] 0364 1303
                               bcf      v____bitbucket_4, 0 ; _btemp62;  1 OV rs rs [?? ??] 0365 106e
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 0366 1820
                               bsf      v____bitbucket_4, 0 ; _btemp62;  1 OV rs rs [?? ??] 0367 146e
                               btfsc    v____bitbucket_4, 0 ; _btemp62;  1 OV rs rs [?? ??] 0368 186e
                               retlw    1                   ;  1 OV rs rs [?? ??] 0369 3401
l__l397
;   90    if (IsMsg(str_gpgll)) then return 2 end if
                               movlw    l__data_str_gpgll   ;  1 OV rs rs [?? ??] 036a 303a
                               datahi_set v___name_1        ;  1 OV rs Rs [?? ??] 036b 1703
                               movwf    v___name_1          ;  1 OV Rs Rs [?? ??] 036c 00a0
                               movlw    HIGH l__data_str_gpgll;  1 OV Rs Rs [?? ??] 036d 3000
                                                            ; W = v___name_1
                               iorlw    64                  ;  1 OV Rs Rs [?? ??] 036e 3840
                               movwf    v___name_1+1        ;  1 OV Rs Rs [?? ??] 036f 00a1
                               call     l_ismsg             ;  1 OV Rs ?? [?? ??] 0370 2336
                                                            ; W = v___name_1
                               datalo_clr v____bitbucket_4 ; _btemp63;  1 OV ?? ?s [?? ??] 0371 1283
                               datahi_clr v____bitbucket_4 ; _btemp63;  1 OV ?s rs [?? ??] 0372 1303
                               bcf      v____bitbucket_4, 1 ; _btemp63;  1 OV rs rs [?? ??] 0373 10ee
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 0374 1820
                               bsf      v____bitbucket_4, 1 ; _btemp63;  1 OV rs rs [?? ??] 0375 14ee
                               btfsc    v____bitbucket_4, 1 ; _btemp63;  1 OV rs rs [?? ??] 0376 18ee
                               retlw    2                   ;  1 OV rs rs [?? ??] 0377 3402
l__l399
;   91    if (IsMsg(str_gpgsa)) then return 3 end if
                               movlw    l__data_str_gpgsa   ;  1 OV rs rs [?? ??] 0378 3034
                               datahi_set v___name_1        ;  1 OV rs Rs [?? ??] 0379 1703
                               movwf    v___name_1          ;  1 OV Rs Rs [?? ??] 037a 00a0
                               movlw    HIGH l__data_str_gpgsa;  1 OV Rs Rs [?? ??] 037b 3000
                                                            ; W = v___name_1
                               iorlw    64                  ;  1 OV Rs Rs [?? ??] 037c 3840
                               movwf    v___name_1+1        ;  1 OV Rs Rs [?? ??] 037d 00a1
                               call     l_ismsg             ;  1 OV Rs ?? [?? ??] 037e 2336
                                                            ; W = v___name_1
                               datalo_clr v____bitbucket_4 ; _btemp64;  1 OV ?? ?s [?? ??] 037f 1283
                               datahi_clr v____bitbucket_4 ; _btemp64;  1 OV ?s rs [?? ??] 0380 1303
                               bcf      v____bitbucket_4, 2 ; _btemp64;  1 OV rs rs [?? ??] 0381 116e
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 0382 1820
                               bsf      v____bitbucket_4, 2 ; _btemp64;  1 OV rs rs [?? ??] 0383 156e
                               btfsc    v____bitbucket_4, 2 ; _btemp64;  1 OV rs rs [?? ??] 0384 196e
                               retlw    3                   ;  1 OV rs rs [?? ??] 0385 3403
l__l401
;   92    if (IsMsg(str_gpgsv)) then return 4 end if
                               movlw    l__data_str_gpgsv   ;  1 OV rs rs [?? ??] 0386 3022
                               datahi_set v___name_1        ;  1 OV rs Rs [?? ??] 0387 1703
                               movwf    v___name_1          ;  1 OV Rs Rs [?? ??] 0388 00a0
                               movlw    HIGH l__data_str_gpgsv;  1 OV Rs Rs [?? ??] 0389 3000
                                                            ; W = v___name_1
                               iorlw    64                  ;  1 OV Rs Rs [?? ??] 038a 3840
                               movwf    v___name_1+1        ;  1 OV Rs Rs [?? ??] 038b 00a1
                               call     l_ismsg             ;  1 OV Rs ?? [?? ??] 038c 2336
                                                            ; W = v___name_1
                               datalo_clr v____bitbucket_4 ; _btemp65;  1 OV ?? ?s [?? ??] 038d 1283
                               datahi_clr v____bitbucket_4 ; _btemp65;  1 OV ?s rs [?? ??] 038e 1303
                               bcf      v____bitbucket_4, 3 ; _btemp65;  1 OV rs rs [?? ??] 038f 11ee
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 0390 1820
                               bsf      v____bitbucket_4, 3 ; _btemp65;  1 OV rs rs [?? ??] 0391 15ee
                               btfsc    v____bitbucket_4, 3 ; _btemp65;  1 OV rs rs [?? ??] 0392 19ee
                               retlw    4                   ;  1 OV rs rs [?? ??] 0393 3404
l__l403
;   93    if (IsMsg(str_gprmc)) then return 5 end if
                               movlw    l__data_str_gprmc   ;  1 OV rs rs [?? ??] 0394 3040
                               datahi_set v___name_1        ;  1 OV rs Rs [?? ??] 0395 1703
                               movwf    v___name_1          ;  1 OV Rs Rs [?? ??] 0396 00a0
                               movlw    HIGH l__data_str_gprmc;  1 OV Rs Rs [?? ??] 0397 3000
                                                            ; W = v___name_1
                               iorlw    64                  ;  1 OV Rs Rs [?? ??] 0398 3840
                               movwf    v___name_1+1        ;  1 OV Rs Rs [?? ??] 0399 00a1
                               call     l_ismsg             ;  1 OV Rs ?? [?? ??] 039a 2336
                                                            ; W = v___name_1
                               datalo_clr v____bitbucket_4 ; _btemp66;  1 OV ?? ?s [?? ??] 039b 1283
                               datahi_clr v____bitbucket_4 ; _btemp66;  1 OV ?s rs [?? ??] 039c 1303
                               bcf      v____bitbucket_4, 4 ; _btemp66;  1 OV rs rs [?? ??] 039d 126e
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 039e 1820
                               bsf      v____bitbucket_4, 4 ; _btemp66;  1 OV rs rs [?? ??] 039f 166e
                               btfsc    v____bitbucket_4, 4 ; _btemp66;  1 OV rs rs [?? ??] 03a0 1a6e
                               retlw    5                   ;  1 OV rs rs [?? ??] 03a1 3405
l__l405
;   94    if (IsMsg(str_gpvtg)) then return 6 end if
                               movlw    l__data_str_gpvtg   ;  1 OV rs rs [?? ??] 03a2 302e
                               datahi_set v___name_1        ;  1 OV rs Rs [?? ??] 03a3 1703
                               movwf    v___name_1          ;  1 OV Rs Rs [?? ??] 03a4 00a0
                               movlw    HIGH l__data_str_gpvtg;  1 OV Rs Rs [?? ??] 03a5 3000
                                                            ; W = v___name_1
                               iorlw    64                  ;  1 OV Rs Rs [?? ??] 03a6 3840
                               movwf    v___name_1+1        ;  1 OV Rs Rs [?? ??] 03a7 00a1
                               call     l_ismsg             ;  1 OV Rs ?? [?? ??] 03a8 2336
                                                            ; W = v___name_1
                               datalo_clr v____bitbucket_4 ; _btemp67;  1 OV ?? ?s [?? ??] 03a9 1283
                               datahi_clr v____bitbucket_4 ; _btemp67;  1 OV ?s rs [?? ??] 03aa 1303
                               bcf      v____bitbucket_4, 5 ; _btemp67;  1 OV rs rs [?? ??] 03ab 12ee
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  1 OV rs rs [?? ??] 03ac 1820
                               bsf      v____bitbucket_4, 5 ; _btemp67;  1 OV rs rs [?? ??] 03ad 16ee
                               btfsc    v____bitbucket_4, 5 ; _btemp67;  1 OV rs rs [?? ??] 03ae 1aee
                               retlw    6                   ;  1 OV rs rs [?? ??] 03af 3406
l__l407
;   96    return 0 ; unknown message
                               retlw    0                   ;  1 OV rs rs [?? ??] 03b0 3400
;   97 end function
l__l395
;  164 end procedure                             
l__l408
...
;   70 T2CON_TOUTPS = 0b00                       -- postscaler 1:1
                               movlw    135                 ;  0 OV rs rs [?? ??] 03b1 3087
                                                            ; W = v_gpserrorcode
                               andwf    v_t2con,f           ;  0 OV rs rs [?? ??] 03b2 0592
;   71 T2CON_T2CKPS = 0b00                       -- prescaler 1:1
                               movlw    252                 ;  0 OV rs rs [?? ??] 03b3 30fc
                               andwf    v_t2con,f           ;  0 OV rs rs [?? ??] 03b4 0592
;   72 T2CON_TMR2ON = TRUE
                               bsf      v_t2con, 2 ; t2con_tmr2on       ;  0 OV rs rs [?? ??] 03b5 1512
;   73 PR2 = 249   -- count from 0 to 249 and skip back to 0 = 250 steps
                               movlw    249                 ;  0 OV rs rs [?? ??] 03b6 30f9
                               datalo_set v_pr2             ;  0 OV rs rS [?? ??] 03b7 1683
                               movwf    v_pr2               ;  0 OV rS rS [?? ??] 03b8 0092
;   75 ccp1con_p1m = 0  -- alleen output op pin P1A
                               movlw    63                  ;  0 OV rS rS [?? ??] 03b9 303f
                               datalo_clr v_ccp1con         ;  0 OV rS rs [?? ??] 03ba 1283
                               andwf    v_ccp1con,f         ;  0 OV rs rs [?? ??] 03bb 0597
;   76 ccp1con_ccp1m = 0b1100  -- pwm mode
                               movlw    240                 ;  0 OV rs rs [?? ??] 03bc 30f0
                               andwf    v_ccp1con,w         ;  0 OV rs rs [?? ??] 03bd 0517
                               iorlw    12                  ;  0 OV rs rs [?? ??] 03be 380c
                               movwf    v_ccp1con           ;  0 OV rs rs [?? ??] 03bf 0097
;   77 pin_c5_direction = output
                               datalo_set v_trisc ; pin_c5_direction        ;  0 OV rs rS [?? ??] 03c0 1683
                                                            ; W = v_ccp1con
                               bcf      v_trisc, 5 ; pin_c5_direction       ;  0 OV rS rS [?? ??] 03c1 1287
                                                            ; W = v_ccp1con
;   79 PIE1_TMR2IE = true
                               bsf      v_pie1, 1 ; pie1_tmr2ie        ;  0 OV rS rS [?? ??] 03c2 148c
                                                            ; W = v_ccp1con
;   80 INTCON_GIE = true
                               bsf      v_intcon, 7 ; intcon_gie      ;  0 OV rS rS [?? ??] 03c3 178b
                                                            ; W = v_ccp1con
;   81 INTCON_PEIE = true
                               bsf      v_intcon, 6 ; intcon_peie      ;  0 OV rS rS [?? ??] 03c4 170b
                                                            ; W = v_ccp1con
;   83 var volatile word Ticks = 0   
                               datalo_clr v_ticks           ;  0 OV rS rs [?? ??] 03c5 1283
                                                            ; W = v_ccp1con
                               clrf     v_ticks             ;  0 OV rs rs [?? ??] 03c6 01b8
                                                            ; W = v_ccp1con
                               clrf     v_ticks+1           ;  0 OV rs rs [?? ??] 03c7 01b9
                                                            ; W = v_ccp1con
;   87 print_string(serial_hw_data, str1)      
                               movlw    l__serial_hw_data_put;  0 OV rs rs [?? ??] 03c8 30e5
                                                            ; W = v_ccp1con
                               movwf    v____device_put_1   ;  0 OV rs rs [?? ??] 03c9 00ee
                               movlw    HIGH l__serial_hw_data_put;  0 OV rs rs [?? ??] 03ca 3001
                                                            ; W = v____device_put_1
                               movwf    v____device_put_1+1 ;  0 OV rs rs [?? ??] 03cb 00ef
                               movlw    10                  ;  0 OV rs rs [?? ??] 03cc 300a
                                                            ; W = v____device_put_1
                               datahi_set v__str_count      ;  0 OV rs Rs [?? ??] 03cd 1703
                               movwf    v__str_count        ;  0 OV Rs Rs [?? ??] 03ce 00a2
                               clrf     v__str_count+1      ;  0 OV Rs Rs [?? ??] 03cf 01a3
                                                            ; W = v__str_count
                               movlw    l__data_str1_2      ;  0 OV Rs Rs [?? ??] 03d0 3010
                                                            ; W = v__str_count
                               movwf    v___str_1           ;  0 OV Rs Rs [?? ??] 03d1 00a6
                               movlw    HIGH l__data_str1_2 ;  0 OV Rs Rs [?? ??] 03d2 3000
                                                            ; W = v___str_1
                               iorlw    64                  ;  0 OV Rs Rs [?? ??] 03d3 3840
                               movwf    v___str_1+1         ;  0 OV Rs Rs [?? ??] 03d4 00a7
                               call     l_print_string      ;  0 OV Rs ?? [?? ??] 03d5 2202
                                                            ; W = v___str_1
;   89 procedure SetDutyCycle (word in duty) is
                               goto     l__l432             ;  0 OV ?? ?? [?? ??] 03d6 2c13
l_setdutycycle
;   91    if (duty > 999) then 
                               movlw    3                   ;  1 OV rs rs [?? ??] 03d7 3003
                                                            ; W = v___duty_1
                               subwf    v___duty_1+1,w      ;  1 OV rs rs [?? ??] 03d8 026f
                               btfss    v__status, v__z     ;  1 OV rs rs [?? ??] 03d9 1d03
                               goto     l__l566             ;  1 OV rs rs [?? ??] 03da 2bdd
                               movlw    231                 ;  1 OV rs rs [?? ??] 03db 30e7
                               subwf    v___duty_1,w        ;  1 OV rs rs [?? ??] 03dc 026e
l__l566
                               btfsc    v__status, v__z     ;  1 OV rs rs [?? ??] 03dd 1903
                               goto     l__l431             ;  1 OV rs rs [?? ??] 03de 2be8
                               btfss    v__status, v__c     ;  1 OV rs rs [?? ??] 03df 1c03
                                                            ; W = v_ccp1con
                               goto     l__l431             ;  1 OV rs rs [?? ??] 03e0 2be8
                                                            ; W = v_ccp1con
;   92       duty = 999
                               movlw    231                 ;  1 OV rs rs [?? ??] 03e1 30e7
                               movwf    v___duty_1          ;  1 OV rs rs [?? ??] 03e2 00ee
                               movlw    3                   ;  1 OV rs rs [?? ??] 03e3 3003
                                                            ; W = v___duty_1
                               movwf    v___duty_1+1        ;  1 OV rs rs [?? ??] 03e4 00ef
;   93       serial_hw_data = "E"
                               movlw    69                  ;  1 OV rs rs [?? ??] 03e5 3045
                                                            ; W = v___duty_1
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 03e6 00a0
                               call     l__serial_hw_data_put;  1 OV rs ?? [?? ??] 03e7 21e5
                                                            ; W = v__pic_temp
;   94    end if                
l__l431
;   96    ccpr1l = byte(duty >> 2)
                               bcf      v__status, v__c     ;  1 OV ?? ?? [?? ??] 03e8 1003
                                                            ; W = v_ccp1con
                               datalo_clr v___duty_1        ;  1 OV ?? ?s [?? ??] 03e9 1283
                                                            ; W = v_ccp1con
                               datahi_clr v___duty_1        ;  1 OV ?s rs [?? ??] 03ea 1303
                                                            ; W = v_ccp1con
                               rrf      v___duty_1+1,w      ;  1 OV rs rs [?? ??] 03eb 0c6f
                                                            ; W = v_ccp1con
                               movwf    v__pic_temp+1       ;  1 OV rs rs [?? ??] 03ec 00a1
                               rrf      v___duty_1,w        ;  1 OV rs rs [?? ??] 03ed 0c6e
                                                            ; W = v__pic_temp
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 03ee 00a0
                               bcf      v__status, v__c     ;  1 OV rs rs [?? ??] 03ef 1003
                                                            ; W = v__pic_temp
                               rrf      v__pic_temp+1,f     ;  1 OV rs rs [?? ??] 03f0 0ca1
                                                            ; W = v__pic_temp
                               rrf      v__pic_temp,f       ;  1 OV rs rs [?? ??] 03f1 0ca0
                               movf     v__pic_temp,w       ;  1 OV rs rs [?? ??] 03f2 0820
                               movwf    v_ccpr1l            ;  1 OV rs rs [?? ??] 03f3 0095
                                                            ; W = v__pic_temp
;   97    ccp1con_dc1b = byte(duty) & 0b11
                               movlw    3                   ;  1 OV rs rs [?? ??] 03f4 3003
                               andwf    v___duty_1,w        ;  1 OV rs rs [?? ??] 03f5 056e
                               movwf    v__pic_temp         ;  1 OV rs rs [?? ??] 03f6 00a0
                               swapf    v__pic_temp,w       ;  1 OV rs rs [?? ??] 03f7 0e20
                                                            ; W = v__pic_temp
                               movwf    v__pic_temp+1       ;  1 OV rs rs [?? ??] 03f8 00a1
                               movlw    48                  ;  1 OV rs rs [?? ??] 03f9 3030
                                                            ; W = v__pic_temp
                               andwf    v__pic_temp+1,f     ;  1 OV rs rs [?? ??] 03fa 05a1
                               movlw    207                 ;  1 OV rs rs [?? ??] 03fb 30cf
                               andwf    v_ccp1con,w         ;  1 OV rs rs [?? ??] 03fc 0517
                               iorwf    v__pic_temp+1,w     ;  1 OV rs rs [?? ??] 03fd 0421
                               movwf    v_ccp1con           ;  1 OV rs rs [?? ??] 03fe 0097
;   99 end procedure
                               return                       ;  1 OV rs rs [?? ??] 03ff 0008
                                                            ; W = v_ccp1con
;  104 procedure isr is
l_isr
;  107    if (PIR1_TMR2IF) then
                               btfss    v_pir1, 1 ; pir1_tmr2if        ;  4 OV rs rs [hl hl] 0400 1c8c
                                                            ; W = v__pic_isr_fsr
                               goto     l__serial_receive_interrupt_handler;  4 OV rs rs [hl hl] 0401 2913
                                                            ; W = v__pic_isr_fsr
;  108       PIR1_TMR2IF = false
                               bcf      v_pir1, 1 ; pir1_tmr2if        ;  4 OV rs rs [hl hl] 0402 108c
                                                            ; W = v___x_67
;  109       Ticks = Ticks + 1
                               incf     v_ticks,f           ;  4 OV rs rs [hl hl] 0403 0ab8
                                                            ; W = v___x_67
                               btfsc    v__status, v__z     ;  4 OV rs rs [hl hl] 0404 1903
                                                            ; W = v___x_67
                               incf     v_ticks+1,f         ;  4 OV rs rs [hl hl] 0405 0ab9
                                                            ; W = v___x_67
;  110       if (Ticks > 9999) then
                               movlw    39                  ;  4 OV rs rs [hl hl] 0406 3027
                                                            ; W = v___x_67
                               subwf    v_ticks+1,w         ;  4 OV rs rs [hl hl] 0407 0239
                               btfss    v__status, v__z     ;  4 OV rs rs [hl hl] 0408 1d03
                               goto     l__l568             ;  4 OV rs rs [hl hl] 0409 2c0c
                               movlw    15                  ;  4 OV rs rs [hl hl] 040a 300f
                               subwf    v_ticks,w           ;  4 OV rs rs [hl hl] 040b 0238
l__l568
                               btfsc    v__status, v__z     ;  4 OV rs rs [hl hl] 040c 1903
                               goto     l__serial_receive_interrupt_handler;  4 OV rs rs [hl hl] 040d 2913
                               btfss    v__status, v__c     ;  4 OV rs rs [hl hl] 040e 1c03
                               goto     l__serial_receive_interrupt_handler;  4 OV rs rs [hl hl] 040f 2913
;  111          Ticks = 0
                               clrf     v_ticks             ;  4 OV rs rs [hl hl] 0410 01b8
                               clrf     v_ticks+1           ;  4 OV rs rs [hl hl] 0411 01b9
;  113    end if   
                               goto     l__serial_receive_interrupt_handler;  4 OV rs rs [hl hl] 0412 2913
;  115 end procedure
l__l432
;  118 for 8 loop
                               datalo_clr v__floop7         ;  0 OV ?? ?s [?? ??] 0413 1283
                               datahi_clr v__floop7         ;  0 OV ?s rs [?? ??] 0414 1303
                               clrf     v__floop7           ;  0 OV rs rs [?? ??] 0415 01ea
l__l438
;  120    led1 = ! led1 
                               btfss    v_porta, 2 ; pin_a2       ;  0 OV rs rs [?? ??] 0416 1d05
                               goto     l__l571             ;  0 OV rs rs [?? ??] 0417 2c1a
                               bcf      v__bitbucket, 2 ; _btemp80  ;  0 OV rs rs [?? ??] 0418 116b
                                                            ; W = v_gpserrorcode
                               goto     l__l570             ;  0 OV rs rs [?? ??] 0419 2c1b
                                                            ; W = v_gpserrorcode
l__l571
                               bsf      v__bitbucket, 2 ; _btemp80  ;  0 OV rs rs [?? ??] 041a 156b
l__l570
                               bcf      v__porta_shadow, 2 ; x69;  0 OV rs rs [?? ??] 041b 1142
                               btfsc    v__bitbucket, 2 ; _btemp80  ;  0 OV rs rs [?? ??] 041c 196b
                               bsf      v__porta_shadow, 2 ; x69;  0 OV rs rs [?? ??] 041d 1542
; c:\jallib\include\device/16f690.jal
;  100    PORTA = _PORTA_shadow
                               movf     v__porta_shadow,w   ;  0 OV rs rs [?? ??] 041e 0842
                               movwf    v_porta             ;  0 OV rs rs [?? ??] 041f 0085
                                                            ; W = v__porta_shadow
; vcxo.jal
;  120    led1 = ! led1 
; c:\jallib\include\device/16f690.jal
...
;  120    led1 = ! led1 
;  121    delay_1ms(50)
                               movlw    50                  ;  0 OV rs rs [?? ??] 0420 3032
                               movwf    v___n_3             ;  0 OV rs rs [?? ??] 0421 00ee
                               clrf     v___n_3+1           ;  0 OV rs rs [?? ??] 0422 01ef
                                                            ; W = v___n_3
                               call     l_delay_1ms         ;  0 OV rs ?? [?? ??] 0423 22f1
                                                            ; W = v___n_3
;  122 end loop
                               datalo_clr v__floop7         ;  0 OV ?? ?s [?? ??] 0424 1283
                               datahi_clr v__floop7         ;  0 OV ?s rs [?? ??] 0425 1303
                               incf     v__floop7,f         ;  0 OV rs rs [?? ??] 0426 0aea
                               movlw    8                   ;  0 OV rs rs [?? ??] 0427 3008
                               subwf    v__floop7,w         ;  0 OV rs rs [?? ??] 0428 026a
                               btfss    v__status, v__z     ;  0 OV rs rs [?? ??] 0429 1d03
                               goto     l__l438             ;  0 OV rs rs [?? ??] 042a 2c16
;  124 SetDutyCycle(500)
                               movlw    244                 ;  0 OV rs rs [?? ??] 042b 30f4
                               movwf    v___duty_1          ;  0 OV rs rs [?? ??] 042c 00ee
                               movlw    1                   ;  0 OV rs rs [?? ??] 042d 3001
                                                            ; W = v___duty_1
                               movwf    v___duty_1+1        ;  0 OV rs rs [?? ??] 042e 00ef
                               call     l_setdutycycle      ;  0 OV rs ?? [?? ??] 042f 23d7
                                                            ; W = v___duty_1
;  129 forever loop    
l__l443
;  139  gpstakt()
...
;  111    if (!Serial_HW_read(char)) then
                               call     l_serial_hw_read    ;  0 OV ?? ?? [?? ??] 0430 2161
                               datalo_clr v___char_7        ;  0 OV ?? ?s [?? ??] 0431 1283
                               datahi_clr v___char_7        ;  0 OV ?s rs [?? ??] 0432 1303
                               movwf    v___char_7          ;  0 OV rs rs [?? ??] 0433 00ed
                               bcf      v__bitbucket, 4 ; _btemp681  ;  0 OV rs rs [?? ??] 0434 126b
                                                            ; W = v___char_7
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  0 OV rs rs [?? ??] 0435 1820
                                                            ; W = v___char_7
                               bsf      v__bitbucket, 4 ; _btemp681  ;  0 OV rs rs [?? ??] 0436 166b
                                                            ; W = v___char_7
                               btfss    v__bitbucket, 4 ; _btemp681  ;  0 OV rs rs [?? ??] 0437 1e6b
                                                            ; W = v___char_7
; vcxo.jal
;  139  gpstakt()
; gps_converter.jal
;  112       return
                               goto     l__l443             ;  0 OV rs rs [?? ??] 0438 2c30
                                                            ; W = v_gpserrorcode
;  113    end if
l__l445
; vcxo.jal
...
;  119    if (GpsErrorCode > 1) then                     
                               movlw    1                   ;  0 OV rs rs [?? ??] 0439 3001
                                                            ; W = v___char_7
                               subwf    v_gpserrorcode,w    ;  0 OV rs rs [?? ??] 043a 0269
                               btfsc    v__status, v__z     ;  0 OV rs rs [?? ??] 043b 1903
                               goto     l__l449             ;  0 OV rs rs [?? ??] 043c 2c60
                               btfss    v__status, v__c     ;  0 OV rs rs [?? ??] 043d 1c03
                               goto     l__l449             ;  0 OV rs rs [?? ??] 043e 2c60
; vcxo.jal
;  139  gpstakt()
; gps_converter.jal
;  120       print_string(serial_hw_data, str_error)
                               movlw    l__serial_hw_data_put;  0 OV rs rs [?? ??] 043f 30e5
                               movwf    v____device_put_1   ;  0 OV rs rs [?? ??] 0440 00ee
                               movlw    HIGH l__serial_hw_data_put;  0 OV rs rs [?? ??] 0441 3001
                                                            ; W = v____device_put_1
                               movwf    v____device_put_1+1 ;  0 OV rs rs [?? ??] 0442 00ef
                               movlw    6                   ;  0 OV rs rs [?? ??] 0443 3006
                                                            ; W = v____device_put_1
                               datahi_set v__str_count      ;  0 OV rs Rs [?? ??] 0444 1703
                               movwf    v__str_count        ;  0 OV Rs Rs [?? ??] 0445 00a2
                               clrf     v__str_count+1      ;  0 OV Rs Rs [?? ??] 0446 01a3
                                                            ; W = v__str_count
                               movlw    l__data_str_error   ;  0 OV Rs Rs [?? ??] 0447 301b
                                                            ; W = v__str_count
                               movwf    v___str_1           ;  0 OV Rs Rs [?? ??] 0448 00a6
                               movlw    HIGH l__data_str_error;  0 OV Rs Rs [?? ??] 0449 3000
                                                            ; W = v___str_1
                               iorlw    64                  ;  0 OV Rs Rs [?? ??] 044a 3840
                               movwf    v___str_1+1         ;  0 OV Rs Rs [?? ??] 044b 00a7
                               call     l_print_string      ;  0 OV Rs ?? [?? ??] 044c 2202
                                                            ; W = v___str_1
;  121       print_byte_dec(serial_hw_data, GpsErrorCode)
                               movlw    l__serial_hw_data_put;  0 OV ?? ?? [?? ??] 044d 30e5
                               datalo_clr v____device_put_19;  0 OV ?? ?s [?? ??] 044e 1283
                               datahi_clr v____device_put_19;  0 OV ?s rs [?? ??] 044f 1303
                               movwf    v____device_put_19  ;  0 OV rs rs [?? ??] 0450 00ee
                               movlw    HIGH l__serial_hw_data_put;  0 OV rs rs [?? ??] 0451 3001
                                                            ; W = v____device_put_19
                               movwf    v____device_put_19+1;  0 OV rs rs [?? ??] 0452 00ef
                               movf     v_gpserrorcode,w    ;  0 OV rs rs [?? ??] 0453 0869
                                                            ; W = v____device_put_19
                               call     l_print_byte_dec    ;  0 OV rs ?? [?? ??] 0454 2234
                                                            ; W = v_gpserrorcode
;  122       print_crlf(serial_hw_data) 
                               movlw    l__serial_hw_data_put;  0 OV ?? ?? [?? ??] 0455 30e5
                               datalo_clr v__device_put     ;  0 OV ?? ?s [?? ??] 0456 1283
                               datahi_clr v__device_put     ;  0 OV ?s rs [?? ??] 0457 1303
                               movwf    v__device_put       ;  0 OV rs rs [?? ??] 0458 00ee
                               movlw    HIGH l__serial_hw_data_put;  0 OV rs rs [?? ??] 0459 3001
                                                            ; W = v__device_put
                               movwf    v__device_put+1     ;  0 OV rs rs [?? ??] 045a 00ef
                               call     l_print_crlf        ;  0 OV rs ?? [?? ??] 045b 21f4
                                                            ; W = v__device_put
;  123       GpsErrorCode = 1
                               movlw    1                   ;  0 OV ?? ?? [?? ??] 045c 3001
                               datalo_clr v_gpserrorcode    ;  0 OV ?? ?s [?? ??] 045d 1283
                               datahi_clr v_gpserrorcode    ;  0 OV ?s rs [?? ??] 045e 1303
                               movwf    v_gpserrorcode      ;  0 OV rs rs [?? ??] 045f 00e9
;  124    end if
l__l449
;  126    if (char == "$") then
                               movlw    36                  ;  0 OV rs rs [?? ??] 0460 3024
                               subwf    v___char_7,w        ;  0 OV rs rs [?? ??] 0461 026d
                               btfss    v__status, v__z     ;  0 OV rs rs [?? ??] 0462 1d03
                               goto     l__l451             ;  0 OV rs rs [?? ??] 0463 2c69
; vcxo.jal
;  139  gpstakt()
; gps_converter.jal
;  128       GpsMsgNr    = 0
                               clrf     v_gpsmsgnr          ;  0 OV rs rs [?? ??] 0464 01b7
;  129       GpsFieldNr  = 0                      
                               clrf     v_gpsfieldnr        ;  0 OV rs rs [?? ??] 0465 01e8
;  130       GpsInBufferIndex = 0
                               clrf     v_gpsinbufferindex  ;  0 OV rs rs [?? ??] 0466 01e7
;  132       GpsErrorCode = 0  ; clear prev errors on new msg start
                               clrf     v_gpserrorcode      ;  0 OV rs rs [?? ??] 0467 01e9
;  135       return
                               goto     l__l443             ;  0 OV rs rs [?? ??] 0468 2c30
;  136    end if
l__l451
;  138    if (GpsErrorCode > 0) then
                               movf     v_gpserrorcode,w    ;  0 OV rs rs [?? ??] 0469 0869
                               btfss    v__status, v__z     ;  0 OV rs rs [?? ??] 046a 1d03
                                                            ; W = v_gpserrorcode
; vcxo.jal
;  139  gpstakt()
; gps_converter.jal
;  139       return
                               goto     l__l443             ;  0 OV rs rs [?? ??] 046b 2c30
;  140    end if   
l__l453
;  142    if (StoreBytes(char)) then ; put byte in buffer, true = field end
                               movf     v___char_7,w        ;  0 OV rs rs [?? ??] 046c 086d
                                                            ; W = v_gpserrorcode
                               call     l_storebytes        ;  0 OV rs ?? [?? ??] 046d 2318
                                                            ; W = v___char_7
                               datalo_clr v__bitbucket+1 ; _btemp741 ;  0 OV ?? ?s [?? ??] 046e 1283
                               datahi_clr v__bitbucket+1 ; _btemp741 ;  0 OV ?s rs [?? ??] 046f 1303
                               bcf      v__bitbucket+1, 2 ; _btemp741;  0 OV rs rs [?? ??] 0470 116c
                               btfsc    v__pic_temp, 0 ; _pic_temp   ;  0 OV rs rs [?? ??] 0471 1820
                               bsf      v__bitbucket+1, 2 ; _btemp741;  0 OV rs rs [?? ??] 0472 156c
                               btfss    v__bitbucket+1, 2 ; _btemp741;  0 OV rs rs [?? ??] 0473 1d6c
                               goto     l__l461             ;  0 OV rs rs [?? ??] 0474 2c9d
; vcxo.jal
;  139  gpstakt()
; gps_converter.jal
;  144       if (GpsFieldNr == 0) then
                               movf     v_gpsfieldnr,w      ;  0 OV rs rs [?? ??] 0475 0868
                               btfss    v__status, v__z     ;  0 OV rs rs [?? ??] 0476 1d03
                                                            ; W = v_gpsfieldnr
                               goto     l__l459             ;  0 OV rs rs [?? ??] 0477 2c99
                                                            ; W = v_gpsfieldnr
; vcxo.jal
;  139  gpstakt()
; gps_converter.jal
;  147          GpsMsgNr = ParseMessageID()    
                               call     l_parsemessageid    ;  0 OV rs ?? [?? ??] 0478 235c
                               datalo_clr v_gpsmsgnr        ;  0 OV ?? ?s [?? ??] 0479 1283
                               datahi_clr v_gpsmsgnr        ;  0 OV ?s rs [?? ??] 047a 1303
                               movwf    v_gpsmsgnr          ;  0 OV rs rs [?? ??] 047b 00b7
;  149          print_string(serial_hw_data, str_msg)  
                               movlw    l__serial_hw_data_put;  0 OV rs rs [?? ??] 047c 30e5
                               movwf    v____device_put_1   ;  0 OV rs rs [?? ??] 047d 00ee
                               movlw    HIGH l__serial_hw_data_put;  0 OV rs rs [?? ??] 047e 3001
                                                            ; W = v____device_put_1
                               movwf    v____device_put_1+1 ;  0 OV rs rs [?? ??] 047f 00ef
                               movlw    4                   ;  0 OV rs rs [?? ??] 0480 3004
                                                            ; W = v____device_put_1
                               datahi_set v__str_count      ;  0 OV rs Rs [?? ??] 0481 1703
                               movwf    v__str_count        ;  0 OV Rs Rs [?? ??] 0482 00a2
                               clrf     v__str_count+1      ;  0 OV Rs Rs [?? ??] 0483 01a3
                                                            ; W = v__str_count
                               movlw    l__data_str_msg     ;  0 OV Rs Rs [?? ??] 0484 3046
                                                            ; W = v__str_count
                               movwf    v___str_1           ;  0 OV Rs Rs [?? ??] 0485 00a6
                               movlw    HIGH l__data_str_msg;  0 OV Rs Rs [?? ??] 0486 3000
                                                            ; W = v___str_1
                               iorlw    64                  ;  0 OV Rs Rs [?? ??] 0487 3840
                               movwf    v___str_1+1         ;  0 OV Rs Rs [?? ??] 0488 00a7
                               call     l_print_string      ;  0 OV Rs ?? [?? ??] 0489 2202
                                                            ; W = v___str_1
;  150          print_byte_dec(serial_hw_data, GpsMsgNr) 
                               movlw    l__serial_hw_data_put;  0 OV ?? ?? [?? ??] 048a 30e5
                               datalo_clr v____device_put_19;  0 OV ?? ?s [?? ??] 048b 1283
                               datahi_clr v____device_put_19;  0 OV ?s rs [?? ??] 048c 1303
                               movwf    v____device_put_19  ;  0 OV rs rs [?? ??] 048d 00ee
                               movlw    HIGH l__serial_hw_data_put;  0 OV rs rs [?? ??] 048e 3001
                                                            ; W = v____device_put_19
                               movwf    v____device_put_19+1;  0 OV rs rs [?? ??] 048f 00ef
                               movf     v_gpsmsgnr,w        ;  0 OV rs rs [?? ??] 0490 0837
                                                            ; W = v____device_put_19
                               call     l_print_byte_dec    ;  0 OV rs ?? [?? ??] 0491 2234
;  151          print_crlf(serial_hw_data)
                               movlw    l__serial_hw_data_put;  0 OV ?? ?? [?? ??] 0492 30e5
                               datalo_clr v__device_put     ;  0 OV ?? ?s [?? ??] 0493 1283
                               datahi_clr v__device_put     ;  0 OV ?s rs [?? ??] 0494 1303
                               movwf    v__device_put       ;  0 OV rs rs [?? ??] 0495 00ee
                               movlw    HIGH l__serial_hw_data_put;  0 OV rs rs [?? ??] 0496 3001
                                                            ; W = v__device_put
                               movwf    v__device_put+1     ;  0 OV rs rs [?? ??] 0497 00ef
                               call     l_print_crlf        ;  0 OV rs ?? [?? ??] 0498 21f4
                                                            ; W = v__device_put
; vcxo.jal
;  139  gpstakt()
; gps_converter.jal
...
;  160       GpsInBufferIndex = 0
                               datalo_clr v_gpsinbufferindex;  0 OV ?? ?s [?? ??] 0499 1283
                                                            ; W = v_gpsfieldnr
                               datahi_clr v_gpsinbufferindex;  0 OV ?s rs [?? ??] 049a 1303
                                                            ; W = v_gpsfieldnr
                               clrf     v_gpsinbufferindex  ;  0 OV rs rs [?? ??] 049b 01e7
                                                            ; W = v_gpsfieldnr
;  161       GpsFieldNr = GpsFieldNr + 1
                               incf     v_gpsfieldnr,f      ;  0 OV rs rs [?? ??] 049c 0ae8
                                                            ; W = v_gpsfieldnr
;  163    end if
l__l461
;  164 end procedure                             
...
;  139  gpstakt()
;  161 end loop
                               goto     l__l443             ;  0 OV rs rs [?? ??] 049d 2c30
                               end
...
;     486e98:__porta_shadow byte (type=i dflags=----- auto sz=1 use=1 assigned=3 base=0042)
...
;     4e5de8:__serial_rcvbuf  (type=a dflags=----- auto sz=12 use=2 assigned=2 base=0043)
;     4e7bd8:__serial_offsetxmthead byte (type=i dflags=----- auto sz=1 use=5 assigned=3 base=004f)
;     4e7cb8:__serial_offsetxmttail byte (type=i dflags=----- auto sz=1 use=8 assigned=3 base=0050)
;     4e7d98:__serial_offsetrcvhead byte (type=i dflags=----- auto sz=1 use=9 assigned=3 base=0051)
;     4e7e78:__serial_offsetrcvtail byte (type=i dflags=----- auto sz=1 use=11 assigned=4 base=0052)
...
;      = 20
;     5524c8:_gpsinbuffer  (type=a dflags=----- auto sz=20 use=3 assigned=3 base=0053)
;     55e108:_gpsinbufferindex byte (type=i dflags=----- auto sz=1 use=4 assigned=3 base=0067)
;     55e1f8:_gpsmsgnr byte (type=i dflags=-V--- auto sticky sz=1 use=1 assigned=2 base=0037)
;     55e2b8:_gpsfieldnr byte (type=i dflags=----- auto sz=1 use=2 assigned=2 base=0068)
;     55e448:_gpserrorcode byte (type=i dflags=----- auto sz=1 use=3 assigned=4 base=0069)
;     55ee38:_str_inbuffer  (type=a dflags=C---- sz=6 use=0 assigned=0)
;      = 73,110,66,117,102,32
;     55e838:_dumpgpsinbuffer_1  (type=F dflags=----- sz=0 use=0 assigned=0 base=0000)
...
;     57b788:_ticks word (type=i dflags=-V--- auto sticky sz=2 use=4 assigned=6 base=0038)
...
;     5817e8:__floop7  (type=i dflags=----- auto sz=1 use=2 assigned=2 base=006a)
...
;      = 0
;     577298:__bitbucket  (type=i dflags=----- auto sz=2 use=6 assigned=12 base=006b)
;     52d3e8:__pic_isr_fsr  (type=i dflags=----- sz=1 use=1 assigned=1 base=0036)
;     52c7f8:__pic_isr_status  (type=i dflags=----- sz=1 use=1 assigned=1 base=0030)
;     52c5e8:__pic_isr_pclath  (type=i dflags=----- sz=1 use=1 assigned=1 base=0031)
;     5281e8:__pic_temp  (type=i dflags=----- sz=2 use=21 assigned=27) ---> _pic_state+0
;     51fa68:__pic_pointer  (type=i dflags=----- sz=2 use=5 assigned=13 base=0034)
;     510c78:__pic_loop  (type=i dflags=----- sz=1 use=1 assigned=2 base=0032)
;     510a68:__pic_divisor  (type=i dflags=----- sz=4 use=20 assigned=16) ---> _pic_state+8
;     4e6618:__pic_dividend  (type=i dflags=----- sz=4 use=9 assigned=16) ---> _pic_state+0
;     50fab8:__pic_quotient  (type=i dflags=----- sz=4 use=17 assigned=13) ---> _pic_state+12
;     4cbe48:__pic_remainder  (type=i dflags=----- sz=4 use=20 assigned=16) ---> _pic_state+4
;     4cbc38:__pic_divaccum  (type=i dflags=----- sz=8 use=8 assigned=8) ---> _pic_state+0
;     612328:__pic_sign  (type=i dflags=----- sz=1 use=2 assigned=3 base=0033)
;     612498:__pic_state  (type=i dflags=----- sz=16 use=95 assigned=96 base=0020)
;     --- labels ---
...
;     _print_universal_dec (pc(024a) usage=5)
...
;     print_byte_dec (pc(0234) usage=10)
...
;     delay_1ms (pc(02f1) usage=5)
;     delay_100ms (pc(0000) usage=0)
;     delay_1s (pc(0000) usage=0)
;     dumpgpsinbuffer (pc(0000) usage=0)
;     storebytes (pc(0318) usage=5)
;     ismsg (pc(0336) usage=30)
;     parsemessageid (pc(035c) usage=5)
;     gpstakt (pc(0000) usage=0)
;     setdutycycle (pc(03d7) usage=5)
;     isr (pc(0400) usage=5)
...
;         --- records ---
;         --- variables ---
;         583f88:_char_7 byte (type=i dflags=----- auto sz=1 use=2 assigned=1 base=006d)
...
;         = 0
;        576418:__bitbucket_1  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        57bf48:_duty_1 word (type=i dflags=----- auto sz=2 use=5 assigned=4 base=006e)
...
;         = 0
;        561908:__bitbucket_2  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        560d98:__bitbucket_3  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        5608b8:__bitbucket_4  (type=i dflags=----- auto sz=1 use=6 assigned=12 base=006e)
;        --- labels ---
;        {block enter}
;          --- records ---
;          --- variables ---
...
;        5603d8:__bitbucket_5  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        5624a8:_char_5 byte (type=i dflags=----- auto sz=1 use=2 assigned=1 base=006e)
...
;         = 0
;        55eb08:__bitbucket_6  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        55e928:_i_1  (type=i dflags=C---- sz=1 use=0 assigned=0)
;         = 0
;        55ece8:__btemp_19  (type=i dflags=C--B- sz=1 use=0 assigned=0 bit=0)
;         = 0
...
;         = 0
;        55ea18:__bitbucket_7  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        55c3e8:__bitbucket_8  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        55a4a8:__bitbucket_9  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        5581f8:_n_3 word (type=i dflags=----- auto sz=2 use=2 assigned=2 base=006e)
...
;        555618:__bitbucket_10  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        553e68:__bitbucket_11  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        553848:__bitbucket_12  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        546e68:__bitbucket_13  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        545e38:__bitbucket_14  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        543eb8:__bitbucket_15  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        543db8:__bitbucket_16  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        542eb8:__bitbucket_17  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        542db8:__bitbucket_18  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        541f18:__bitbucket_19  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        541e18:__bitbucket_20  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        544ac8:__device_put_19  (type=* dflags=----- auto ptr_ptr sz=2 use=2 assigned=4 base=006e)
...
;         = 0
;        540ee8:__bitbucket_22  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        540c78:__bitbucket_23  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        540b18:__bitbucket_24  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        5407d8:__bitbucket_25  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        540538:__bitbucket_26  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        540438:__bitbucket_27  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        508cf8:__bitbucket_28  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        504378:__bitbucket_29  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53f838:__bitbucket_30  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53f738:__bitbucket_31  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        53e978:__bitbucket_32  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53e878:__bitbucket_33  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53d948:__bitbucket_34  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53d778:__bitbucket_35  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 108,111,119
;        53d268:__bitbucket_36  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 102,97,108,115,101
;        53c8e8:__bitbucket_37  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        5161f8:__device_put_1  (type=* dflags=----- auto ptr_ptr sz=2 use=2 assigned=6 base=006e)
...
;        5165b8:_i byte (type=i dflags=----- auto sz=1 use=4 assigned=2 base=012e)
...
;        53cc58:__bitbucket_38  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        515de8:__device_put  (type=* dflags=----- auto ptr_ptr sz=2 use=4 assigned=4 base=006e)
;        53ca48:__bitbucket_39  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        53c408:__bitbucket_40  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53c1d8:__bitbucket_41  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        5474f8:_digit_divisor_5 sdword (type=i dflags=--S-- auto sz=4 use=12 assigned=8 base=012f)
;        548108:_digit_number_5 byte (type=i dflags=----- auto sz=1 use=1 assigned=2 base=0133)
;        5481f8:_digit byte (type=i dflags=----- auto sz=1 use=2 assigned=1 base=0134)
...
;        54a108:__temp_42  (type=i dflags=----- auto sz=1 use=1 assigned=1 base=0135)
;        53b108:__bitbucket_42  (type=i dflags=----- auto sz=1 use=4 assigned=8 base=0136)
;        --- labels ---
;        {block enter}
;          --- records ---
;          --- variables ---
...
;         = 0
;        53ae88:__bitbucket_43  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53aa78:__bitbucket_44  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        53a518:__bitbucket_45  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        53a7d8:__bitbucket_46  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        506ac8:_data_7 byte (type=i dflags=----- auto sticky sz=1 use=1 assigned=1 base=003e)
...
;         = 0
;        53a678:__bitbucket_47  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        53a108:__bitbucket_48  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        539ab8:__bitbucket_49  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        4fcee8:_data_5 byte (type=i dflags=----- auto sticky sz=1 use=3 assigned=1 base=003f)
;        4fd108:_newxmthead byte (type=i dflags=----- auto sticky sz=1 use=5 assigned=2 base=0040)
...
;         = 0
;        539d78:__bitbucket_50  (type=i dflags=----- auto sticky sz=1 use=3 assigned=6 base=0041)
;        --- labels ---
;        {block enter}
;          --- records ---
;          --- variables ---
...
;        539c18:__bitbucket_51  (type=i dflags=----- auto sz=1 use=0 assigned=0 base=ffff)
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        4f67e8:_data_1 byte (type=i dflags=----- auto sz=1 use=1 assigned=1 base=006e)
...
;        5395a8:__bitbucket_52  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        4ed4b8:_x_67 byte (type=i dflags=----- sticky sz=1 use=4 assigned=7 base=003a)
...
;        4f0d08:__temp_25  (type=i dflags=----- sticky sz=1 use=2 assigned=2 base=003b)
;        538cb8:__bitbucket_53  (type=i dflags=----- sticky sz=2 use=3 assigned=6 base=003c)
;        --- labels ---
;        {block enter}
;          --- records ---
;          --- variables ---
...
;        --- records ---
;        --- variables ---
;        4e84b8:_x_66 byte (type=i dflags=----- sticky sz=1 use=1 assigned=1 base=003a)
...
;         = 0
;        539108:__bitbucket_54  (type=i dflags=----- sticky sz=1 use=3 assigned=6 base=003b)
;        --- labels ---
;        {block enter}
;          --- records ---
;          --- variables ---
...
;         = 4798
;        538e18:__bitbucket_55  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        5387d8:__bitbucket_56  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        5385a8:__bitbucket_57  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        537458:__bitbucket_58  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        --- records ---
;        --- variables ---
;        537288:__bitbucket_59  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        536d18:__bitbucket_60  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        5367b8:__bitbucket_61  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        536a78:__bitbucket_62  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        536918:__bitbucket_63  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        5363a8:__bitbucket_64  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        535d48:__bitbucket_65  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        536108:__bitbucket_66  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        535ea8:__bitbucket_67  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        535938:__bitbucket_68  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        5353d8:__bitbucket_69  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        535698:__bitbucket_70  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        535538:__bitbucket_71  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        534e78:__bitbucket_72  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        534918:__bitbucket_73  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        534bd8:__bitbucket_74  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        534a78:__bitbucket_75  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        534508:__bitbucket_76  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        533f88:__bitbucket_77  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        534268:__bitbucket_78  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        534108:__bitbucket_79  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        533b78:__bitbucket_80  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        533618:__bitbucket_81  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        5338d8:__bitbucket_82  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        533778:__bitbucket_83  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        533108:__bitbucket_84  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        532818:__bitbucket_85  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        532b88:__bitbucket_86  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        532978:__bitbucket_87  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        532338:__bitbucket_88  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        532108:__bitbucket_89  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        530f18:__bitbucket_90  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        530d48:__bitbucket_91  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        530938:__bitbucket_92  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        5303d8:__bitbucket_93  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        530698:__bitbucket_94  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        530538:__bitbucket_95  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;        4e85a8:__bitbucket_96  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        52fa78:__bitbucket_97  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        52fd38:__bitbucket_98  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        52fbd8:__bitbucket_99  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        52f668:__bitbucket_100  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        52f108:__bitbucket_101  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        52f3c8:__bitbucket_102  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        52f268:__bitbucket_103  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        52ebd8:__bitbucket_104  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
...
;         = 0
;        52e678:__bitbucket_105  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;         = 0
;        52e938:__bitbucket_106  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;        {block enter}
;          --- records ---
...
;        --- records ---
;        --- variables ---
;        52e7d8:__bitbucket_107  (type=i dflags=C---- sz=0 use=0 assigned=0)
;         = 0
;        --- labels ---
;      {block exit}
; --- call stack ---
...
;460cf8:_l97(use=0:ref=2:pc=0000)
;461ca8:_l98(use=0:ref=2:pc=0000)
...
;514ec8:_l241(use=4:ref=4:pc=02f0)
...
;518768:_l250(use=5:ref=3:pc=0208)
;5187c8:_l251(use=5:ref=3:pc=0229)
;518828:_l252(use=4:ref=3:pc=0233)
;518a18:_l253(use=0:ref=1:pc=0000)
;518a58:_l254(use=5:ref=3:pc=0212)
...
;548a98:_l322(use=5:ref=3:pc=025b)
;549598:_l323(use=5:ref=3:pc=025c)
;5495f8:_l324(use=9:ref=3:pc=02f0)
;549658:_l325(use=0:ref=1:pc=0000)
;54b408:_l326(use=0:ref=1:pc=0000)
;54c4a8:_l327(use=5:ref=3:pc=02ee)
...
;558c98:_l361(use=5:ref=3:pc=02f5)
;558cf8:_l362(use=5:ref=3:pc=0307)
...
;55be88:_l371(use=5:ref=4:pc=0313)
...
;55efa8:_l376(use=0:ref=2:pc=0000)
;55e898:_l377(use=0:ref=2:pc=0000)
...
;5621c8:_l382(use=8:ref=5:pc=0335)
;562588:_l383(use=0:ref=1:pc=0000)
;562c98:_l384(use=5:ref=3:pc=031f)
;563358:_l385(use=0:ref=1:pc=0000)
;563aa8:_l386(use=5:ref=3:pc=0328)
;565a18:_l387(use=0:ref=2:pc=0000)
;565a78:_l388(use=4:ref=4:pc=035b)
;566598:_l389(use=5:ref=3:pc=0337)
;5665f8:_l390(use=0:ref=1:pc=0000)
;566658:_l391(use=0:ref=1:pc=0000)
;5667d8:_l392(use=0:ref=1:pc=0000)
;566e28:_l393(use=5:ref=3:pc=0353)
;5695d8:_l394(use=0:ref=2:pc=0000)
;569638:_l395(use=24:ref=9:pc=03b1)
;5698d8:_l396(use=0:ref=1:pc=0000)
;569c18:_l397(use=5:ref=3:pc=036a)
;56a2e8:_l398(use=0:ref=1:pc=0000)
;56a6d8:_l399(use=5:ref=3:pc=0378)
;56ace8:_l400(use=0:ref=1:pc=0000)
;56b1b8:_l401(use=5:ref=3:pc=0386)
;56b7c8:_l402(use=0:ref=1:pc=0000)
;56bbb8:_l403(use=5:ref=3:pc=0394)
;56c2e8:_l404(use=0:ref=1:pc=0000)
;56c6d8:_l405(use=5:ref=3:pc=03a2)
;56cce8:_l406(use=0:ref=1:pc=0000)
;56d1b8:_l407(use=5:ref=3:pc=03b0)
;56eb78:_l408(use=5:ref=4:pc=03b1)
...
;57d438:_l431(use=9:ref=3:pc=03e8)
;57f238:_l432(use=5:ref=4:pc=0413)
...
;581c28:_l438(use=5:ref=3:pc=0416)
...
;588208:_l459(use=5:ref=3:pc=0499)
;5882d8:_l460(use=0:ref=1:pc=0000)
;588828:_l461(use=5:ref=3:pc=049d)
;5888f8:_l462(use=0:ref=1:pc=0000)
;588a38:_l463(use=6:ref=4:pc=049d)
;5c3ee8:_l464(use=2:ref=1:pc=0043)
;5c3f48:_l465(use=2:ref=1:pc=0046)
;5c4848:_l466(use=0:ref=1:pc=0052)
;5c48a8:_l467(use=0:ref=1:pc=0000)
;5c5e98:_l468(use=0:ref=1:pc=0071)
;5c6328:_l469(use=2:ref=1:pc=0077)
;5c88a8:_l470(use=0:ref=1:pc=00ba)
;5c8908:_l471(use=0:ref=1:pc=0000)
;5cb5a8:_l472(use=0:ref=1:pc=00fd)
;5cb8e8:_l473(use=2:ref=1:pc=0103)
;5ccaa8:_l474(use=0:ref=1:pc=0120)
;5cce88:_l475(use=0:ref=1:pc=0126)
;5ce5a8:_l476(use=0:ref=1:pc=0148)
;5ce8e8:_l477(use=0:ref=1:pc=014e)
;5d03a8:_l478(use=0:ref=1:pc=0176)
;5d06e8:_l479(use=2:ref=1:pc=017c)
;5d0f48:_l480(use=0:ref=1:pc=018a)
;5d1428:_l481(use=0:ref=1:pc=0190)
;5d2a28:_l482(use=0:ref=1:pc=01b2)
;5d2d68:_l483(use=2:ref=1:pc=01b8)
;5d4a48:_l484(use=0:ref=1:pc=01ea)
;5d4aa8:_l485(use=0:ref=1:pc=0000)
;5d64a8:_l486(use=0:ref=1:pc=020e)
;5d67e8:_l487(use=2:ref=1:pc=0214)
;5e2d98:_l488(use=6:ref=1:pc=0376)
;5e42a8:_l489(use=0:ref=1:pc=037c)
;5ea1a8:_l490(use=0:ref=1:pc=042a)
;5ea208:_l491(use=0:ref=1:pc=0000)
;5ec5a8:_l492(use=3:ref=1:pc=045c)
;5ec608:_l493(use=3:ref=1:pc=045e)
;5eeee8:_l494(use=0:ref=1:pc=049c)
;5ef3a8:_l495(use=2:ref=1:pc=04a2)
;5f3888:_l496(use=2:ref=1:pc=0516)
;5f38e8:_l497(use=2:ref=1:pc=0519)
;5f4d68:_l498(use=2:ref=1:pc=0536)
;5f4dc8:_l499(use=2:ref=1:pc=0539)
;5f6328:_l500(use=2:ref=1:pc=0556)
;5f6388:_l501(use=2:ref=1:pc=0559)
;5f7808:_l502(use=2:ref=1:pc=0576)
;5f7868:_l503(use=2:ref=1:pc=0579)
;5f8ce8:_l504(use=2:ref=1:pc=0596)
;5f8d48:_l505(use=2:ref=1:pc=0599)
;5fa2a8:_l506(use=2:ref=1:pc=05b6)
;5fa308:_l507(use=2:ref=1:pc=05b9)
;5fde68:_l508(use=2:ref=1:pc=0612)
;5fe688:_l509(use=0:ref=1:pc=0618)
;601d88:_l510(use=2:ref=1:pc=0676)
;602608:_l511(use=0:ref=1:pc=067c)
;6032a8:_l512(use=2:ref=1:pc=0695)
;603308:_l513(use=2:ref=1:pc=0692)
;6056a8:_l514(use=2:ref=1:pc=06cf)
;605708:_l515(use=2:ref=1:pc=06d2)
;606428:_l516(use=0:ref=1:pc=06dd)
;606768:_l517(use=0:ref=1:pc=06e3)
;609da8:_l518(use=2:ref=1:pc=0744)
;609e08:_l519(use=2:ref=1:pc=0747)
;612558:_l520(use=2:ref=1:pc=0000)
;6125b8:_l521(use=2:ref=1:pc=0000)
;612618:_l522(use=2:ref=1:pc=0000)
;612678:_l523(use=2:ref=1:pc=0000)
;613d68:_l524(use=2:ref=1:pc=0000)
;615568:_l525(use=2:ref=1:pc=0000)
;6177a8:_l526(use=6:ref=1:pc=0000)
;61e448:_l527(use=2:ref=1:pc=0072)
;61e4a8:_l528(use=2:ref=1:pc=00a1)
;61e508:_l529(use=2:ref=1:pc=0092)
;61e568:_l530(use=2:ref=1:pc=0059)
;61e6e8:_l531(use=2:ref=1:pc=0069)
;61e868:_l532(use=2:ref=1:pc=006c)
;61e928:_l533(use=6:ref=1:pc=008e)
;61ec88:_l534(use=2:ref=1:pc=00e7)
;61ece8:_l535(use=2:ref=1:pc=00e9)
;61ed68:_l536(use=0:ref=1:pc=00ed)
;61edc8:_l537(use=0:ref=1:pc=0000)
;61ee28:_l538(use=0:ref=1:pc=00fc)
;61eee8:_l539(use=2:ref=1:pc=0100)
;61efa8:_l540(use=0:ref=1:pc=011f)
;61e1a8:_l541(use=0:ref=1:pc=0000)
;61f1c8:_l542(use=0:ref=1:pc=013a)
;61f288:_l543(use=2:ref=1:pc=013e)
;61f2e8:_l544(use=0:ref=1:pc=0149)
;61f348:_l545(use=0:ref=1:pc=014d)
;61f468:_l546(use=0:ref=1:pc=015a)
;61f528:_l547(use=0:ref=1:pc=015e)
;61f648:_l548(use=0:ref=1:pc=0172)
;61f708:_l549(use=2:ref=1:pc=0176)
;61f768:_l550(use=0:ref=1:pc=017b)
;61f7c8:_l551(use=0:ref=1:pc=017f)
;61f8e8:_l552(use=0:ref=1:pc=0190)
;61f9a8:_l553(use=2:ref=1:pc=0194)
;61fb48:_l554(use=0:ref=1:pc=01a8)
;61fba8:_l555(use=0:ref=1:pc=0000)
;61fc68:_l556(use=0:ref=1:pc=01ba)
;61fd28:_l557(use=2:ref=1:pc=01be)
;463668:_l558(use=6:ref=1:pc=026f)
;4631a8:_l559(use=0:ref=1:pc=0273)
;464318:_l560(use=0:ref=1:pc=02dc)
;464598:_l561(use=0:ref=1:pc=0000)
;464a98:_l562(use=3:ref=1:pc=02f9)
;464d18:_l563(use=3:ref=1:pc=02fb)
;4656d8:_l564(use=0:ref=1:pc=0321)
;465a98:_l565(use=2:ref=1:pc=0325)
;468bd8:_l566(use=2:ref=1:pc=03dd)
;4691d8:_l567(use=0:ref=1:pc=03e1)
;46a318:_l568(use=2:ref=1:pc=040c)
;46a818:_l569(use=0:ref=1:pc=0410)
;46aa98:_l570(use=2:ref=1:pc=041b)
;46ad18:_l571(use=2:ref=1:pc=041a)
;46b1d8:_l572(use=0:ref=1:pc=043b)
;46b598:_l573(use=0:ref=1:pc=043f)
