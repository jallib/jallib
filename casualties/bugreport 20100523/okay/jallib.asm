...
; c(56a428) l(16) 56a428{u-} call print_string(,2423[F------1]:{___serial_hw_data_put_1[F---1]},2425[iC-----4]:{[iC--4]27},2426[aC-----27]:{__str1_2[aC--27]2139058047})
                               ...
                               clrf     v__str_count+1      ;  0 OV rs rs [?? ??] 0087 01aa
                                                            ; W = v__str_count
                               movlw    l__data_str1_2      ;  0 OV rs rs [?? ??] 0088 3005
                                                            ; W = v__str_count
                               movwf    v___str_1           ;  0 OV rs rs [?? ??] 0089 00ab
                               movlw    HIGH l__data_str1_2 ;  0 OV rs rs [?? ??] 008a 3000
                                                            ; W = v___str_1
                               iorlw    64                  ;  0 OV rs rs [?? ??] 008b 3840
                               movwf    v___str_1+1         ;  0 OV rs rs [?? ??] 008c 00ac
                               call     l_print_string      ;  0 OV rs ?? [?? ??] 008d 2060
                                                            ; W = v___str_1
; c(56a498) l(16) 56a498{u-} {eos}
;   19    led = true   
; c(56a5e8) l(18) 56a5e8{u-} {block}
; c(56a688) l(18) 56a688{u-} = 2430[B------1]:{__x_116[B---:1]}, 2429[BC-----1]:{true[BC--:1]1}
                               datalo_clr v__portc_shadow ; x116;  0 OV ?? ?s [?? ??] 008e 1283
                               bsf      v__portc_shadow, 2 ; x116;  0 OV rs rs [?? ??] 008f 1526
...
; c(56a8a8) l(297) 56a8a8{u-} = 681[i-V----1]:{portc[i-V-1]}, 682[i------1]:{_portc_shadow[i---1]}
                               movf     v__portc_shadow,w   ;  0 OV rs rs [?? ??] 0090 0826
                               movwf    v_portc             ;  0 OV rs rs [?? ??] 0091 0087
                                                            ; W = v__portc_shadow
...
; c(56af18) l(19) 56af18{u-} call delay_1ms(,2432[iC-----4]:{[iC--4]500})
                               movlw    244                 ;  0 OV rs rs [?? ??] 0092 30f4
                               movwf    v___n_3             ;  0 OV rs rs [?? ??] 0093 00a7
                               movlw    1                   ;  0 OV rs rs [?? ??] 0094 3001
                                                            ; W = v___n_3
                               movwf    v___n_3+1           ;  0 OV rs rs [?? ??] 0095 00a8
                               call     l_delay_1ms         ;  0 OV rs ?? [?? ??] 0096 2042
                                                            ; W = v___n_3
; c(56af88) l(19) 56af88{u-} {eos}
;   22    led = false   
; c(56a9f8) l(21) 56a9f8{u-} {block}
; c(56b108) l(21) 56b108{u-} = 2436[B------1]:{__x_117[B---:1]}, 2435[BC-----1]:{false[BC--:1]0}
                               datalo_clr v__portc_shadow ; x117;  0 OV ?? ?s [?? ??] 0097 1283
                               bcf      v__portc_shadow, 2 ; x117;  0 OV rs rs [?? ??] 0098 1126
; c(56b1b8) l(21) 56b1b8{u-} {block}
; c:\jallib\include\device/16f877a.jal
;  298    PORTC = _PORTC_shadow
; c(56b228) l(297) 56b228{u-} = 681[i-V----1]:{portc[i-V-1]}, 682[i------1]:{_portc_shadow[i---1]}
                               movf     v__portc_shadow,w   ;  0 OV rs rs [?? ??] 0099 0826
                               movwf    v_portc             ;  0 OV rs rs [?? ??] 009a 0087
                                                            ; W = v__portc_shadow
...
; c(56b898) l(22) 56b898{u-} call delay_1ms(,2438[iC-----4]:{[iC--4]500})
                               movlw    244                 ;  0 OV rs rs [?? ??] 009b 30f4
                               movwf    v___n_3             ;  0 OV rs rs [?? ??] 009c 00a7
                               movlw    1                   ;  0 OV rs rs [?? ??] 009d 3001
                                                            ; W = v___n_3
                               movwf    v___n_3+1           ;  0 OV rs rs [?? ??] 009e 00a8
                               call     l_delay_1ms         ;  0 OV rs ?? [?? ??] 009f 2042
                                                            ; W = v___n_3
; c(56b908) l(22) 56b908{u-} {eos}
;   25 end loop 
; c(56b988) l(24) 56b988{u-} {end-of-block}
; c(56b9f8) l(24) 56b9f8{u-} goto _l432
                               goto     l__l432             ;  0 OV ?? ?? [?? ??] 00a0 2880
                               end
...
;     --- records ---
;     --- variables ---
;     460d58:_jal_version  (type=i dflags=C---- sz=4 use=0 assigned=0)
;      = 2004
;     460e48:_jal_build  (type=i dflags=C---- sz=4 use=0 assigned=0)
;      = 20100313
;     4617c8:_device_id word (type=i dflags=C---- sz=2 use=0 assigned=0)
;      = 3616
;     461f18:_pictype  (type=a dflags=C---- sz=7 use=0 assigned=0)
;      = 49,54,70,56,55,55,65
;     461cd8:_datasheet  (type=a dflags=C---- sz=5 use=0 assigned=0)
;      = 51,57,53,56,50
;     461dc8:_pgmspec  (type=a dflags=C---- sz=5 use=0 assigned=0)
;      = 51,57,53,56,57
;     461918:_pic_12  (type=i dflags=C---U sz=4 use=0 assigned=0)
;      = 1
;     461a08:_pic_14  (type=i dflags=C---U sz=4 use=0 assigned=0)
;      = 2
;     461af8:_pic_16  (type=i dflags=C---U sz=4 use=0 assigned=0)
;      = 3
;     461be8:_sx_12  (type=i dflags=C---U sz=4 use=0 assigned=0)
;      = 4
...
;      = 0
;     4616c8:_high bit (type=B dflags=C--B- sz=1 use=0 assigned=0 bit=0)
;      = 1
...
;     4ee638:__pic_state  (type=i dflags=----- sz=2 use=5 assigned=7 base=0020)
;     --- labels ---
...
;        530888:_str_1  (type=* dflags=----- auto ptr_lookup sz=2 use=2 assigned=2 base=002b)
...
;460cd8:_l62(use=0:ref=2:pc=0000)
...
;461508:_l345(use=14:ref=5:pc=0080)
;462538:_l346(use=0:ref=2:pc=0000)
...
;54adb8:_l438(use=3:ref=1:pc=0058)
;54af48:_l439(use=3:ref=1:pc=005a)
;578428:_l440(use=3:ref=1:pc=0049)
;578488:_l441(use=3:ref=1:pc=004b)
