...
;  129    _ks0108_write(side, KS0108_CMD_COLUMN | column)
                               movlw    64
                               datalo_clr v___x_122
                               datahi_clr v___x_122
                               iorwf    v___x_122,w
                               datalo_set v____temp_80
                               movwf    v____temp_80
                               movf     v____temp_80,w
                               movwf    v___data_14
                               datalo_clr v___side_24
                               movf     v___side_24,w
                               branchlo_clr l__ks0108_write
                               call     l__ks0108_write
; D:\My Documents\My Dropbox\Elektronica\glcd/glcd_common.jal
...
;   68 		if (currY == yDiff) & (currX == xDiff) then
                               movf     v_curry,w
                               subwf    v_ydiff,w
                               datalo_set v____bitbucket_9 ; _btemp95
...
;   80 		if (currY == yDiff) & (currX == xDiff) then
                               movf     v_curry,w
                               subwf    v_ydiff,w
                               datalo_set v____bitbucket_9 ; _btemp99
...
;  145 	lcd_write_char(x, y, hundrets + 48,0)
                               ...
                               movf     v___x_126,w
                               movwf    v___x_127
                               datalo_set v____bitbucket_4 ; debug3
...
;  443 			_ks0108_column(KS0108_LEFT,x)        -- Set the horizontal address
                               datalo_set v___side_30
                               clrf     v___side_30
                               movlw    64
                               datalo_clr v___x_127
                               iorwf    v___x_127,w
                               datalo_set v____temp_97
                               movwf    v____temp_97
                               movf     v____temp_97,w
                               movwf    v___data_14
                               movf     v___side_30,w
...
;  146 	lcd_write_char(x + 6, y, tens + 48,0)
                               ...
                               movf     v____temp_95,w
                               movwf    v___x_128
                               datalo_set v____bitbucket_4 ; debug4
...
; D:\My Documents\My Dropbox\Elektronica\glcd/glcd_ks0108.jal
;  443 			_ks0108_column(KS0108_LEFT,x)        -- Set the horizontal address
                               datalo_set v___side_34
                               clrf     v___side_34
                               movlw    64
                               datalo_clr v___x_128
                               iorwf    v___x_128,w
                               datalo_set v____temp_102
                               movwf    v____temp_102
...
;  147 	lcd_write_char(x + 12, y, ones + 48,0)
                               ...
                               movf     v____temp_95,w
                               movwf    v___x_129
                               datalo_set v____bitbucket_4 ; debug5
...
; D:\My Documents\My Dropbox\Elektronica\glcd/glcd_ks0108.jal
;  443 			_ks0108_column(KS0108_LEFT,x)        -- Set the horizontal address
                               datalo_set v___side_38
                               clrf     v___side_38
                               movlw    64
                               datalo_clr v___x_129
                               iorwf    v___x_129,w
                               datalo_set v____temp_107
                               movwf    v____temp_107
...
;  434 		cx = myFontTable[fIndex]
                               ...
                               movwf    v___cx_5
;  435 		if debug then
                               datalo_clr v____bitbucket_3 ; debug6
...
; D:\My Documents\My Dropbox\Elektronica\glcd/glcd_ks0108.jal
;  443 			_ks0108_column(KS0108_LEFT,x)        -- Set the horizontal address
                               datalo_set v___side_42
                               clrf     v___side_42
                               movlw    64
                               datalo_clr v___x_132
                               iorwf    v___x_132,w
                               datalo_set v____temp_113
                               movwf    v____temp_113
...
;  226 		lcd_filled_rect(x0, y, theValue+1, y+5, 1)		-- Fill the part that needs filling
                               ...
                               datalo_clr v___x0_8
                               movf     v___x0_8,w
                               branchlo_clr l_lcd_filled_rect
